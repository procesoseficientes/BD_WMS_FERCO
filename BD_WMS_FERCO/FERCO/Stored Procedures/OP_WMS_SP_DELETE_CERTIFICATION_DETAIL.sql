...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_DELETE_CERTIFICATION_DETAIL] @CERTIFICATION_DETAIL_ID = 1                                                
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_DELETE_CERTIFICATION_DETAIL (@CERTIFICATION_DETAIL_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    BEGIN
      DELETE [FERCO].[OP_WMS_CERTIFICATION_DETAIL]
      WHERE [CERTIFICATION_DETAIL_ID] = @CERTIFICATION_DETAIL_ID;
    END;
    ELSE
    BEGIN
      -- ------------------------------------------------------------------------------------
      ...
      WHERE [BOX_BARCODE] = @BOX_BARCODE
        AND [CERTIFICATION_HEADER_ID] = @CERTIFICATION_DETAIL_ID;
    END;
