...
-- Ejemplo de Ejecucion:
	 EXEC [FERCO].[OP_WMS_SP_GET_MY_PICKING_LIST_DETAIL] @LOGIN_ID		 = 'ACAMACHO'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MY_PICKING_LIST_DETAIL] (
		@LOGIN_ID VARCHAR(25)
...
BEGIN
  ...
  --
	...
	LEFT JOIN [FERCO].[OP_WMS_MATERIALS] [M] ON [M].[MATERIAL_ID] = [T].[MATERIAL_ID]
	WHERE
