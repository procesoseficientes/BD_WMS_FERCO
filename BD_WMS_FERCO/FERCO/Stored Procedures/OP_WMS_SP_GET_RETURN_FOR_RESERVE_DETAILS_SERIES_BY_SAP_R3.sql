...
-- Ejemplo de Ejecucion:
         EXEC [FERCO].[OP_WMS_SP_GET_RETURN_FOR_RESERVE_DETAILS_SERIES_BY_SAP_R3] @RECEPTION_HEADER = 104
*/
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_RETURN_FOR_RESERVE_DETAILS_SERIES_BY_SAP_R3] (
