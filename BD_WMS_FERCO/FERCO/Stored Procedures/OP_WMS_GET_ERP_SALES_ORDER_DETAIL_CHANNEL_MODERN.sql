...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_GET_ERP_SALES_ORDER_DETAIL_CHANNEL_MODERN] @DOC_NUM = 1, @EXTERNAL_SOURCE_ID = 1
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_ERP_SALES_ORDER_DETAIL_CHANNEL_MODERN] (@DOC_NUM INT, @EXTERNAL_SOURCE_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
