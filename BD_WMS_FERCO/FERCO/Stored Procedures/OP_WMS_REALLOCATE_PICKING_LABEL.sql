...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_REALLOCATE_PICKING_LABEL]
					@LABEL_ID = 3
					,@TARGET_LOCATION = 'B01-P01-F01-NU'

*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_REALLOCATE_PICKING_LABEL (@LABEL_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    IF NOT EXISTS (SELECT TOP 1
          1
        FROM [FERCO].[OP_WMS_PICKING_LABELS]
        WHERE [LABEL_ID] = @LABEL_ID
        AND [LABEL_STATUS] <> 'DELIVERED')
    BEGIN
    ...
    IF NOT EXISTS (SELECT TOP 1
        ...
        WHERE [LOCATION_SPOT] = @TARGET_LOCATION)
    BEGIN
    ...
    SET [SOURCE_LOCATION] = [TARGET_LOCATION]
