...
EXEC [FERCO].OP_WMS_SP_GET_WAVE_PICKING_PENDING_TO_DISPATCH @LOGIN = 'RD'
*/
-- =============================================

CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_WAVE_PICKING_PENDING_TO_DISPATCH] (@LOGIN VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  AND MIN([TL].[DISPATCH_LICENSE_EXIT_COMPLETED]) = 0
