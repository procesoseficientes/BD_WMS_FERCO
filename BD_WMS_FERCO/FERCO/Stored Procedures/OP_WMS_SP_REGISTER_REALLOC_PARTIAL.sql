...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_REGISTER_REALLOC_PARTIAL]
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT CLASS_ID,
               ...
               LAST_UPDATED,
               PRIORITY
        FROM FERCO.OP_WMS_FN_GET_CLASSES_BY_LOCATION(@pTARGET_LOCATION);
        ...
        FROM FERCO.OP_WMS_FUNC_GETLOGIN_NAME(@pLOGIN_ID) L;
        ...
        FROM FERCO.OP_WMS_INV_X_LICENSE IL
            LEFT JOIN FERCO.OP_WMS_STATUS_OF_MATERIAL_BY_LICENSE SML
                ON (
        ...
        BEGIN
            ...
            SELECT @pTRADE_AGREEMENT,
                   ...
                   (
                       SELECT TOP 1
                              *
                       FROM FERCO.OP_WMS_FUNC_GETTRANS_DESC('REUBICACION_PARCIAL')
                   ),
                   ...
                   (
                       SELECT *
                       FROM FERCO.OP_WMS_FUNC_GETMATERIAL_DESC(@pMATERIAL_BARCODE, @pCLIENT_OWNER)
                   ),
                   @MATERIAL_CLASS,
                   FERCO.OP_WMS_FN_GET_MATERIAL_COST_BY_MATERIAL(@pMATERIAL_ID, @pCLIENT_OWNER_LOCAL),
                   @pSOURCE_LICENSE,
                   @pTARGET_LICENSE,
        ...
        BEGIN
            EXEC FERCO.OP_WMS_INSERT_MASTER_PACK_BY_REALLOC_PARTIAL @SOURCE_LICENSE = @pSOURCE_LICENSE,
        ...
        BEGIN
            EXEC FERCO.OP_WMS_SP_UPDATE_PARTIAL_LICENSE_FAST_PICKING @LOGIN_ID = @pLOGIN_ID,           -- varchar(50)
