...
-- Ejemplo de Ejecucion:
	      exec [FERCO].[OP_WMS_SP_PROCESS_CHARGE_SERVICES] @TYPE  = 'ON_DEMAND'
, @LAST_UPDATED_BY  = 'DU'
        SELECT * FROM   [FERCO].OP_WMS_SERVICES_TO_BILL ORDER BY PROCESS_DATE DESC
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_PROCESS_CHARGE_SERVICES (@TYPE VARCHAR(25) = 'AUTOMATIC_SERVICE'
...
BEGIN
  ...
  BEGIN TRY
    ...
    -- ------------------------------------------------------------------------------------
    DELETE [FERCO].[OP_WMS_SERVICES_TO_BILL]
    WHERE [IS_CHARGED] = 0
    ...
    WHERE [BILLING_FRECUENCY] = 15
      ...
      AND [PROCESS_DATE] BETWEEN [FERCO].[OP_WMS_FN_GET_FIRST_DAY_OF_MONTH](@PROCESS_DATE)
      AND [FERCO].[OP_WMS_FN_GET_LAST_DAY_OF_FIRST_FORTNIGHT](@PROCESS_DATE)
      AND [IS_CHARGED] = 0
    -- ------------------------------------------------------------------------------------
    ...
    WHERE [BILLING_FRECUENCY] = 15
      AND DATEPART(DAY, @PROCESS_DATE) > 15
      AND [PROCESS_DATE] BETWEEN [FERCO].[OP_WMS_FN_GET_LAST_DAY_OF_FIRST_FORTNIGHT](@PROCESS_DATE)
      AND [FERCO].[OP_WMS_FN_GET_LAST_DAY_OF_MONTH](@PROCESS_DATE)
      AND [IS_CHARGED] = 0
    ...
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_PALLET_POSITION] @PROCESS_DATE = @PROCESS_DATE
    ...
    -- ------------------------------------------------------------------------------------
    INSERT INTO [#DAY_SERVICES_TO_BILL] ([QTY], [TRANSACTION_TYPE], [PRICE], [TOTAL_AMOUNT], [PROCESS_DATE], [CREATED_DATE], [LAST_UPDATED_DATE], [LAST_UPDATED_BY], [TYPE_CHARGE_ID], [TYPE_CHARGE_DESCRIPTION], [CLIENT_CODE], [CLIENT_NAME], [IS_CHARGED], [INVOICE_REFERENCE], [CHARGED_DATE], [LICENSE_ID], [LOCATION], [SERVICE_ID], [SERVICE_CODE], [SERVICE_DESCRIPTION], [REGIMEN], [DOC_NUM], [TRANSACTION_ID], [HAS_ADJUST], [BILLING_FRECUENCY], [ACUERDO_COMERCIAL])
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_MT2] @PROCESS_DATE = @PROCESS_DATE
                                                 ,@LAST_UPDATED_BY = @LAST_UPDATED_BY
                                                 ,@TYPE = @TYPE
    ...
    -- ------------------------------------------------------------------------------------
    INSERT INTO [#DAY_SERVICES_TO_BILL] ([QTY], [TRANSACTION_TYPE], [PRICE], [TOTAL_AMOUNT], [PROCESS_DATE], [CREATED_DATE], [LAST_UPDATED_DATE], [LAST_UPDATED_BY], [TYPE_CHARGE_ID], [TYPE_CHARGE_DESCRIPTION], [CLIENT_CODE], [CLIENT_NAME], [IS_CHARGED], [INVOICE_REFERENCE], [CHARGED_DATE], [LICENSE_ID], [LOCATION], [SERVICE_ID], [SERVICE_CODE], [SERVICE_DESCRIPTION], [REGIMEN], [DOC_NUM], [TRANSACTION_ID], [ACUERDO_COMERCIAL])
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_AUDIT_DISPATCH] @INICIAL_DATE = @INICIAL_DATE
                                                            ,@END_DATE = @FINAL_DATE
                                                            ,@LAST_UPDATED_BY = @LAST_UPDATED_BY
    ...
    -- ------------------------------------------------------------------------------------
    INSERT INTO [#DAY_SERVICES_TO_BILL] ([QTY], [TRANSACTION_TYPE], [PRICE], [TOTAL_AMOUNT], [PROCESS_DATE], [CREATED_DATE], [LAST_UPDATED_DATE], [LAST_UPDATED_BY], [TYPE_CHARGE_ID], [TYPE_CHARGE_DESCRIPTION], [CLIENT_CODE], [CLIENT_NAME], [IS_CHARGED], [INVOICE_REFERENCE], [CHARGED_DATE], [LICENSE_ID], [LOCATION], [SERVICE_ID], [SERVICE_CODE], [SERVICE_DESCRIPTION], [REGIMEN], [DOC_NUM], [TRANSACTION_ID], [ACUERDO_COMERCIAL])
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_AUDIT_RECEPTION] @INICIAL_DATE = @INICIAL_DATE
                                                             ,@END_DATE = @FINAL_DATE
                                                             ,@LAST_UPDATED_BY = @LAST_UPDATED_BY
    ...
    -- ------------------------------------------------------------------------------------
    INSERT INTO [#DAY_SERVICES_TO_BILL] ([QTY], [TRANSACTION_TYPE], [PRICE], [TOTAL_AMOUNT], [PROCESS_DATE], [CREATED_DATE], [LAST_UPDATED_DATE], [LAST_UPDATED_BY], [TYPE_CHARGE_ID], [TYPE_CHARGE_DESCRIPTION], [CLIENT_CODE], [CLIENT_NAME], [IS_CHARGED], [INVOICE_REFERENCE], [CHARGED_DATE], [LICENSE_ID], [LOCATION], [SERVICE_ID], [SERVICE_CODE], [SERVICE_DESCRIPTION], [REGIMEN], [DOC_NUM], [TRANSACTION_ID], [ACUERDO_COMERCIAL])
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_PICKING] @INICIAL_DATE = @INICIAL_DATE
                                                     ,@END_DATE = @FINAL_DATE
                                                     ,@LAST_UPDATED_BY = @LAST_UPDATED_BY
    ...
    -- ------------------------------------------------------------------------------------
    INSERT INTO [#DAY_SERVICES_TO_BILL] ([QTY], [TRANSACTION_TYPE], [PRICE], [TOTAL_AMOUNT], [PROCESS_DATE], [CREATED_DATE], [LAST_UPDATED_DATE], [LAST_UPDATED_BY], [TYPE_CHARGE_ID], [TYPE_CHARGE_DESCRIPTION], [CLIENT_CODE], [CLIENT_NAME], [IS_CHARGED], [INVOICE_REFERENCE], [CHARGED_DATE], [LICENSE_ID], [LOCATION], [SERVICE_ID], [SERVICE_CODE], [SERVICE_DESCRIPTION], [REGIMEN], [DOC_NUM], [TRANSACTION_ID], [ACUERDO_COMERCIAL])
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_RECEPTION] @INICIAL_DATE = @INICIAL_DATE
                                                       ,@END_DATE = @FINAL_DATE
                                                       ,@LAST_UPDATED_BY = @LAST_UPDATED_BY
    ...
    -- ------------------------------------------------------------------------------------
    INSERT INTO [#DAY_SERVICES_TO_BILL] ([QTY], [TRANSACTION_TYPE], [PRICE], [TOTAL_AMOUNT], [PROCESS_DATE], [CREATED_DATE], [LAST_UPDATED_DATE], [LAST_UPDATED_BY], [TYPE_CHARGE_ID], [TYPE_CHARGE_DESCRIPTION], [CLIENT_CODE], [CLIENT_NAME], [IS_CHARGED], [INVOICE_REFERENCE], [CHARGED_DATE], [LICENSE_ID], [LOCATION], [SERVICE_ID], [SERVICE_CODE], [SERVICE_DESCRIPTION], [REGIMEN], [DOC_NUM], [TRANSACTION_ID], [ACUERDO_COMERCIAL])
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_TYPE_CHARGE_BY_LICENCE] @INICIAL_DATE = @INICIAL_DATE
                                                                    ,@END_DATE = @FINAL_DATE
                                                                    ,@LAST_UPDATED_BY = @LAST_UPDATED_BY
    ...
    EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_TYPE_CHARGE_BY_FREQUENCY] @PROCESS_DATE = @PROCESS_DATE
                                                                      ,@LAST_UPDATED_BY = @LAST_UPDATED_BY
                                                                      ,@TYPE = @TYPE
    ...
    --
    INSERT INTO [FERCO].[OP_WMS_SERVICES_TO_BILL]
      SELECT
        [QTY]
       ,[TRANSACTION_TYPE]
       ,[PRICE]
