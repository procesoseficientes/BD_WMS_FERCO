...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].OP_WMS_SP_GET_LICENSE_DISPATCH_PRINT_FORMAT
					@LICENSE_ID = 135466
					,@LOGIN_ID = '2005QA'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_LICENSE_DISPATCH_PRINT_FORMAT] (
		@LICENSE_ID INT
		,@LOGIN_ID VARCHAR(25)
	)
AS
BEGIN
  ...
  --
	...
	BEGIN
		EXEC [FERCO].[OP_WMS_SP_GET_LICENSE_PRINT_FORMAT] @LICENSE_ID = @LICENSE_ID, -- int
