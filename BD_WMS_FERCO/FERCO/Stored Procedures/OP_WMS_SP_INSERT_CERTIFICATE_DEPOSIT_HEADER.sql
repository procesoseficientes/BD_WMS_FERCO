...
Ejemplo de Ejecucion:
                    EXEC [[FERCO]].[OP_WMS_SP_INSERT_CERTIFICATE_DEPOSIT_HEADER] 
                    @VALID_FROM = '2016-02-10 12:19:04.323'
                    ,@VALID_TO = '2016-02-15 12:19:04.323'
                    ,@NAME_USER = 'ADMIN'
                    ,@STATUS = 'ACTIVO'
                    ,@CLIENT_NODE = NULL 
                    SELECT * FROM [[FERCO]].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER]
        
                
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_CERTIFICATE_DEPOSIT_HEADER]
(
    @VALID_FROM DATE
    ,@VALID_TO DATE
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO [FERCO].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER] (
            [VALID_FROM]
            ,[VALID_TO]
            ,[LAST_UPDATED]
            ,[LAST_UPDATED_BY]
