...
-- Ejemplo de Ejecucion:  
	EXEC [FERCO].OP_WMS_SP_GET_CAN_REALLOCATE_OPERATORS_ASSIGNED_TO_DISTRIBUTION_CENTER_BY_USER @LOGIN = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_CAN_REALLOCATE_OPERATORS_ASSIGNED_TO_DISTRIBUTION_CENTER_BY_USER (@LOGIN VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
