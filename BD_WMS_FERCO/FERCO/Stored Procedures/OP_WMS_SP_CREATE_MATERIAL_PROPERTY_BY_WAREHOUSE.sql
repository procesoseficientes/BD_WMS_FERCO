...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_CREATE_MATERIAL_PROPERTY_BY_WAREHOUSE]
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CREATE_MATERIAL_PROPERTY_BY_WAREHOUSE (@MATERIAL_PROPERTY_ID INT
...
BEGIN
  ...
  BEGIN TRY
    DECLARE @ID INT
    --
    INSERT INTO [FERCO].[OP_WMS_MATERIAL_PROPERTY_BY_WAREHOUSE] ([MATERIAL_PROPERTY_ID]
    , [WAREHOUSE_ID]
    , [MATERIAL_ID]
    , [VALUE]
    , [CREATED_BY]
    ...
    , [LAST_UPDATE_BY]
    , [LAST_UPDATE])
      VALUES (@MATERIAL_PROPERTY_ID  -- MATERIAL_PROPERTY_ID - int
