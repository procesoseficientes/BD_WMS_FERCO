...
-- Ejemplo de Ejecucion:
			...
			--
			EXEC [FERCO].[OP_WMS_SP_GET_NEXT_PICKING_DEMAND_DETAIL_FOR_R3] 
				@PICKING_DEMAND_HEADER_ID = 27
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_NEXT_PICKING_DEMAND_DETAIL_FOR_R3] (
...
BEGIN
  ...
  --
	SELECT TOP 1
		@IS_INTERNAL_SALE = 1
	FROM
		[FERCO].[OP_WMS_FUNC_SPLIT_3](@INTERNAL_SALE, '|')
	WHERE
		[VALUE] = @PICKING_OWNER;
  --
