...
-- Ejemplo de Ejecucion:
            EXEC [FERCO].OP_WMS_SP_GET_BALANCE_OF_PAYMENTS_BY_FISCAL @LOGIN = 'ADMIN'
   
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_BALANCE_OF_PAYMENTS_BY_FISCAL (@LOGIN VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  INSERT INTO @POLIZA ([DOC_ID], [CODIGO_POLIZA], [NUMERO_ORDEN], [FECHA_DOCUMENTO], [REGIMEN], [LICENSE_ID], [MATERIAL_ID], [LINE_NUMBER], [CUSTOMS_AMOUNT], [VALOR_UNITARIO_CIF], [VALOR_UNITARIO_IMPUESTO])
    ...
    FROM [FERCO].[OP_WMS3PL_POLIZA_TRANS_MATCH] [PTM]
  ...
  INNER JOIN [FERCO].[OP_WMS_CONFIGURATIONS] [CG]
    ON (
