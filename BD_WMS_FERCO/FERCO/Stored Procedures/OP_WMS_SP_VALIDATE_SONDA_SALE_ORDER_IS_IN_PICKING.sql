...
-- Ejemplo de Ejecucion:
                EXEC [FERCO].[OP_WMS_SP_VALIDATE_SONDA_SALE_ORDER_IS_IN_PICKING] @SALE_ORDER_ID = 123123
				EXEC [FERCO].[OP_WMS_SP_VALIDATE_SONDA_SALE_ORDER_IS_IN_PICKING] @SALE_ORDER_ID = 14322
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_VALIDATE_SONDA_SALE_ORDER_IS_IN_PICKING (@SALE_ORDER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
