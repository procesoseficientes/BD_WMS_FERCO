...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_LICENSE_PRINT_FORMAT]
					@LICENSE_ID = 90
					,@LOGIN = 'ACAMACHO'
					,@REIMPRESION = 1
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_LICENSE_PRINT_FORMAT] (
		@LICENSE_ID INT
		,@LOGIN VARCHAR(25)
		,@REIMPRESION INT
	)
...
BEGIN
	...
	SELECT TOP 1
		...
		,@COMPANY =  UPPER([c].[CLIENT_CODE])+'-'+ [c].[COMPANY_NAME]
	FROM
		[FERCO].[OP_WMS_LICENSES] [l]
	INNER JOIN [FERCO].[OP_WMS_COMPANY] [c] ON [c].[CLIENT_CODE] = [l].[CLIENT_OWNER]
	WHERE
