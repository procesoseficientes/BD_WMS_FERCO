...
CREATE PROCEDURE FERCO.OP_WMS_SP_SET_POLIZA_PENDING_RECTIFICATION @DOC_ID NUMERIC(18)
...
BEGIN
  BEGIN TRY
    ...
    SET CODIGO_POLIZA_RECTIFICACION = @CODIGO_POLIZA_RECTIFADA
       ,CODIGO_POLIZA = NULL
       ,LAST_UPDATED = GETDATE()
       ,LAST_UPDATED_BY = @LAST_UPDATED_BY
