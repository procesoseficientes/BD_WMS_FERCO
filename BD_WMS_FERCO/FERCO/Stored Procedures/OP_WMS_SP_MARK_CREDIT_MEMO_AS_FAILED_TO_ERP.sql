...
-- Description:			Modificación del orden de los parametros por problemas con la interfaz de devoluciones.

/*
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_MARK_CREDIT_MEMO_AS_FAILED_TO_ERP]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_MARK_CREDIT_MEMO_AS_FAILED_TO_ERP]
(
