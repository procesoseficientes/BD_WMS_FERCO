...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_GET_MEASUREMENT_UNIT]
				--
				EXEC [FERCO].[OP_WMS_GET_MEASUREMENT_UNIT]
					@CLIENT_ID = 'C00015'
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_MEASUREMENT_UNIT] (
...
BEGIN
	...
	FROM
		[FERCO].[OP_WMS_UNIT_MEASUREMENT_BY_MATERIAL] [UM]
	...
	LEFT JOIN [FERCO].[OP_WMS_CONFIGURATIONS] [CONF] ON [CONF].[PARAM_NAME] = [UM].[MEASUREMENT_UNIT];
END;
