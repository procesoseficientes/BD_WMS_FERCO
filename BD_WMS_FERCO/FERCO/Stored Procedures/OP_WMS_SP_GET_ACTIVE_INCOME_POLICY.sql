...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_ACTIVE_INCOME_POLICY] @WAREHOUSE ='CEDI_ZONA_5', @CLIENT_OWNER = 'FERCO'
				SELECT * FROM [FERCO].[OP_WMS_POLIZA_HEADER]

*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_ACTIVE_INCOME_POLICY] (
...
BEGIN
	...
	SELECT
		...
		, [H].[NUMERO_ORDEN] 
	FROM
		[FERCO].[OP_WMS_POLIZA_HEADER] [H]
	INNER JOIN [FERCO].[OP_WMS_LICENSES] [L] ON [L].[CODIGO_POLIZA] = [H].[CODIGO_POLIZA]
