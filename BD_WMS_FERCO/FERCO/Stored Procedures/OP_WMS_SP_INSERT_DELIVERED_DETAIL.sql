...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_INSERT_DELIVERED_DETAIL] @LABEL_ID = 5, @WAVE_PICKING_ID = 21
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_DELIVERED_DETAIL] (@LABEL_ID INT
, @STATUS VARCHAR(50)
, @LOGIN_ID VARCHAR(50)
...
BEGIN
  ...
  BEGIN TRY
    ...
    IF EXISTS (SELECT TOP 1
          1
        FROM [FERCO].[OP_WMS_DELIVERED_DISPATCH_DETAIL] [DL]
    ...
    INSERT INTO [FERCO].[OP_WMS_DELIVERED_DISPATCH_DETAIL] ([LABEL_ID]
    , [LAST_UPDATE]
    , [LAST_UPDATE_BY]
    ...
    UPDATE [FERCO].[OP_WMS_PICKING_LABELS]
