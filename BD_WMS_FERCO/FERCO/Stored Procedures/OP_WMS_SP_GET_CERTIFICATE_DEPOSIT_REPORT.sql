...
Ejemplo de Ejecucion:
                --
                EXEC [FERCO].OP_WMS_SP_GET_CERTIFICATE_DEPOSIT_REPORT
                    @ID_DEPOSIT_HEADER = 1
                --    
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_CERTIFICATE_DEPOSIT_REPORT] (
...
BEGIN
	...
	FROM
		[FERCO].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL] AS [CDD]
	INNER JOIN [FERCO].[OP_WMS_POLIZA_HEADER] [PH] ON ([CDD].[DOC_ID] = [PH].[DOC_ID])
	INNER JOIN [FERCO].[OP_WMS_LICENSES] [L] ON ([PH].[CODIGO_POLIZA] = [L].[CODIGO_POLIZA])
	...
	INNER JOIN [FERCO].[OP_WMS_VIEW_INSURANCE_DOC] [ID] ON ([ID].[POLIZA_INSURANCE] = [PH].[POLIZA_ASEGURADA])
	LEFT JOIN [FERCO].[OP_WMS_POLIZA_DETAIL] [PD] ON (
											[PH].[DOC_ID] = [PD].[DOC_ID]
