...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_TASKS_GENERAL_DISCRETIONARY]
  ...
  --DECLARE @HAVBATCH NUMERIC(18);
	...
	BEGIN TRY
		...
		IF NOT EXISTS ( SELECT
							1
						FROM
							[FERCO].[OP_WMS_VIEW_INVENTORY_GENERAL_BY_MATERIALS]
						WHERE
      ...
      ---- ------------------------------------------------------------------------------------
      --              EXEC [FERCO].[OP_WMS_SP_CANCEL_PICKING_DETAIL_LINE] @LOGIN_ID = @TASK_ASSIGNEDTO,
      --                  @WAVE_PICKING_ID = @WAVE_PICKING_ID,
