...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_POLIZA_TO_AUTHORIZE] @START_DATE = '2014-01-01 23:59:00.000'
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_POLIZA_TO_AUTHORIZE]
(
    @START_DATE DATETIME,
    @END_DATE DATETIME,
    @LOGIN VARCHAR(25),
...
BEGIN
    ...
    FROM [FERCO].[OP_WMS_POLIZA_HEADER] [PH]
        ...
        INNER JOIN [FERCO].OP_WMS_FUNC_SPLIT_3(@WAREHOUSES_ID, @DELIMITER) [WF]
            ON ([T].[TARGET_WAREHOUSE] = [WF].[VALUE])
        LEFT JOIN [FERCO].OP_WMS_FN_GET_INSURANCE_DOC() [ID]
        ...
        LEFT JOIN [FERCO].[OP_WMS_VIEW_CLIENTS] [VC]
