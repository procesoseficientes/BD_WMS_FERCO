...
EXEC [FERCO].[OP_WMS_SP_CERTIFICATION_BY_SERIAL_NUMBER] @CERTIFICATION_HEADER_ID = 1
                                       ,@MATERIAL_ID = 'arium/prueba'
                                       ,@SERIAL_NUMBER = '258636'                                       
			SELECT * FROM [FERCO].[OP_WMS_TASK] 
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_DELETE_CERTIFICATION_BY_SERIAL_NUMBER]
    (
...
BEGIN
    ...
    BEGIN TRY
        ...
        DELETE
            [FERCO].[OP_WMS_CERTIFICATION_BY_SERIAL_NUMBER]
        WHERE
