...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_PROPERTY_BY_WAREHOUSE_FOR_MATERIAL]
					@MATERIAL_ID = 'Me_Llega/C00000493'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_PROPERTY_BY_WAREHOUSE_FOR_MATERIAL (@MATERIAL_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  FROM [FERCO].[OP_WMS_MATERIAL_PROPERTY_BY_WAREHOUSE] [MPW]
  INNER JOIN [FERCO].[OP_WMS_MATERIAL_PROPERTY_OPTION] [MPO]
    ON (
