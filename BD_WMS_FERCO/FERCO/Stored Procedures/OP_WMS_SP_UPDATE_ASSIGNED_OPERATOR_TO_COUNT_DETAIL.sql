...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_UPDATE_ASSIGNED_OPERATOR_TO_COUNT_DETAIL]  @PHYSICAL_COUNT_DETAIL_ID = 8, 
                                                                            @ASSIGNED_TO ='BCORADO'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_ASSIGNED_OPERATOR_TO_COUNT_DETAIL (@PHYSICAL_COUNT_DETAIL_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    IF @MISMA_BODEGA <> 'NO'
    BEGIN
      UPDATE [FERCO].[OP_WMS_PHYSICAL_COUNTS_DETAIL]
