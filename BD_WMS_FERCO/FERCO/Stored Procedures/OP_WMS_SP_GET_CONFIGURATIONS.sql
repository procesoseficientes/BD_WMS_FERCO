...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_GET_CONFIGURATIONS 
  exec [FERCO].OP_WMS_SP_GET_CONFIGURATIONS @PARAM_TYPE='SISTEMA',@PARAM_GROUP='RECEPCION',@PARAM_NAME='AÑOS_A_AGREGAR_A_FECHA_DE_VENCIMIENTO_DE_LOTE'

*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_CONFIGURATIONS (@PARAM_TYPE VARCHAR(25)
