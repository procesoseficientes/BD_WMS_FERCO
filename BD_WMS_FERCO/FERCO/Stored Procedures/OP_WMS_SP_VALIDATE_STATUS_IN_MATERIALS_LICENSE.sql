...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_VALIDATE_STATUS_IN_MATERIALS_LICENSE] @LICENSE = 32166
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_VALIDATE_STATUS_IN_MATERIALS_LICENSE (@LICENSE NUMERIC)
AS
BEGIN
  SET NOCOUNT ON;
  --
