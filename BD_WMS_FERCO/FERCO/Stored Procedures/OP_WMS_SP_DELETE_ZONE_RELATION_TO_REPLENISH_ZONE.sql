...
EXEC [FERCO].[OP_WMS_SP_DELETE_ZONE_RELATION_TO_REPLENISH_ZONE]
	@ZONE_ID = 3 , -- int
...
--GO
CREATE PROCEDURE FERCO.OP_WMS_SP_DELETE_ZONE_RELATION_TO_REPLENISH_ZONE @ZONE_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    --
    DELETE FROM [FERCO].[OP_WMS_ZONE_TO_REPLENISH_IN_ZONE]
    WHERE [ZONE_ID] = @ZONE_ID
      AND [REPLENISH_ZONE_ID] = @REPLENISH_ZONE_ID;
    --
