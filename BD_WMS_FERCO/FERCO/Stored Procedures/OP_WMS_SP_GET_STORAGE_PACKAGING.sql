...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_STORAGE_PACKAGING]
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_STORAGE_PACKAGING](
...
BEGIN
	...
	LEFT JOIN [FERCO].[OP_WMS_UNIT_MEASUREMENT_BY_MATERIAL] [M] ON( ([M].MEASUREMENT_UNIT = [C].PARAM_NAME) AND (M.MATERIAL_ID = @MATERIAL_ID))
	WHERE 
