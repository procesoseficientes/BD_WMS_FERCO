...
/*
	EXECUTE [FERCO].[OP_WMS_INSERT_PILOT_FROM_DISPATCH_LICENCE] @NAME_PILOT = 'Rudi', @LAST_NAME = 'Garcia'                                                    
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_INSERT_PILOT_FROM_DISPATCH_LICENCE] (
