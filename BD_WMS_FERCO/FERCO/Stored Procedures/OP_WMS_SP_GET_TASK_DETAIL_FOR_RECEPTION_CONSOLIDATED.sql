...
-- Ejemplo de Ejecucion:
	exec ferco.OP_WMS_SP_GET_TASK_DETAIL_FOR_RECEPTION_CONSOLIDATED @SERIAL_NUMBER=10371000

	SELECT * FROM [FERCO].OP_WMS_TASK_LIST
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_TASK_DETAIL_FOR_RECEPTION_CONSOLIDATED] (@SERIAL_NUMBER INT)
AS
...
BEGIN
    ...
    BEGIN
        ...
        FROM [FERCO].[OP_WMS_POLIZA_HEADER] [PH]
            ...
            INNER JOIN [FERCO].[OP_WMS_TRANS] [TR]
                ON (
...
BEGIN
    ...
    (SELECT [M].[MATERIAL_ID] AS [MATERIAL_ID],
     ...
     FROM [#RECEPTION_DETAIL] [RDD]
         LEFT JOIN [FERCO].[OP_WMS_TRANS] [TR]
