...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_CREATE_WAREHOUSE] 
				...
				-- 
				SELECT * FROM [FERCO].[OP_WMS_WAREHOUSES] 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CREATE_WAREHOUSE (@WAREHOUSE_ID VARCHAR(25)
, @NAME VARCHAR(50)
...
BEGIN
  ...
  BEGIN TRY
    DECLARE @ID INT
    --
    INSERT INTO [FERCO].[OP_WMS_WAREHOUSES] ([WAREHOUSE_ID]
    , [NAME]
    , [COMMENTS]
    , [ERP_WAREHOUSE]
    , [SHUNT_NAME]
    ...
    , [PICKING_TYPE])
      VALUES (@WAREHOUSE_ID  -- WAREHOUSE_ID - varchar(25)
