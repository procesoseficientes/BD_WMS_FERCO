...
--        EXEC [FERCO].[OP_WMS_SP_GET_CLASS_NOT_ASSOCIATED_SLOTTING_ZONE] @ID_SLOTTING = 'E80CD6C1-3D8D-E911-8106-60A44CCD8810'
--*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_CLASS_NOT_ASSOCIATED_SLOTTING_ZONE]
...
BEGIN
    ...
    FROM [FERCO].[OP_WMS_CLASS] [C]
        LEFT JOIN [FERCO].[OP_WMS_SLOTTING_ZONE_BY_CLASS] [SZC]
            ON (
