...
--        EXEC [FERCO].[OP_WMS_SP_GET_SUB_CLASS_BY_SLOTTING_ZONE] @ID_SLOTTING = '8461C8AF-708D-E911-8106-60A44CCD8810' -- uniqueidentifier
--*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_SUB_CLASS_BY_SLOTTING_ZONE]
...
BEGIN
    ...
    FROM [FERCO].[OP_WMS_SLOTTING_ZONE_BY_SUB_CLASS]
