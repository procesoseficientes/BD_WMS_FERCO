...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_GET_INFO_OF_NO_INMEDIATE_PICKING] @WAVE_PICKING_ID = 4974
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_INFO_OF_NO_INMEDIATE_PICKING] (@WAVE_PICKING_ID INT)
AS
BEGIN
	SET NOCOUNT ON;
	--	
