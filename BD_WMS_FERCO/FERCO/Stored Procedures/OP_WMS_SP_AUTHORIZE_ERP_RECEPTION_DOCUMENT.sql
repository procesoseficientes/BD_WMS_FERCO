...
-- Modificacion 10/10/2017 @ NEXUS-Team Sprint eFERCO
					-- rodrigo.gomez
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_AUTHORIZE_ERP_RECEPTION_DOCUMENT] (
  ...
  --
	BEGIN TRY
		...
		SELECT TOP 1
			@TASK_ID = [TASK_ID]
		FROM
			[FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] WITH (NOLOCK)
		WHERE
