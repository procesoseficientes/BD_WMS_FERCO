...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_TOP_5_UPDATES_DELIVERY_NOTE] @owner = 'me_llega'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_TOP_5_UPDATES_DELIVERY_NOTE (@OWNER VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  WHERE [mh].[STATUS] IN ('ASSIGNED', 'COMPLETED')
