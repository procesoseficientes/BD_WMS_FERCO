...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_CREATE_REPLEANISH_TASK] @MATERIAL_ID = 'C00277/MILAN-16M'
                                                       ,@WAVE_PICKING_ID = 0
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CREATE_REPLEANISH_TASK (@MATERIAL_ID VARCHAR(25)
