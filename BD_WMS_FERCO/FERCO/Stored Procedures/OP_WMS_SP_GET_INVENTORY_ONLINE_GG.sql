...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_INVENTORY_ONLINE_GG] @LOGIN = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INVENTORY_ONLINE_GG]
(@LOGIN VARCHAR(25))
AS
BEGIN
    SET NOCOUNT ON;
    ...
    EXEC [FERCO].[OP_WMS_SP_GET_WAREHOUSE_ASSOCIATED_WITH_USER] @LOGIN_ID = 'admin';
