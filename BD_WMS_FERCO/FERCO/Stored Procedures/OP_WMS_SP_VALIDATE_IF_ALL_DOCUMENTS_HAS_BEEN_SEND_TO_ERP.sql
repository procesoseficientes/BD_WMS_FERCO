...
-- Ejemplo de Ejecucion:
         EXEC [FERCO].[OP_WMS_SP_VALIDATE_IF_ALL_DOCUMENTS_HAS_BEEN_SEND_TO_ERP] @TASK_ID = 101
*/
CREATE PROCEDURE [FERCO].[OP_WMS_SP_VALIDATE_IF_ALL_DOCUMENTS_HAS_BEEN_SEND_TO_ERP] (@TASK_ID INT)
AS
BEGIN
	--
	DECLARE
