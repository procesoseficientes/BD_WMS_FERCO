...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_CLASSES_BY_NAME]
					@NAME = 'Baterias'
				-- 
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_CLASSES_BY_NAME]
@NAME VARCHAR(50)
AS
BEGIN
	SELECT
		...
		CLASS_NAME
	FROM
		[FERCO].[OP_WMS_CLASS] [CL]
	JOIN
		[FERCO].[OP_WMS_CONFIGURATIONS] [CO] ON ([CL].[CLASS_TYPE] = [CO].[PARAM_NAME]
