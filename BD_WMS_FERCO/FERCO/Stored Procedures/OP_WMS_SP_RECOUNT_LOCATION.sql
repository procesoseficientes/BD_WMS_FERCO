...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_RECOUNT_LOCATION] @LOGIN= 'ACAMACHO' 
, @TASK_ID = 7
, @LOCATION = 'B02-P01-F01-NU'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_RECOUNT_LOCATION] (
		@LOGIN VARCHAR(25)
		,@TASK_ID INT
		,@LOCATION VARCHAR(25)
	)
...
BEGIN
  ...
  --
	...
	BEGIN TRY
		...
		INNER JOIN [FERCO].[OP_WMS_PHYSICAL_COUNTS_DETAIL] [D] ON [E].[PHYSICAL_COUNT_DETAIL_ID] = [D].[PHYSICAL_COUNT_DETAIL_ID]
