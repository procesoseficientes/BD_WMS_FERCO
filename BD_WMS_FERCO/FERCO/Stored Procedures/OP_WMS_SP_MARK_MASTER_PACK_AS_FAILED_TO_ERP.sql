...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_MARK_MASTER_PACK_AS_FAILED_TO_ERP]
          @MASTER_PACK_HEADER_ID  = 1
          ,@POSTED_RESPONSE = 'Error de sap'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_MARK_MASTER_PACK_AS_FAILED_TO_ERP] (@MASTER_PACK_HEADER_ID INT
, @POSTED_RESPONSE VARCHAR(500))
AS
BEGIN
  SET NOCOUNT ON;
  DECLARE 
	@ERP_REFERENCE VARCHAR(50) = -1
	,@IS_IMPLOSION INT = 0
  --
	BEGIN TRY
