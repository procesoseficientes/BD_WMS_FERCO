...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_MATERIALS_COMPONENTS_MASTER_PACK] @MATERIAL_ID = 'FERCO/PT0001'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MATERIALS_COMPONENTS_MASTER_PACK] (@MATERIAL_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  FROM [FERCO].[OP_WMS_COMPONENTS_BY_MASTER_PACK] [MP]
  INNER JOIN [FERCO].[OP_WMS_MATERIALS] [C]
