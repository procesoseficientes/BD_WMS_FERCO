...
--                      licencia
-- ================================================================================================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_REGISTER_GENERAL_TRANSFER_RECEPTION]
...
BEGIN
    ...
    BEGIN TRY
        ...
        (   ISNULL(
            ...
            (
                SELECT *
                FROM [ferco].[OP_WMS_FUNC_GETMATERIAL_DESC](@MATERIAL_BARCODE, @CLIENT_OWNER_LOCAL)
            ),                                                                                            -- MATERIAL_DESCRIPTION
            ISNULL(
            (
        ...
        BEGIN
            EXEC [ferco].[OP_WMS_SP_UPDATE_LICENSE_FAST_PICKING] @LOGIN_ID = @pLOGIN_ID,           -- varchar(50)
