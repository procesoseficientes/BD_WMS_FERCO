 ...
 -- Ejemplo de Ejecucion:
        ...
        exec [FERCO].[OP_WMS_SP_CREATE_MATERIAL_STATUS] 'ESTADO_DEFAULT', @STATUS_ID OUT , @DEFAULT = 1
				SELECT  @STATUS_ID
				SELECT * FROM [FERCO].[OP_WMS_STATUS_OF_MATERIAL_BY_LICENSE] WHERE [STATUS_ID] = @STATUS_ID
 */
 -- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_CREATE_MATERIAL_STATUS] (
