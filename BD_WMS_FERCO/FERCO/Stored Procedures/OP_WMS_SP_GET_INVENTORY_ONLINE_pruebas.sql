...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_INVENTORY_ONLINE_pruebas] @LOGIN = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INVENTORY_ONLINE_pruebas]
(@LOGIN VARCHAR(25))
AS
BEGIN
    SET NOCOUNT ON;
    ...
    WHERE [ID].[QTY] > 0 AND [ID].[MATERIAL_ID] = 'ferco/029929';
END;
