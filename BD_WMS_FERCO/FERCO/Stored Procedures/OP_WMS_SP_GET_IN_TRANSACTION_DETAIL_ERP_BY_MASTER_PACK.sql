...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_IN_TRANSACTION_DETAIL_ERP_BY_MASTER_PACK] @MASTER_PACK_HEADER_ID = 15
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_IN_TRANSACTION_DETAIL_ERP_BY_MASTER_PACK (@MASTER_PACK_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  SELECT
   ...
   ,[FERCO].[OP_WMS_GET_STRING_FROM_CHAR]([MPD].[MATERIAL_ID],
    '/') AS ItemCode
  ...
  INNER JOIN [FERCO].[OP_WMS_MASTER_PACK_DETAIL] [MPD]
