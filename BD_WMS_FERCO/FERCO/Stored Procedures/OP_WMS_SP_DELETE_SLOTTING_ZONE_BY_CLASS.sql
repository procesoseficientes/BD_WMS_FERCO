...
/*
	EXECUTE [FERCO].[OP_WMS_SP_DELETE_SLOTTING_ZONE_BY_CLASS] @ID_SLOTTING_ZONE = 'E80CD6C1-3D8D-E911-8106-60A44CCD8810', -- varchar(50)
																@XML = '<ArrayOfClase>
																			<Clase>
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_DELETE_SLOTTING_ZONE_BY_CLASS]
(
...
BEGIN TRY
    ...
    DELETE [SZD]
    FROM [FERCO].[OP_WMS_SLOTTING_ZONE_BY_CLASS] [SZD]
