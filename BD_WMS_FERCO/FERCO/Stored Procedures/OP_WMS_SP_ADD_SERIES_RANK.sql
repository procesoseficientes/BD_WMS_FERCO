...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_ADD_SERIES_RANK] @LICENSE_ID = NULL, -- numeric
...
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_ADD_SERIES_RANK] (
		...
		BEGIN
			...
			BEGIN
				...
				INSERT	INTO @OPERACION
						...
						EXEC [FERCO].[OP_WMS_SP_INSERT_MATERIAL_X_SERIAL_NUMBER] @LICENSE_ID = @LICENSE_ID, -- numeric
			...
			ELSE
				...
				BEGIN 
					INSERT	INTO @OPERACION
							...
							EXEC [FERCO].[OP_WMS_SP_UPDATE_SCANNED_SERIAL_NUMBER_TO_PROCESS_RANK] @SERIAL_NUMBER = @I_SERIAL, -- varchar(50)
