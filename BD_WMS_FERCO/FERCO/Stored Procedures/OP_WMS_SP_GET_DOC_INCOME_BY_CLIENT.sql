...
Ejemplo de Ejecucion:
							EXEC [FERCO].OP_WMS_SP_GET_DOC_INCOME_BY_CLIENT @CODE_CLIENT = 'C40' , @START_DATE = '20160101', @END_DATE = '20160703'
*/
-- =============================================

CREATE PROCEDURE FERCO.OP_WMS_SP_GET_DOC_INCOME_BY_CLIENT @CODE_CLIENT VARCHAR(25)
, @START_DATE DATE
, @END_DATE DATE
AS
  SELECT DISTINCT
