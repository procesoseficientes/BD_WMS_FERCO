...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_MARK_CREDIT_MEMO_AS_SEND_TO_ERP]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_MARK_CREDIT_MEMO_AS_SEND_TO_ERP](
...
BEGIN
	...
	BEGIN TRY
		...
		-- ------------------------------------------------------------------------------------
		IF NOT EXISTS (SELECT * FROM [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL] WHERE [IS_POSTED_ERP] <> 1 AND [ERP_RECEPTION_DOCUMENT_HEADER_ID] = @RECEPTION_HEADER_ID)
		BEGIN
