...
*/
CREATE PROCEDURE [FERCO].[OP_WMS_GET_PENDING_TASK_BY_USER_SUPER]
...
BEGIN
    ...
    FROM FERCO.OP_WMS_TASK_LIST [WTL]
...
--EXECUTE FERCO.OP_WMS_GET_PENDING_TASK_BY_USER_SUPER @LOGIN_ID = 'MARVIN' -- varchar(100)