...
-- Ejemplo de Ejecucion:
	 EXEC [FERCO].[OP_WMS_SP_GET_LOCATION_TASK_BY_LOGIN] @LOGIN_ID = 'ACAMACHO', @TASK_TYPE = 'TAREA_REUBICACION'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_LOCATION_TASK_BY_LOGIN] (@LOGIN_ID VARCHAR(25)
