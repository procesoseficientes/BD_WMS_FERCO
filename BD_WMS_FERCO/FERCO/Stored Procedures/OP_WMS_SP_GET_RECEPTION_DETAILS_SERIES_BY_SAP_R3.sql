...
-- Description:			obtiene las series que se deben enviar para un documento por orden de compra

/*
-- Ejemplo de Ejecucion:
         EXEC [FERCO].[OP_WMS_SP_GET_RECEPTION_DETAILS_SERIES_BY_SAP_R3] @RECEPTION_HEADER = 104
*/
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_RECEPTION_DETAILS_SERIES_BY_SAP_R3] (
