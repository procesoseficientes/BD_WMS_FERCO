...
-- Ejemplo de Ejecucion:
		EXEC 	[FERCO].[OP_WMS_SP_GET_LOCATION_BY_ZONE_OR_WAREHOUSE] @WAREHOUSE = 'BODEGA_04|BODEGA_05', @ZONE = 'BODEGA_04_PASILLO'
  SELECT * FROM [FERCO].[OP_WMS_SHELF_SPOTS] [S] 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_LOCATION_BY_ZONE_OR_WAREHOUSE (@WAREHOUSE VARCHAR(MAX),
