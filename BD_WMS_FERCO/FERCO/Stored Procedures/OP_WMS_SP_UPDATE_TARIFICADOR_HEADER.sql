...
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_TARIFICADOR_HEADER @ACUERDO_COMERCIAL_ID INT,
...
BEGIN
  ...
  BEGIN TRAN
  BEGIN
    UPDATE FERCO.OP_WMS_TARIFICADOR_HEADER
    SET ACUERDO_COMERCIAL_NOMBRE = @ACUERDO_COMERCIAL_NOMBRE
