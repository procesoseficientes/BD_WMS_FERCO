...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].OP_WMS_SP_GET_SUGGESTED_LOCATIONS_OF_MATERIAL_BY_LICENSE
				@LOGIN = 'MDUARTE@FERCOGT'
					,@LICENSE_ID = 4186824
...
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_SUGGESTED_LOCATIONS_OF_MATERIAL_BY_LICENSE] (
		@LOGIN VARCHAR(50)
		,@LICENSE_ID INT
	)
AS
