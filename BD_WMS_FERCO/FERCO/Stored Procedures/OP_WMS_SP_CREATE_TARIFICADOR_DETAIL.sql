...
-- Ejemplo de Ejecucion:
		...
		--
		[FERCO].[OP_WMS_SP_CREATE_TARIFICADOR_DETAIL]
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CREATE_TARIFICADOR_DETAIL @ACUERDO_COMERCIAL INT
, @TYPE_CHARGE_ID INT
, @UNIT_PRICE INT
, @CURRENCY VARCHAR(20)
...
BEGIN
  ...
  BEGIN TRAN;
  BEGIN
    INSERT INTO [FERCO].[OP_WMS_TARIFICADOR_DETAIL] ([ACUERDO_COMERCIAL]
    , [TYPE_CHARGE_ID]
    , [UNIT_PRICE]
    , [CURRENCY]
    , [COMMENTS]
