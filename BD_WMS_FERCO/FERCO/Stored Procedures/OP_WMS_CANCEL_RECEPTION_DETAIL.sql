...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_CANCEL_RECEPTION_DETAIL] @XML = '<ArrayOfTareaDetalle >
  <TareaDetalle>
    <SERIAL_NUMBER>537566</SERIAL_NUMBER>
    <MATERIAL_ID>FERCO/001792</MATERIAL_ID>
    <MATERIAL_NAME>FERCO/001792</MATERIAL_NAME>
    <QTY>3.0000</QTY>
    <QTY_DOC>0</QTY_DOC>
    ...
    <BARCODE_ID>FERCO/001792</BARCODE_ID>
  ...
  <TareaDetalle>
    <SERIAL_NUMBER>537566</SERIAL_NUMBER>
    <MATERIAL_ID>FERCO/001799</MATERIAL_ID>
    <MATERIAL_NAME>FERCO/001799</MATERIAL_NAME>
    <QTY>3.0000</QTY>
    <QTY_DOC>0</QTY_DOC>
    <QTY_DIFFERENCE>3.0000</QTY_DIFFERENCE>
    <TASK_COMMENTS>TAREA DE RECEPCION NO. 537566</TASK_COMMENTS>
    <WAVE_PICKING_ID>0</WAVE_PICKING_ID>
    <BARCODE_ID>FERCO/001799</BARCODE_ID>
    <CODIGO_POLIZA_SOURCE>513883</CODIGO_POLIZA_SOURCE>
    <USE_PICKING_LINE>0</USE_PICKING_LINE>
    <PHYSICAL_COUNT_DETAIL_ID>0</PHYSICAL_COUNT_DETAIL_ID>
    <IS_SELECTED>true</IS_SELECTED>
  ...
  <TareaDetalle>
    <SERIAL_NUMBER>537566</SERIAL_NUMBER>
    <MATERIAL_ID>FERCO/01272016</MATERIAL_ID>
    ...
    <TASK_COMMENTS>TAREA DE RECEPCION NO. 537566</TASK_COMMENTS>
    <WAVE_PICKING_ID>0</WAVE_PICKING_ID>
    <BARCODE_ID>FERCO/01272016</BARCODE_ID>
    <CODIGO_POLIZA_SOURCE>513883</CODIGO_POLIZA_SOURCE>
    <USE_PICKING_LINE>0</USE_PICKING_LINE>
    <PHYSICAL_COUNT_DETAIL_ID>0</PHYSICAL_COUNT_DETAIL_ID>
    <IS_SELECTED>true</IS_SELECTED>
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_CANCEL_RECEPTION_DETAIL] (
		@XML XML
...
BEGIN
    ...
    -- -------------------------------------------
		...
		SELECT
			...
			,[INVL].[LICENSE_ID]
		FROM
			[FERCO].[OP_WMS_LICENSES] AS [L]
		INNER JOIN [FERCO].[OP_WMS_INV_X_LICENSE] AS [INVL] ON [INVL].[LICENSE_ID] = [L].[LICENSE_ID]
    ...
    -- -------------------------------------------
      ...
      -- -------------------------------------------
			...
			FROM
				@MATERIALS_TEMP AS [M]
			INNER JOIN [FERCO].[OP_WMS3PL_POLIZA_TRANS_MATCH]
    ...
    -- -------------------------------------------    
      ...
      -- -------------------------------------------
			DELETE
				[MSN]
			FROM
				[FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER] [MSN]
      ...
      -- -------------------------------------------
			...
			LEFT JOIN [FERCO].[OP_WMS_INV_X_LICENSE] [IL] ON ([L].[LICENSE_ID] = [IL].[LICENSE_ID])
			WHERE
