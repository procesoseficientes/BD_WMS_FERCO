...
-- Modificacion 1/26/2018 @ Reborn-Team Sprint Trotzdem
					-- diego.as
					-- Se agrega parametros de recepcion de FERCO
...
-- Ejemplo de Ejecucion:
        EXEC [FERCO].[OP_WMS_SP_INSERT_ERP_RECEPTION_DOCUMENT_HEADER]
			@DOC_ID = 0
			,@TYPE = 'RECEPCION'
			,@CODE_SUPPLIER = '46513'
			,@CODE_CLIENT = 'FERCO'
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_ERP_RECEPTION_DOCUMENT_HEADER] (
		@DOC_ID VARCHAR(50)
		,@TYPE VARCHAR(25)
