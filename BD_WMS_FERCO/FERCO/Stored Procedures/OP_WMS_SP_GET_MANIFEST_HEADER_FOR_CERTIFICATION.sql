...
-- Ejemplo de Ejecucion:
            EXEC [FERCO].OP_WMS_SP_GET_MANIFEST_HEADER_FOR_CERTIFICATION 1119
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_MANIFEST_HEADER_FOR_CERTIFICATION (@MANIFEST_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  LEFT JOIN [FERCO].[OP_WMS_CERTIFICATION_HEADER] [CH]
    ON ([CH].[MANIFEST_HEADER_ID] = [MH].[MANIFEST_HEADER_ID])
