...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_VALIDATE_LOCATION_VOLUME] @LOCATION= 'BSA-01', @LICENSE_ID = 123
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_VALIDATE_LOCATION_VOLUME] (@LOCATION VARCHAR(25)
, @LICENSE_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  BEGIN TRY
    ...
    BEGIN
      ...
      IF @VOLUME_TOTAL < ([FERCO].[OP_WMS_FN_GET_VOLUMEN_FROM_LICENCE](@LICENSE_ID) + [FERCO].[OP_WMS_FN_GET_VOLUMEN_FROM_LOCATION](@LOCATION))
      BEGIN
        SELECT
          2 AS Resultado
