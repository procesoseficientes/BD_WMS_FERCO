...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_ADD_TRANSFER_REQUEST_HEADER]
					@REQUEST_TYPE = 'prueba'
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_ADD_TRANSFER_REQUEST_HEADER] (@REQUEST_TYPE VARCHAR(50)
...
BEGIN
  ...
  BEGIN TRY
    DECLARE @ID INT
    --
    INSERT INTO [FERCO].[OP_WMS_TRANSFER_REQUEST_HEADER] ([REQUEST_TYPE]
    , [WAREHOUSE_FROM]
    , [WAREHOUSE_TO]
    , [REQUEST_DATE]
    , [DELIVERY_DATE]
    ...
    , [LAST_UPDATE_BY]
    , [OWNER])
      VALUES (@REQUEST_TYPE  -- REQUEST_TYPE - varchar(50)
