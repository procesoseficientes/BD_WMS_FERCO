...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_INVENTORY_TRANSACTION_HEADER_ERP_BY_PICKING]
					@PICKING_DEMAND_HEADER_ID = 4182
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_INVENTORY_TRANSACTION_HEADER_ERP_BY_PICKING (@PICKING_DEMAND_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  LEFT JOIN [FERCO].[OP_WMS_VIEW_CLIENTS] [C]
    ON ([C].[CLIENT_CODE] = [H].[CLIENT_CODE])
