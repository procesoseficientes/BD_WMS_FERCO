...
-- Ejemplo de Ejecucion:
			 EXEC [FERCO].[OP_WMS_SP_GET_SERIES_BY_RECEPTION_HEADER] @RECEPTION_HEADER = '2005'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_SERIES_BY_RECEPTION_HEADER]
...
INNER JOIN [FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER] [S] ON [S].[LICENSE_ID] = [L].[LICENSE_ID]
											AND [S].[STATUS] > 0
WHERE
