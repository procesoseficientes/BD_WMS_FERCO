...
Ejemplo de Ejecucion:
	EXECUTE [FERCO].[OP_WMS_SP_GET_INVENTORY_RESERVED_BY_PROJECT] @WAREHOUSE = 'BODEGA_01', @PROJECT_ID = '59012660-EDCC-465B-BF08-68D58744D3D8', @DISCRETIONAL = 1
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INVENTORY_RESERVED_BY_PROJECT] (
...
BEGIN
	...
	BEGIN
		...
		SELECT
			...
			,[GIP].[STATUS_CODE]
		FROM
			[FERCO].[OP_WMS_FN_GET_INVENTORY_FROM_PROYECT](@PROJECT_ID) [GIP]
		WHERE
