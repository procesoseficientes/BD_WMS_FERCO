...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_INVENTORY_TRANSACTION_HEADER_ERP_BY_MASTER_PACK] @MASTER_PACK_HEADER_ID = 16
      EXEC  [FERCO].[OP_WMS_SP_GET_IN_TRANSACTION_DETAIL_ERP_BY_MASTER_PACK] @MASTER_PACK_HEADER_ID = 16
      EXEC  [FERCO].[OP_WMS_SP_GET_OUT_TRANSACTION_DETAIL_ERP_BY_MASTER_PACK] @MASTER_PACK_HEADER_ID = 16
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_INVENTORY_TRANSACTION_HEADER_ERP_BY_MASTER_PACK (@MASTER_PACK_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
