...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_INSERT_PICKING_LABELS   

*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_INSERT_PICKING_LABELS (@LOGIN_ID VARCHAR(25)
, @WAVE_PICKING_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    LEFT JOIN [FERCO].[OP_WMS_TRANSFER_REQUEST_HEADER] [TR]
    ...
    INSERT INTO [FERCO].[OP_WMS_PICKING_LABELS] ([LOGIN_ID], [CLIENT_CODE], [STATE_CODE], [REGIMEN], [CLIENT_NAME], [WAVE_PICKING_ID])
