...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_ASSOCIATE_USER_TO_PILOT   @USER_CODE = 'OPER2', @PILOT_CODE = 1, @LAST_UPDATE_BY = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_ASSOCIATE_USER_TO_PILOT (@USER_CODE VARCHAR(25), @PILOT_CODE INT, @LAST_UPDATE_BY VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  BEGIN TRY
    ...
    INSERT INTO [FERCO].[OP_WMS_USER_X_PILOT] ([USER_CODE], [PILOT_CODE], [LAST_UPDATE_BY])
