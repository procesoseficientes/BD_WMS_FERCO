...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_INFO_LICENSE_DISPATCH] @LICENSE_ID = 480527
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INFO_LICENSE_DISPATCH] (@LICENSE_ID INT)
AS
BEGIN
	DECLARE
		@WAVE_PICKING INT = 0
