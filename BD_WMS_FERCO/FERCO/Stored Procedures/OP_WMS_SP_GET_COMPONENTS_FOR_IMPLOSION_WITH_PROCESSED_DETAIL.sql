...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_COMPONENTS_FOR_IMPLOSION_WITH_PROCESSED_DETAIL]
					@LICENSE_ID = 378274,
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_COMPONENTS_FOR_IMPLOSION_WITH_PROCESSED_DETAIL (@LICENSE_ID INT,
