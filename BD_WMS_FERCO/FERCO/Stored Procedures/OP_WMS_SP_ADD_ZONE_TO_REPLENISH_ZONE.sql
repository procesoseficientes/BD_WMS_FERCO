...
EXEC [FERCO].[OP_WMS_SP_ADD_ZONE_TO_REPLENISH_ZONE] @ZONE_ID = 1 , 
	@REPLENISH_ZONE_ID = 2
*/
-- =============================================

CREATE PROCEDURE FERCO.OP_WMS_SP_ADD_ZONE_TO_REPLENISH_ZONE (@ZONE_ID INT
...
BEGIN
  BEGIN TRY
    DECLARE @ID INT;
    --
    INSERT INTO [FERCO].[OP_WMS_ZONE_TO_REPLENISH_IN_ZONE] ([ZONE_ID], [REPLENISH_ZONE_ID])
      VALUES (@ZONE_ID  -- ZONE_ID - int
