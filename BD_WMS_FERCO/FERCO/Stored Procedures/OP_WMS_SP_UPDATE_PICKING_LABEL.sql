...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_UPDATE_PICKING_LABEL


*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_UPDATE_PICKING_LABEL] (
		@LABEL_ID INT
...
BEGIN
  ...
  --
	...
	BEGIN TRY
		...
		LEFT JOIN [FERCO].[OP_WMS_TRANSFER_REQUEST_HEADER] [TR] ON [TL].[TRANSFER_REQUEST_ID] = [TR].[TRANSFER_REQUEST_ID]
		WHERE
		...
		BEGIN
			...
			INSERT	INTO [FERCO].[OP_WMS_PICKING_LABELS_BY_SERIAL_NUMBER]
					(
						[LABEL_ID]
						,[SERIAL_NUMBER]
						,[BATCH]
