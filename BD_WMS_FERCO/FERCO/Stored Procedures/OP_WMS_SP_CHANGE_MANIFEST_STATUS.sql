...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_CHANGE_MANIFEST_STATUS @MANIFEST_HEADER_ID =1, @STATUS = 'CANCELED'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CHANGE_MANIFEST_STATUS (@MANIFEST_HEADER_ID INT, @STATUS VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
