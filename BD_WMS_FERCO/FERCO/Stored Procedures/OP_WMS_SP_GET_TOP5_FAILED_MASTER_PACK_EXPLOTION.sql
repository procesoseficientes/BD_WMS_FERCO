...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_TOP5_FAILED_MASTER_PACK_EXPLOTION]
				@OWNER = 'arium'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_TOP5_FAILED_MASTER_PACK_EXPLOTION (@OWNER VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [FERCO].[OP_WMS_MATERIAL_INTERCOMPANY] [MI]
    ON (
