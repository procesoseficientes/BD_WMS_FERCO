...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_MERGE_MASTER_PACK_COMPONENT_BY_LOAD]
					@MASTER_PACK_CODE = 'FERCO/SKUPRUEBA'
					,@COMPONENT_MATERIAL = 'FERCO/bbb'
					,@QTY = 15
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_MERGE_MASTER_PACK_COMPONENT_BY_LOAD](
