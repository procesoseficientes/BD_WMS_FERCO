...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_GET_MATERIAL_FOR_MANIFEST @MANIFEST_HEADER_ID = 1119, @BARCODE_ID = 'arium/100089'


*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_MATERIAL_FOR_MANIFEST (@MANIFEST_HEADER_ID INT
...
BEGIN
  ...
  AND ([M].[BARCODE_ID] = @BARCODE_ID
  OR [M].[ALTERNATE_BARCODE] = @BARCODE_ID
  OR [M].[MATERIAL_ID] = @BARCODE_ID)
