...
-- Ejemplo de Ejecucion:
    DECLARE  @pResult VARCHAR(250) 
			exec [FERCO].[OP_WMS_SP_VALIDATE_LICENSE_FOR_REALLOC_PARTIAL] @LICENSE_ID = 217709
                                                        ,@pResult = @pResult OUTPUT 
    SELECT @pResult
  SELECT *   FROM [FERCO].[OP_WMS_SHELF_SPOTS] [S] 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_VALIDATE_LICENSE_FOR_REALLOC_PARTIAL (@LICENSE_ID NUMERIC
