...
Ejemplo de Ejecucion:
							EXEC [FERCO].OP_WMS_SP_GET_DETAILS_DOC_INCOME_BY_CLIENT @CODE_CLIENT = 'C40', @CODE_POLIZA = '297'
*/
-- =============================================


CREATE PROCEDURE FERCO.OP_WMS_SP_GET_DETAILS_DOC_INCOME_BY_CLIENT (@CODE_CLIENT VARCHAR(50)
