...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_INVENTORY_POLICY] @CODIGO_POLIZA = '11370'
				SELECT * FROM [FERCO].[OP_WMS_LICENSES]
				
				*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INVENTORY_POLICY] (@CODIGO_POLIZA VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  LEFT JOIN [FERCO].[OP_WMS_TONE_AND_CALIBER_BY_MATERIAL] [T]
