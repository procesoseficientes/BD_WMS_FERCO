...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_TOP5_PICKING_TRANSFER_DOCUMENT_R3]  @IS_INVOICE = 0
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_TOP5_PICKING_TRANSFER_DOCUMENT_R3] (@IS_INVOICE INT = 0)
AS
BEGIN
	SET NOCOUNT ON;
	--
