...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_GET_ACTIVE_USER_BY_DISTRIBUTION_CENTER]
					@DISTRIBUTION_CENTER = 'BODEGA_01'
				--
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_ACTIVE_USER_BY_DISTRIBUTION_CENTER (@DISTRIBUTION_CENTER VARCHAR(200))
AS
BEGIN
  SET NOCOUNT ON;
  --
