...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_CHANGE_STATUS_DELIVERED_DISPATCH_HEADER] 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CHANGE_STATUS_DELIVERED_DISPATCH_HEADER (@DELIVERED_DISPATCH_HEADER_ID INT
, @STATUS VARCHAR(50)
...
BEGIN
  ...
  FROM [FERCO].[OP_WMS_DELIVERED_DISPATCH_HEADER] [DDH]
  WHERE [DDH].[DELIVERED_DISPATCH_HEADER_ID] = @DELIVERED_DISPATCH_HEADER_ID;
  --

  BEGIN TRY

    UPDATE [FERCO].[OP_WMS_DELIVERED_DISPATCH_HEADER]
    SET [STATUS] = @STATUS
       ,[LAST_UPDATE] = GETDATE()
