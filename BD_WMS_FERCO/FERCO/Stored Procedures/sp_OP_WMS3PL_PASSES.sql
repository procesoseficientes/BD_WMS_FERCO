...
CREATE PROCEDURE FERCO.sp_OP_WMS3PL_PASSES @PASS_ID NUMERIC(18, 0) = NULL OUTPUT,
...
BEGIN
  BEGIN TRY
    ...
    BEGIN
      INSERT INTO FERCO.OP_WMS3PL_PASSES (CLIENT_CODE, CLIENT_NAME, LAST_UPDATED_BY, LAST_UPDATED
      , ISEMPTY, VEHICLE_PLATE, VEHICLE_DRIVER, VEHICLE_ID
      , DRIVER_ID, AUTORIZED_BY, HANDLER, CARRIER
      , TXT, LOADUNLOAD, LOADWITH, AUDIT_ID)
        VALUES (@CLIENT_CODE, @CLIENT_NAME, @LAST_UPDATED_BY, GETDATE(), @ISEMPTY, @VEHICLE_PLATE, @VEHICLE_DRIVER, @VEHICLE_ID, @DRIVER_ID, @AUTORIZED_BY, @HANDLER, @CARRIER, @TXT, @LOADUNLOAD, @LOADWITH, @AUDIT_ID);
