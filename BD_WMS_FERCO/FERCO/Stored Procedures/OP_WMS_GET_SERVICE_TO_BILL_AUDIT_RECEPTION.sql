...
-- Description:			SP que obtienen todos los servicios a cobrar de auditoria por recepcion
...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_AUDIT_RECEPTION]  @INICIAL_DATE = '2016-11-03 00:00:00.000'
  , @END_DATE = '2016-11-03 23:59:59.850', @LAST_UPDATED_BY = 'PAGUILAR'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_SERVICE_TO_BILL_AUDIT_RECEPTION (@INICIAL_DATE DATETIME
, @END_DATE DATETIME
...
BEGIN
  ...
  WHERE [TC].[SERVICE_CODE] = 'AUDITORIAS_RECEPCION'
  ...
  SELECT
   ...
   ,[C].[ACUERDO_COMERCIAL]
  FROM [FERCO].[OP_WMS_AUDIT_RECEPTION_CONTROL] ARC
