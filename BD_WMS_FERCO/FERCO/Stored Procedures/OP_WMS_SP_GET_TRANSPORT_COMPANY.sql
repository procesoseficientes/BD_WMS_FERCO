...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].OP_WMS_SP_GET_TRANSPORT_COMPANY @TRANSPORT_COMPANY_CODE = NULL
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_TRANSPORT_COMPANY (@TRANSPORT_COMPANY_CODE INT = NULL)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT
   ...
   ,[TC].[LAST_UPDATE_BY]
   ,[TC].[IS_OWN]
  FROM [FERCO].[OP_WMS_TRANSPORT_COMPANY] [TC]
  WHERE (
