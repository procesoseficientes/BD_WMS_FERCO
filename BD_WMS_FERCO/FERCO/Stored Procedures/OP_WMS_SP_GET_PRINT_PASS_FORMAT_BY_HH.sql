...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_PRINT_PASS_FORMAT_BY_HH] @PASS_ID = 10,@LOGIN_ID = 'MARVIN', @DOMAIN='l3w'
*/
-- =============================================  
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_PRINT_PASS_FORMAT_BY_HH] (
		@PASS_ID INT
...
BEGIN
  ...
  -- ------------------------------------------------------------------------------------
	...
	INSERT	INTO [#result]
			EXEC [FERCO].[OP_WMS_SP_GET_PASS_FOR_REPORT] @PASS_ID = @PASS_ID, -- int
