...
-- Ejemplo de Ejecucion:			
  EXEC [FERCO].OP_WMS_GET_SUGGESTED_DISPATCH_LICENSE
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_SUGGESTED_DISPATCH_LICENSE] (
		@LOGIN VARCHAR(50)
...
BEGIN
  ...
  --
	...
	FROM
		[FERCO].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [NPDH]
	WHERE
	...
	BEGIN
		...
		BEGIN
			...
			SELECT
				...
				,[AL].[STATUS_CODE]
			FROM
				[FERCO].[OP_WMS_INVENTORY_RESERVED_BY_PROJECT] [AL]
			INNER JOIN [FERCO].[OP_WMS_MATERIALS] [M] ON [AL].[MATERIAL_ID] = [M].[MATERIAL_ID]
			INNER JOIN [FERCO].[OP_WMS_LICENSES] [L] ON [AL].[LICENSE_ID] = [L].[LICENSE_ID]
