...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_PROJECT_BY_STATUS]						
					@STATUS VARCHAR(20) = 'CREATED'
   */
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_PROJECT_BY_STATUS] (
...
BEGIN
	...
	INNER JOIN [FERCO].[OP_WMS_MATERIALS] [M] ON [IRP].[MATERIAL_ID] = [M].[MATERIAL_ID]
	GROUP BY
		[PROJECT_ID];
