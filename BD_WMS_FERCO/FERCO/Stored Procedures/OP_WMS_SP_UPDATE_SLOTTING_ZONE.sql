...
--        EXEC [FERCO].[OP_WMS_SP_UPDATE_SLOTTING_ZONE] @ID_SLOTTING_ZONE = 'E80CD6C1-3D8D-E911-8106-60A44CCD8810', -- varchar(50)
--													  @MANDATORY = 1 -- bit
--*/
-- =============================================

CREATE PROCEDURE [FERCO].[OP_WMS_SP_UPDATE_SLOTTING_ZONE]
    (
...
AS
    BEGIN TRY
        ...
        UPDATE  [FERCO].[OP_WMS_SLOTTING_ZONE]
