...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_TYPE_CHARGE_BY_FREQUENCY]  @PROCESS_DATE = '2017-03-02 00:00:000'
 ,@LAST_UPDATED_BY = 'PABS'
 ,@TYPE = 'ON_DEMAND'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_SERVICE_TO_BILL_TYPE_CHARGE_BY_FREQUENCY (@PROCESS_DATE DATETIME
...
BEGIN
  ...
  INSERT INTO [#CLIENT_TO_BILL] ([CLIENT_CODE], [CLIENT_NAME], [ACUERDO_COMERCIAL], [TYPE_CHARGE_ID], [TYPE_CHARGE_DESCRIPTION], [SERVICE_ID], [SERVICE_CODE], [SERVICE_DESCRIPTION], [UNIT_PRICE], [REGIMEN], [BILLING_FRECUENCY])
    SELECT
     ...
     ,[C].[REGIMEN]
     ,[C].[BILLING_FRECUENCY]
    FROM [FERCO].[OP_WMS_FN_GET_CUSTOMERS_TO_BILL_BY_TRADE_AGREEMENT](1, @TYPE, @PROCESS_DATE, NULL, 1) [C]
