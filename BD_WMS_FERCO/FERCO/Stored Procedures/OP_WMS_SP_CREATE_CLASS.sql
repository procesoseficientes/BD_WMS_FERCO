...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_CREATE_CLASS] @CLASS_NAME = 'Plasticos', -- varchar(50)
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CREATE_CLASS (@CLASS_NAME VARCHAR(50)
...
BEGIN
  ...
  BEGIN TRY
    DECLARE @ID INT;
    --
    INSERT INTO [FERCO].[OP_WMS_CLASS] ([CLASS_NAME]
    , [CLASS_DESCRIPTION]
    , [CLASS_TYPE]
    , [CREATED_BY]
    , [CREATED_DATETIME]
    ...
    , [LAST_UPDATED]
    , [PRIORITY])
      VALUES (@CLASS_NAME  -- CLASS_NAME - varchar(50)
  ...
  BEGIN CATCH
    SELECT
     ...
     ,CASE CAST(@@ERROR AS VARCHAR)
        WHEN '2627' THEN 'Ya existe una clase con el nombre.'
        ELSE ERROR_MESSAGE()
      END [Mensaje]
     ,@@ERROR [Codigo];
  END CATCH;
