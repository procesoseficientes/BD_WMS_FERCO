...
CREATE PROCEDURE FERCO.OP_WMS_SP_CREATE_TARIFICADOR_HEADER @AcuerdoComercialId INT OUTPUT,
...
BEGIN
  ...
  BEGIN TRAN
  BEGIN
    INSERT INTO FERCO.OP_WMS_TARIFICADOR_HEADER (ACUERDO_COMERCIAL_NOMBRE
    , VALID_FROM
    , VALID_TO
    , EXPIRES
    , CURRENCY
