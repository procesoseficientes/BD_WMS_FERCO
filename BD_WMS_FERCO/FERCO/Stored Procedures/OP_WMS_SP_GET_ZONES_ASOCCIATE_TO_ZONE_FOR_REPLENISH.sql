...
EXEC [FERCO].[OP_WMS_SP_GET_ZONES_ASOCCIATE_TO_ZONE_FOR_REPLENISH] @ZONE_ID = 1
*/
-- =============================================
--SET QUOTED_IDENTIFIER ON|OFF
--SET ANSI_NULLS ON|OFF
--GO
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_ZONES_ASOCCIATE_TO_ZONE_FOR_REPLENISH (@ZONE_ID INT)
AS
BEGIN
  SELECT
    Z.[ZONE_ID]
  ...
  INNER JOIN [FERCO].[OP_WMS_ZONE_TO_REPLENISH_IN_ZONE] R
    ON Z.[ZONE_ID] = R.[REPLENISH_ZONE_ID]
