...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_INSERT_OP_WMS_POLIZA_DETAIL_EXT @CUSTOMER VARCHAR(MAX)
, @USER VARCHAR(50)
, @HEADER INT

AS
BEGIN TRY
  INSERT INTO [FERCO].[OP_WMS_POLIZA_DETAIL]
    SELECT
      @HEADER
     ...
     ,NULL
     ,NULL
    FROM FERCO.OP_WMS_CHARGE_EXTERNAL_INVENTORY EXT
