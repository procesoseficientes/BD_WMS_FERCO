...
-- Ejemplo de Ejecucion:
			...
			--
			EXEC [FERCO].[OP_WMS_SP_GET_NEXT_PICKING_DEMAND_DETAIL_RESERVE_DOCUMENT_FOR_R3]
				@PICKING_DEMAND_HEADER_ID = 28
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_NEXT_PICKING_DEMAND_DETAIL_RESERVE_DOCUMENT_FOR_R3] (
