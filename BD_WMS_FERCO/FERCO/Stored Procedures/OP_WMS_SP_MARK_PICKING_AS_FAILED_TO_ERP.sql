...
-- Modificacion 9/17/2020
-- fabrizio delcompare
-- Se revalida si se creo exitosamente sen SAP
/*
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_MARK_PICKING_AS_FAILED_TO_ERP]
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_MARK_PICKING_AS_FAILED_TO_ERP]
    (
