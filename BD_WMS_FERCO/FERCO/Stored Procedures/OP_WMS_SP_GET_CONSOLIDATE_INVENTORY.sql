...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_CONSOLIDATE_INVENTORY] @LOGIN = 'ADMIN' 
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_CONSOLIDATE_INVENTORY] (@LOGIN VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT
    ...
    ((SELECT
        ...
        , 'N/A') AS Expr1
      FROM [FERCO].OP_WMS_LICENSES AS Z
  ...
  INNER JOIN [FERCO].OP_WMS_MATERIALS AS B
