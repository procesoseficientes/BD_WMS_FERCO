...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_VALIDATE_IS_MASTER_PACK]
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_VALIDATE_IS_MASTER_PACK](
	@MATERIAL VARCHAR(50)
)
AS
BEGIN
	...
	FROM [FERCO].[OP_WMS_MATERIALS] [M] WITH(INDEX([IN_OP_WMS_MATERIALS_MATERIAL_ID_BARCODE_ID_ALTERNATE_BARCODE]))
