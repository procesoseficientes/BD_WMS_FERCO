...
--        EXEC [FERCO].[OP_WMS_GET_SLOTTING_SUB_CLASS] @LOGIN = 'RUDI'
--*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_SLOTTING_SUB_CLASS]
(
    @LOGIN VARCHAR(25),
...
BEGIN
    ...
    FROM [FERCO].[OP_WMS_ZONE] [Z]
        ...
        LEFT JOIN [FERCO].[OP_WMS_SLOTTING_ZONE_BY_SUB_CLASS] [SSC]
