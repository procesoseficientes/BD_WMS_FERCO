...
-- Ejemplo de Ejecucion:
        SELECT CODIGO_POLIZA, NUMERO_ORDEN, TIPO, WAREHOUSE_REGIMEN  FROM [FERCO].[OP_WMS_POLIZA_HEADER] order by 1 desc 
		EXEC [FERCO].[OP_WMS_SP_GET_POLIZA_HEADER] @CODE_POLICY = 'ZUPMGAP7Z', -- varchar(25)
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_POLIZA_HEADER (@CODE_POLICY VARCHAR(25)
, @TYPE VARCHAR(25)
...
BEGIN
  ...
  SELECT
   ...
   ,(SELECT TOP 1
        [b].[CLIENT_NAME]
      FROM [FERCO].[OP_WMS_VIEW_CLIENTS] [b]
      WHERE [b].[CLIENT_CODE] = [P].[CLIENT_CODE] COLLATE DATABASE_DEFAULT)
    + CHAR(13) + CHAR(10)
    +
    CASE
      WHEN [RDH].[NAME_SUPPLIER] IS NULL THEN ''
