...
EXEC [FERCO].[OP_WMS_SP_ADD_STATUS_OF_MATERIAL_BY_LICENSE] @STATUS_CODE ='ESTADO_DEFAULT' 
															,@STATUS_NAME = 'PRUEBA'
                                                            ,@BLOCKS_INVENTORY = 0
                                                            ,@ALLOW_REALLOC = 0
...
CREATE PROCEDURE [FERCO].[OP_WMS_SP_ADD_STATUS_OF_MATERIAL_BY_LICENSE] (@STATUS_CODE VARCHAR(50), @STATUS_NAME VARCHAR(100)
...
AS
  ...
  BEGIN TRY
    INSERT [FERCO].[OP_WMS_STATUS_OF_MATERIAL_BY_LICENSE] ([STATUS_CODE]
    , [STATUS_NAME]
    , [BLOCKS_INVENTORY]
    , [ALLOW_REALLOC]
    , [TARGET_LOCATION]
