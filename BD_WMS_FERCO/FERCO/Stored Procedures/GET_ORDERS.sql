...
-- =============================================
CREATE PROCEDURE [FERCO].[GET_ORDERS] 
	-- Add the parameters for the stored procedure here
	--<@Param1, sysname, @p1> <Datatype_For_Param1, , int> = <Default_Value_For_Param1, , 0>, 
	--<@Param2, sysname, @p2> <Datatype_For_Param2, , int> = <Default_Value_For_Param2, , 0>
AS
BEGIN
	--INSERT INTO [192.168.16.158].[OP_WMS].[FERCO].[OP_WMS_DEMAND_TO_PICK]
	INSERT INTO [FERCO].[OP_WMS_DEMAND_TO_PICK]
		...
		from 
			FERCO_SB1.dbo.OINV A JOIN
			FERCO_SB1.dbo.INV1 B ON A.DOCENTRY = B.DOCENTRY and B.TreeType in ('N', 'I') JOIN
			FERCO_SB1.dbo.OCRD C ON A.CardCode = C.CardCode JOIN
			FERCO_SB1.dbo.OSLP D ON C.SlpCode = D.SlpCode
		WHERE 
