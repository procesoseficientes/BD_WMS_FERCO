...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].OP_WMS_SP_VALIDATED_CONFIGURATION_OF_SLOTTING_ZONE_BY_LICENSE						
					@LICENSE_ID = 469790
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_VALIDATED_CONFIGURATION_OF_SLOTTING_ZONE_BY_LICENSE]
(
    @LOGIN VARCHAR(50),
    @LICENSE_ID INT
)
...
BEGIN
    ...
    FROM [FERCO].[OP_WMS_INV_X_LICENSE] [IL]
        ...
        INNER JOIN [FERCO].[OP_WMS_CLASS] [C]
    ...
    FROM [FERCO].[OP_WMS_SLOTTING_ZONE] [SZ]
        ...
        INNER JOIN [FERCO].[OP_WMS_SLOTTING_ZONE_BY_CLASS] [SZC]
