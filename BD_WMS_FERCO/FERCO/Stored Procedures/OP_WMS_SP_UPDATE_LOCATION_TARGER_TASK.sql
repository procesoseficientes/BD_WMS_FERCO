...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_UPDATE_LOCATION_TARGER_TASK]
...
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_LOCATION_TARGER_TASK
    (
     @WAVE_PICKING_ID INT
    ,@LOGIN VARCHAR(25)
...
FROM
    [FERCO].[OP_WMS_TASK_LIST] [T] WITH (INDEX ([IX_OP_WMS_TASK_LIST_ASSIG_TO]))
WHERE
