...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_OPERATORS_ASSIGNED_TO_DISTRIBUTION_CENTER] @DISTRIBUTION_CENTER  = 'C001' 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_OPERATORS_ASSIGNED_TO_DISTRIBUTION_CENTER (@DISTRIBUTION_CENTER VARCHAR(200))
AS
BEGIN
  SET NOCOUNT ON;
  --
