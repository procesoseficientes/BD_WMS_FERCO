...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_MARK_AS_FAILED_DELIVERY_NOTE_UPDATE]
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_MARK_AS_FAILED_DELIVERY_NOTE_UPDATE (@PICKING_DEMAND_HEADER_ID INT
