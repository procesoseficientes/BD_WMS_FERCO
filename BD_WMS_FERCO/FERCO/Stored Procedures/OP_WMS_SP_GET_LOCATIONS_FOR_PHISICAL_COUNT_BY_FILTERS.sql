...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_LOCATIONS_FOR_PHISICAL_COUNT_BY_FILTERS]  @WAREHOUSE = 'BODEGA_04' ,@REGIMEN = 'GENERAL'
 , @CLIENT_CODE = 'C00030', @MATERIAL = 'C00030/LECHE-CONDE'  , @LOCATION = 'B04-TA-C03-NU|B04-TA-C07-NU|B04-TA-C08-NU' ,@EMPTY_LOCATIONS = 1

    EXEC [FERCO].OP_WMS_SP_GET_LOCATIONS_FOR_PHISICAL_COUNT_BY_FILTERS @WAREHOUSE = N'BODEGA_02'
                                                                  ,@REGIMEN = N'GENERAL'
                                                                  ,@ZONE = N'BODEGA_02'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_LOCATIONS_FOR_PHISICAL_COUNT_BY_FILTERS (@WAREHOUSE VARCHAR(MAX),
@REGIMEN VARCHAR(50),
...
BEGIN
  ...
  FROM [FERCO].[OP_WMS_FN_SPLIT](@MATERIAL, '|') [M]
