...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_CHANGE_MANIFEST_VEHICLE @MANIFEST_HEADER_ID = 1170, @VEHICLE_CODE = 26,@LOGIN= 'beto'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_CHANGE_MANIFEST_VEHICLE (@MANIFEST_HEADER_ID INT
, @VEHICLE_CODE INT
, @LOGIN VARCHAR(50))
AS
BEGIN
