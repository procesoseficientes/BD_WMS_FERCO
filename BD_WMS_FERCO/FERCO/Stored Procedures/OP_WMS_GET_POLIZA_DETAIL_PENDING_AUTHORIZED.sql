...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_GET_POLIZA_DETAIL_PENDING_AUTHORIZED] @CODE_POLIZA = 28841
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_POLIZA_DETAIL_PENDING_AUTHORIZED (@CODE_POLIZA VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --  
