...
-- Ejemplo de Ejecucion:
				...
				EXEC [FERCO].[OP_WMS_SP_ADD_EXTERNAL_TRANSACCION]
						@CLIENTE ='C00330'
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_ADD_EXTERNAL_TRANSACCION (@CLIENTE VARCHAR(50)
...
AS
  ...
  BEGIN
    BEGIN TRY
      ...
      EXEC @RESULTADO_MATERIALES = [FERCO].[OP_WMS_SP_ADD_MATERIAL_EXT] @CLIENTE = @CLIENTE
                                                                       ,@USUARIO = @USUARIO
      ...
      EXEC [FERCO].[OP_WMS_SP_INSERT_POLIZA_HEADER_FOR_EXTERNAL_INVENTORY] @DOC_ID = @POLIZA_NUM OUTPUT
      ...
      BEGIN
        ...
        EXEC @RESULTADO_POLIZA_DETAIL = [FERCO].[OP_WMS_SP_INSERT_OP_WMS_POLIZA_DETAIL_EXT] @CUSTOMER = @CLIENTE
                                                                                           ,@USER = @USUARIO
                                                                                           ,@HEADER = @POLIZA_NUM
      ...
      EXEC [FERCO].[OP_WMS_SP_CREA_LICENCIA] @pCODIGO_POLIZA = @POLIZA_NUM
                                            ,@pLOGIN = @USUARIO
      ...
      BEGIN
        ...
        EXEC @RESULTADO_INVENTARIO_LICENCIA = [FERCO].[OP_WMS_SP_UPDATE_OR_INSERT_OP_WMS_INV_X_LICENSE_EXT] @CUSTOMER = @CLIENTE
                                                                                                           ,@USER = @USUARIO
                                                                                                           ,@ACUERDO_COMERCIAL = @ACUERDO_COMERCIAL
                                                                                                           ,@RESULTADO = ''
                                                                                                           ,@LICENSE_ID = @LICENCIA
      ...
      TRUNCATE TABLE [FERCO].[OP_WMS_CHARGE_EXTERNAL_INVENTORY]
