...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].OP_WMS_SP_DELETE_TRANSPORT_COMPANY @TRANSPORT_COMPANY_CODE = 2
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_DELETE_TRANSPORT_COMPANY (@TRANSPORT_COMPANY_CODE INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  BEGIN TRY
    ...
    DELETE [FERCO].[OP_WMS_TRANSPORT_COMPANY]
