...
-- Ejemplo de Ejecucion:
	EXEC [FERCO].[OP_WMS_SP_UPDATE_SCANNED_SERIAL_NUMBER_TO_PROCESS_RANK] @SERIAL_NUMBER = '201234567899'
                                                                    ,@LICENSE_ID = 167669
                                                                    ,@STATUS = 1
                                                                    ,@WAVE_PICKING_ID = 0
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_UPDATE_SCANNED_SERIAL_NUMBER_TO_PROCESS_RANK] (
  ...
  ---------------------------------------------------------------------------------  
	...
	BEGIN
		...
		SELECT
			@COUNT_SERIES = COUNT(*)
		FROM
			[FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER] [MS]
		WHERE
	...
	ELSE
		...
		BEGIN
			...
			LEFT JOIN [FERCO].[OP_WMS_FN_GET_COMMITED_INVENTORY_BY_LICENCE]() [CL] ON [IL].[MATERIAL_ID] = [CL].[MATERIAL_ID]
