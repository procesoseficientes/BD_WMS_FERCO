...
EXEC [FERCO].[OP_WMS_SP_INSERT_TASK] @CREATE_BY = 'ADMIN'
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_INSERT_TASK (@CREATE_BY VARCHAR(25)
...
BEGIN
  SET NOCOUNT ON;
  --
  INSERT INTO [FERCO].[OP_WMS_TASK] ([CREATE_BY]
  , [TASK_TYPE]
  , [TASK_ASSIGNED_TO]
  , [IS_ACCEPTED]
  , [IS_COMPLETE]
