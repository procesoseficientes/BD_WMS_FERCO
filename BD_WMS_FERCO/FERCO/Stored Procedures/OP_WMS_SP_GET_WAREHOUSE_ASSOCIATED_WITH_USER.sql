...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_WAREHOUSE_ASSOCIATED_WITH_USER] @LOGIN_ID = 'ACAMACHO'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_WAREHOUSE_ASSOCIATED_WITH_USER (@LOGIN_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [FERCO].[OP_WMS_WAREHOUSE_BY_USER] [WB]
