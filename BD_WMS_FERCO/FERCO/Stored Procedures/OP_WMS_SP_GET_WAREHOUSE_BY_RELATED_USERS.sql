...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_WAREHOUSE_BY_RELATED_USERS] @LOGIN='ADMIN' ,@OPERATORS='ACAMACHO|BETO'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_WAREHOUSE_BY_RELATED_USERS (@LOGIN VARCHAR(50)
...
BEGIN
  ...
  SELECT
    * INTO #OPERATORS
  FROM [FERCO].[OP_WMS_FN_SPLIT](@OPERATORS, '|') [OP]
