...
--                   [[FERCO]].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL] 
...
Ejemplo de Ejecucion:
                --
                EXEC [FERCO].OP_WMS_SP_GET_CERTIFICATE_DEPOSIT_DETAIL_BY_HEADER
                    @ID_DEPOSIT_HEADER = 2
                --    
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_CERTIFICATE_DEPOSIT_DETAIL_BY_HEADER] (@ID_DEPOSIT_HEADER INT)
...
BEGIN
  ...
  FROM [FERCO].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL] AS [CDD]
