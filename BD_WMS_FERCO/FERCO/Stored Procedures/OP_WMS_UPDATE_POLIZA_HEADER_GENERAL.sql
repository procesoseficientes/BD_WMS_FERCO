...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_UPDATE_POLIZA_HEADER_GENERAL] @DOC_ID = 0
                                                          , @POLIZA_ASEGURADA = '23123'
                                                          , @ACUERDO_COMERCIAL = '12'        
                                                          , @LOGIN = 'admin'                                                  
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_UPDATE_POLIZA_HEADER_GENERAL (@DOC_ID NUMERIC
...
BEGIN
  ...
  BEGIN TRY
    ...
    SET [POLIZA_ASEGURADA] = @POLIZA_ASEGURADA
    ...
    UPDATE [IL]
    SET [IL].[TERMS_OF_TRADE] = @ACUERDO_COMERCIAL
