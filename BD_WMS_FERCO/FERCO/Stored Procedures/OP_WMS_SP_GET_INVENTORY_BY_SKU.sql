...
-- Ejemplo de Ejecucion:
    exec [FERCO].OP_WMS_SP_GET_INVENTORY_BY_SKU @MATERIAL_ID='FERCO/SKUPRUEBAHEC'
                                                ,@CURRENT_WAREHOUSE='CE'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INVENTORY_BY_SKU] (
...
BEGIN
  ...
  --
	...
	SELECT
		...
		,[SML].[STATUS_CODE]
	FROM
		[FERCO].[OP_WMS_VIEW_INVENTORY_GENERAL_BY_MATERIALS] [IBM]
	LEFT JOIN [FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER] [MS] ON (
