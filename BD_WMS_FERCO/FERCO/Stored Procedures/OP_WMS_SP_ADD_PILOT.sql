...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_ADD_PILOT]   @NAME = 'Diego'
                                          ,@LAST_NAME = 'AS'
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_ADD_PILOT (@NAME VARCHAR(250)
...
BEGIN
  ...
  BEGIN TRY
    ...
    INSERT INTO [FERCO].[OP_WMS_PILOT] ([NAME], [LAST_NAME], [IDENTIFICATION_DOCUMENT_NUMBER], [LICENSE_NUMBER], [LICESE_TYPE], [LICENSE_EXPIRATION_DATE], [ADDRESS], [TELEPHONE], [MAIL], [COMMENT], [LAST_UPDATE_BY])
