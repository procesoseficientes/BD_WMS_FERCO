...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_CHECKPOINTS_BY_LOGIN]						
					@LOGIN_ID VARCHAR(25) = 'RUDI'
        , @TYPE VARCHAR(25) = 'PC'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_CHECKPOINTS_BY_LOGIN](@LOGIN_ID VARCHAR(25)
, @TYPE VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  SELECT
   ...
   ,[C].[TYPE]
   ,[C].[PATH_IMAGE]
  FROM [FERCO].[OP_WMS_ROLES_JOIN_CHECKPOINTS] [RC]
  INNER JOIN [FERCO].[OP_WMS_CHECKPOINTS] [C]
