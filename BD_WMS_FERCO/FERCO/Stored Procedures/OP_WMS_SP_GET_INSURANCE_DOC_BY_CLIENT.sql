...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_INSURANCE_DOC_BY_CLIENT] @CODE_CLIENT = 'arium' -- varchar(50)
			--
			EXEC [FERCO].[OP_WMS_SP_GET_INSURANCE_DOC_BY_CLIENT] @CODE_CLIENT = 'FERCO' -- varchar(50)
*/
-- =============================================
--
--GO

CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INSURANCE_DOC_BY_CLIENT] (
...
BEGIN
	...
	BEGIN
		SELECT
			...
			,[PS].[INSURANCE_OWHEN]
		FROM
			[FERCO].[OP_WMS_INSURANCE_DOCS] [PS]
		WHERE
	...
	BEGIN
		...
		FROM
			[FERCO].[OP_WMS_FUNC_GET_PARAMETROS_GENERALES]('POLIZAS',
											'POLIZAS_SEGUROS') [C];
	END;
END;