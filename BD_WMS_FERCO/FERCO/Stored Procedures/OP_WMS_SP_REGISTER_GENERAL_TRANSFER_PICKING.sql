...
-- ================================================================================================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_REGISTER_GENERAL_TRANSFER_PICKING]
...
BEGIN
    ...
    BEGIN TRY
        ...
        (   ISNULL(
            ...
            @pLOGIN_ID,                                                                                   -- LOGIN_ID
            (
                SELECT * FROM [ferco].[OP_WMS_FUNC_GETLOGIN_NAME](@pLOGIN_ID)
            ),                                                                                            -- LOGIN_NAME
            'TRASLADO_GENERAL',                                                                           -- TRANS_TYPE
            ISNULL(
            (
                SELECT [PARAM_CAPTION]
                FROM [ferco].[OP_WMS_FUNC_GETTRANS_DESC]('TRASLADO_GENERAL')
            ),
            'TRASLADO GENERAL'
                  ),                                                                                      -- TRANS_DESCRIPTION
            ...
            (
                SELECT *
                FROM [ferco].[OP_WMS_FUNC_GETMATERIAL_DESC](@pMATERIAL_BARCODE, @CLIENT_OWNER_LOCAL)
            ),                                                                                            -- MATERIAL_DESCRIPTION
            ISNULL(
            (
            ...
            [ferco].[OP_WMS_FN_GET_MATERIAL_COST_BY_MATERIAL](@MATERIAL_ID_LOCAL, @CLIENT_OWNER_LOCAL), -- MATERIAL_COST
            ...
            (
                SELECT * FROM [ferco].[OP_WMS_FUNC_GETCLIENT_NAME](@CLIENT_OWNER_LOCAL)
            ),                                                                                            -- CLIENT_NAME
        ...
        IF @IS_MASTER_PACK = 1
        BEGIN
            EXEC [ferco].[OP_WMS_SP_DISPATCH_MASTER_PACK] @MATERIAL_ID = @MATERIAL_ID_LOCAL,
