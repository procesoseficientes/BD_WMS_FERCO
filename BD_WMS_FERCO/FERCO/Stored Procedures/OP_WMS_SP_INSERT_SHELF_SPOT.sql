...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_INSERT_SHELF_SPOT]
				-- 
				SELECT * FROM [FERCO].[OP_WMS_SHELF_SPOTS] 
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_SHELF_SPOT] (
...
BEGIN
	...
	BEGIN TRY
			--
		INSERT	INTO [FERCO].[OP_WMS_SHELF_SPOTS]
				(
					[WAREHOUSE_PARENT]
					,[ZONE]
					,[LOCATION_SPOT]
