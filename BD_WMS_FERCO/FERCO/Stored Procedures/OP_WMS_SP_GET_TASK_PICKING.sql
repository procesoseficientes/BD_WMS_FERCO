...
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_TASK_PICKING @OlaPicking NUMERIC(18, 0),
...
BEGIN
  ...
  BEGIN
    ...
    SELECT
     ...
     ,(SELECT TOP 1
          IV.QTY
        FROM [FERCO].[OP_WMS_INV_X_LICENSE] IV
     ...
     ,(SELECT TOP 1
        ...
        WHERE L.LICENSE_ID = TL.LICENSE_ID_SOURCE)
      AS USED_MT2
     ,ISNULL((SELECT
          1
    ...
    INNER JOIN [FERCO].[OP_WMS_SHELF_SPOTS] SS
      ON (SS.LOCATION_SPOT = TL.LOCATION_SPOT_SOURCE)
