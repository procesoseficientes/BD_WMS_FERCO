...
-- Ejemplo de Ejecucion:
            EXEC [FERCO].OP_WMS_SP_GET_LABELS_BY_WAVE_PICKING 
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_LABELS_BY_WAVE_PICKING] (@WAVE_PICKING_ID INT)
AS
    BEGIN
        SET NOCOUNT ON;
  ...
  --
        ...
        FROM    [FERCO].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [DH]
                LEFT JOIN [FERCO].[OP_WMS_DELIVERED_DISPATCH_HEADER] [DDH] ON ([DDH].[PICKING_DEMAND_HEADER_ID] = [DH].[PICKING_DEMAND_HEADER_ID])
