...
-- Ejemplo de Ejecucion:
			exec [FERCO].[OP_WMS_GET_MATERIAL_FOR_MASTER_PACK_COMPONENT_BY_CLIENT] @MASTER_PACK_MATERIAL_ID  = 'FERCO/PT0001'
, @CLIENT_ID = 'FERCO'
*/
-- =============================================
CREATE PROCEDURE [FERCO].OP_WMS_GET_MATERIAL_FOR_MASTER_PACK_COMPONENT_BY_CLIENT (@MASTER_PACK_MATERIAL_ID VARCHAR(50)
...
BEGIN
  ...
  LEFT JOIN [FERCO].[OP_WMS_COMPONENTS_BY_MASTER_PACK] [CM]
