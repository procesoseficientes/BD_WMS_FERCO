...
EXEC [FERCO].[OP_WMS_SP_GET_PASS] @PASS_HEADER_ID = 12, @LOGIN_ID = 'RUDI', @DISTRIBUTION_CENTER_ID = 'MAJADAS'
EXEC [FERCO].[OP_WMS_SP_GET_PASS] @PASS_HEADER_ID = 12, @LOGIN_ID = 'RUDI', @DISTRIBUTION_CENTER_ID = 'MAJADAS'
...
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_PASS (@PASS_HEADER_ID INT, @LOGIN_ID VARCHAR(25), @DISTRIBUTION_CENTER_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
