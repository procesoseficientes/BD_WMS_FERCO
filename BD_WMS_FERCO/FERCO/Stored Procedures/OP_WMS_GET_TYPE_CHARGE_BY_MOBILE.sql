...
-- Ejemplo de Ejecucion:      
				EXEC [FERCO].OP_WMS_GET_TYPE_CHARGE_BY_MOBILE
					@LICENSE_ID = 147625
				--
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_TYPE_CHARGE_BY_MOBILE @LICENSE_ID AS INT,
...
BEGIN
  ...
  FROM [FERCO].[OP_WMS_TYPE_CHARGE] [TC]
  ...
  LEFT JOIN [FERCO].[OP_WMS_TYPE_CHARGE_X_LICENSE] [L]
    ON [L].[TYPE_CHARGE_ID] = [TC].[TYPE_CHARGE_ID]
      AND [L].[LICENCESE_ID] = @LICENSE_ID
