...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_GET_VEHICLES_WITH_PILOT 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_VEHICLES_WITH_PILOT
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [FERCO].[OP_WMS_TRANSPORT_COMPANY] [TC]
    ON [V].[TRANSPORT_COMPANY_CODE] = [TC].[TRANSPORT_COMPANY_CODE]
