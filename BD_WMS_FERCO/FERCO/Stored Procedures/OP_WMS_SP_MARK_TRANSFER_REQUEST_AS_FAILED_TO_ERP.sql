...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_MARK_TRANSFER_REQUEST_AS_FAILED_TO_ERP]
					@RECEPTION_DOCUMENT_ID = 40790
					,@POSTED_RESPONSE = 'SAP ERROR'
					,@OWNER = 'autovanguard'
				-- 
				SELECT * FROM [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER]
				WHERE [ERP_RECEPTION_DOCUMENT_HEADER_ID] = 4079;		

*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_MARK_TRANSFER_REQUEST_AS_FAILED_TO_ERP (@RECEPTION_DOCUMENT_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    WHERE [RDD].[ERP_RECEPTION_DOCUMENT_HEADER_ID] = @RECEPTION_DOCUMENT_ID
