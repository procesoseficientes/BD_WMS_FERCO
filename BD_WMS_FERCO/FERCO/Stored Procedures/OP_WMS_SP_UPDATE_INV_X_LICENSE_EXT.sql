...
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_INV_X_LICENSE_EXT (@QTY AS NUMERIC(18, 2)
...
BEGIN
  ...
  --        SELECT @QTY_FOR_LICENCIA = QTY FROM [FERCO].[OP_WMS_INV_X_LICENSE]
  ...
  BEGIN
    ...
    EXEC [FERCO].OP_WMS_SP_INSERT_TASK_EXT @WAVE_PICKING_ID = @WAVE_PICKING_ID
                                          ,@QTY = @QTY
