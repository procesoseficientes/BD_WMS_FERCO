...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_GET_LABEL_DATA_FOR_MANIFEST @MANIFEST_HEADER_ID = 18, @LABEL_ID = 4


*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_LABEL_DATA_FOR_MANIFEST (@MANIFEST_HEADER_ID INT
, @LABEL_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  ...
  FROM [FERCO].[OP_WMS_PICKING_LABEL_BY_MANIFEST] [PLM]
