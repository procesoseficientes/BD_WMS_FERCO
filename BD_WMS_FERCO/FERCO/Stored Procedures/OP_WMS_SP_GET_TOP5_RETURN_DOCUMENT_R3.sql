...
-- Fecha de Creacion: 	20181128 GForce@Ornitorrinco
-- Description:	        Sp que trae el top 5 de los documentos de recepcion para sap cuando vienen de devolucion

/*
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_TOP5_RETURN_DOCUMENT_R3]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_TOP5_RETURN_DOCUMENT_R3]
AS
BEGIN
	SET NOCOUNT ON;
  --
