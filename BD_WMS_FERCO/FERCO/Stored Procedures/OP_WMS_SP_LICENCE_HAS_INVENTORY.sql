...
-- Ejemplo de Ejecucion:
	  EXEC [FERCO].[OP_WMS_SP_LICENCE_HAS_INVENTOR] @LICENCE_ID = 189	
    SELECT * FROM [FERCO].[OP_WMS_LICENSES] [OWL]
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_LICENCE_HAS_INVENTORY (@LICENCE_ID NUMERIC(18, 0))
AS
BEGIN
