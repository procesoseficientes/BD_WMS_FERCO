...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[[OP_WMS_SP_VALIDATE_INVENTORY_FOR_REALLOC]]
					@LICENSE_ID = 5
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_VALIDATE_INVENTORY_FOR_REALLOC] (
...
BEGIN
	...
	BEGIN TRY
		...
		FROM
			[FERCO].[OP_WMS_FN_GET_COMMITED_INVENTORY_BY_LICENCE]() [CI]
		WHERE
