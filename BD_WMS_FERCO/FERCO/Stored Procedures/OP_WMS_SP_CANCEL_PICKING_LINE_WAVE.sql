...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_CANCEL_PICKING_LINE_WAVE]
					@WAVE_PICKING_ID = 4897
					,@LOGIN = 'ADMIN'
				-- 
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_CANCEL_PICKING_LINE_WAVE] (
		@WAVE_PICKING_ID INT
		,@LOGIN VARCHAR(50)
	)
AS
BEGIN
	...
	BEGIN TRY
        ...
        -- ------------------------------------------------------------------------------------
		INSERT	INTO @RESULT
				EXEC [op_wms].[dbo].[OP_WMS_SP_DELETE_PICKING] @WAVE_PICKING_ID = @WAVE_PICKING_ID; -- int
