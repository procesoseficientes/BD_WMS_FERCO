...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_INSERT_POLIZA_DETAIL_GENERAL] @DOC_ID = 0
                                                          , @SKU_DESCRIPTION = ''
                                                          , @QTY = 1
                                                          , @CUSTOMS_AMOUNT = 1
                                                          , @CLIENT_CODE = 'q12'
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_INSERT_POLIZA_DETAIL_GENERAL (@DOC_ID NUMERIC
...
BEGIN
  ...
  BEGIN TRY
    ...
    INSERT INTO [FERCO].[OP_WMS_POLIZA_DETAIL] ([DOC_ID], [LINE_NUMBER], [SKU_DESCRIPTION], [BULTOS], [QTY], [CUSTOMS_AMOUNT], [QTY_UNIT], [CLIENT_CODE], [MATERIAL_ID], [UNITARY_PRICE], [LAST_UPDATED_BY], [LAST_UPDATED], [SAC_CODE], [DAI], [IVA], [MISC_TAXES])
