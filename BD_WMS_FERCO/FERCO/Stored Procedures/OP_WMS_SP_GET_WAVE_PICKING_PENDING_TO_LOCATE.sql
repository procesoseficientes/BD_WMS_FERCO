...
EXEC [FERCO].[OP_WMS_SP_GET_WAVE_PICKING_PENDING_TO_LOCATE] @LOGIN_ID = 'MARVIN'
*/

-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_WAVE_PICKING_PENDING_TO_LOCATE] (@LOGIN_ID VARCHAR(50))
AS
BEGIN
	SET NOCOUNT ON;
	...
	INNER JOIN [FERCO].[OP_WMS_TASK_LIST] [T] ON [T].[WAVE_PICKING_ID] = [L].[WAVE_PICKING_ID]
	LEFT JOIN [FERCO].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [NPH] ON [NPH].[WAVE_PICKING_ID] = [L].[WAVE_PICKING_ID]
	WHERE
