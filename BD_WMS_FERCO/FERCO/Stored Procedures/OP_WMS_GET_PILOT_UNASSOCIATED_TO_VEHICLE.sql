...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_GET_PILOT_UNASSOCIATED_TO_VEHICLE]
			@PILOT_CODE = 2
			--
			EXEC  [FERCO].[OP_WMS_GET_PILOT_UNASSOCIATED_TO_VEHICLE]
			@PILOT_CODE = NULL
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_PILOT_UNASSOCIATED_TO_VEHICLE (@PILOT_CODE INT = NULL)
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  LEFT JOIN [FERCO].[OP_WMS_VEHICLE] [V]
