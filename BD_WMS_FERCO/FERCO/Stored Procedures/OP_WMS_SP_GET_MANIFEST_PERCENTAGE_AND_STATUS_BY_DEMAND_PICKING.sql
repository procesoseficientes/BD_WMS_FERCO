...
-- Ejemplo de Ejecucion:
        EXEC [FERCO].[OP_WMS_SP_GET_MANIFEST_PERCENTAGE_AND_STATUS_BY_DEMAND_PICKING] @VEHICLE_CODES = '17|19|21|25' ,@PILOT_CODES = '20', @START_DATE = '2017-10-19 6:50:05 PM' , @END_DATE = '2017-11-10 11:09:53 AM'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MANIFEST_PERCENTAGE_AND_STATUS_BY_DEMAND_PICKING] (@VEHICLE_CODES VARCHAR(MAX) = NULL,
...
BEGIN
  ...
  INSERT INTO @VEHICLES
    SELECT DISTINCT
      [VS].[VALUE]
     ,[V].[PLATE_NUMBER]
    FROM [FERCO].[OP_WMS_FUNC_SPLIT_3](@VEHICLE_CODES, '|') [VS]
    INNER JOIN [FERCO].[OP_WMS_VEHICLE] [V]
  ...
  INSERT INTO @PILOTS
    SELECT DISTINCT
     ...
     ,[P].[NAME]
     ,[P].[LAST_NAME]
    FROM [FERCO].[OP_WMS_FUNC_SPLIT_3](@PILOT_CODES, '|') [PS]
    INNER JOIN [FERCO].[OP_WMS_PILOT] [P]
