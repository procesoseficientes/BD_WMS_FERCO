...
-- Ejemplo de Ejecucion:
  EXEC	[FERCO].[OP_WMS_SP_VALIDATE_RECOUNTED_MATERIAL_FOR_TASK] @LOGIN = 'ACAMACHO' , @TASK_ID = 8 , @LOCATION = 'B01-R01-C01-NB'
  , @LICENCE_ID  = 127680
, @MATERIAL_ID = 'C00030/LECH-CONDEN'
, @BATCH = '281617'
, @SERIAL = 'GDR007'
  SELECT * FROM [FERCO].[OP_WMS_PHYSICAL_COUNTS_DETAIL] [OWPCD]
    SELECT * FROM [FERCO].[OP_WMS_PHYSICAL_COUNTS_EXECUTION] [OWPCE]

*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_VALIDATE_RECOUNTED_MATERIAL_FOR_TASK] (@LOGIN VARCHAR(25)
, @TASK_ID INT
, @LOCATION VARCHAR(50)
, @LICENCE_ID INT
...
BEGIN
  ...
  LEFT JOIN [FERCO].[OP_WMS_PHYSICAL_COUNTS_EXECUTION] [E]
