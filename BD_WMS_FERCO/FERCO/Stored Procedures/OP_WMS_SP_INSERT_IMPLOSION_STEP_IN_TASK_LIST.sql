...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_INSERT_IMPLOSION_STEP_IN_TASK_LIST]
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_INSERT_IMPLOSION_STEP_IN_TASK_LIST (@LICENSE_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    --
    SELECT
      @CODIGO_POLIZA_TARGET = [CODIGO_POLIZA]
    ...
    , [CALIBER]
    , [LICENSE_ID_TARGET])
      VALUES (NULL  -- WAVE_PICKING_ID - numeric
