...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_UPDATE_MATERIAL_PROPERTY_BY_WAREHOUSE]
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_MATERIAL_PROPERTY_BY_WAREHOUSE (@MATERIAL_PROPERTY_ID INT
...
BEGIN
  ...
  --
  BEGIN TRY
    UPDATE [FERCO].[OP_WMS_MATERIAL_PROPERTY_BY_WAREHOUSE]
    SET [VALUE] = @VALUE
       ,[LAST_UPDATE] = GETDATE()
