...
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_AUDIT_RECEPTION_RESET @pAUDIT_ID NUMERIC(18, 0),
      ...
      BEGIN
        ...
        BEGIN
          ...
          WHERE AUDIT_ID = @pAUDIT_ID
            AND AUDIT_TYPE = 'RECEPTION'
          DELETE FROM [FERCO].OP_WMS_AUDIT_RECEPTION_SKUS
          WHERE AUDIT_ID = @pAUDIT_ID
        END
        ELSE
          DELETE FROM [FERCO].OP_WMS_AUDIT_RECEPTION_SKUS
        ...
        BEGIN
          ...
          WHERE AUDIT_ID = @pAUDIT_ID
            AND AUDIT_TYPE = 'RECEPTION'
          DELETE FROM [FERCO].OP_WMS_AUDIT_RECEPTION_SERIES
          WHERE AUDIT_ID = @pAUDIT_ID
        END
        ELSE
          DELETE FROM [FERCO].OP_WMS_AUDIT_RECEPTION_SERIES
