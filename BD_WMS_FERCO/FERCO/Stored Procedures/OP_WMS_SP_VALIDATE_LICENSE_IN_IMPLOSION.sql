...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_VALIDATE_LICENSE_IN_IMPLOSION]
					@LICENSE_ID = 189,
					@WAREHOUSE = 'BODEGA_11'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_VALIDATE_LICENSE_IN_IMPLOSION (@LICENSE_ID INT,
...
BEGIN
  ...
  SELECT
    CASE
      WHEN @BODEGA_VALIDA = 1 THEN 1
      ELSE -1
    END AS Resultado
   ,CASE
      WHEN @BODEGA_VALIDA = 1 THEN 'Proceso Exitoso'
