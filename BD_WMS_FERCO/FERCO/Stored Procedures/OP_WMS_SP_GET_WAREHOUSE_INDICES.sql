...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_WAREHOUSE_INDICES]
*/
-- =============================================  
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_WAREHOUSE_INDICES] (@DATE_WAREHOUSE_INDICES DATE
, @LOGIN VARCHAR(25)
, @WAREHOUSE_XML XML
, @MATERIAL_XML XML)
AS
BEGIN
  ...
  SELECT
   ...
   ,[WI].[DATE_END]
   ,[WI].[DATE_OF_PROCESS]
  FROM [FERCO].[OP_WMS_WAREHOUSE_INDICES] [WI]
  INNER JOIN @WAREHOUSE_TABLE [WT]
