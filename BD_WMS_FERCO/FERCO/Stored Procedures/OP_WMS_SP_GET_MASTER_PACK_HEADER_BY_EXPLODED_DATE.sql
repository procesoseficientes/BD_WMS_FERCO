...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_MASTER_PACK_HEADER_BY_EXPLODED_DATE] @START_DATE = '2015-01-26', @END_DATE= '2017-12-27' 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_MASTER_PACK_HEADER_BY_EXPLODED_DATE (@START_DATE DATETIME, @END_DATE DATETIME, @LOGIN VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
