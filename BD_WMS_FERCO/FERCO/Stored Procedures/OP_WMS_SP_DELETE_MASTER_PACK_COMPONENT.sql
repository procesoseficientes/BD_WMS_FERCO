...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_DELETE_MASTER_PACK_COMPONENT (@MASTER_PACK_COMPONENT_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  DELETE [FERCO].[OP_WMS_COMPONENTS_BY_MASTER_PACK]
  WHERE [MASTER_PACK_COMPONENT_ID] = @MASTER_PACK_COMPONENT_ID
