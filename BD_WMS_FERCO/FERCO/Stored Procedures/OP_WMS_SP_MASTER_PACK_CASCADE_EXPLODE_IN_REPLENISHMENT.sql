...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_MASTER_PACK_CASCADE_EXPLODE_IN_REPLENISHMENT (@MATERIAL_ID VARCHAR(25)
, @NEW_LICENSE NUMERIC
...
END
  ...
  IF @REPLENISH_MATERIAL_ID_TARGET IS NOT NULL
    AND @REPLENISH_MATERIAL_ID_TARGET <> @MATERIAL_ID
  BEGIN
    ...
    IF EXISTS (SELECT TOP 1
      ...
      EXEC [FERCO].[OP_WMS_EXPLODE_MASTER_PACK] @LICENSE_ID = @NEW_LICENSE
