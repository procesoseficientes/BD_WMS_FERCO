...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_MATERIAL_BY_BARCODE] @LICENCE_ID = 66724
                                                   ,@BARCODE_ID = 'LEC-DES-USA'

*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MATERIAL_BY_BARCODE]
    (
     @LICENCE_ID INT
...
BEGIN
    ...
    LEFT JOIN [FERCO].[OP_WMS_INV_X_LICENSE] [IL] ON [IL].[LICENSE_ID] = @LICENCE_ID
