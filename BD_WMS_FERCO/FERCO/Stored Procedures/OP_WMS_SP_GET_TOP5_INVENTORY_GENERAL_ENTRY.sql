...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_TOP5_INVENTORY_GENERAL_ENTRY (@OWNER VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  SELECT DISTINCT
   ...
   ,@SERIE [SeriesSalida]
  FROM [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] [RED]
  WHERE [RED].[IS_POSTED_ERP] <> 1
