...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_TRANSFER_REQUEST_HEADER_BY_DATE]
					@WAREHOUSE_ID = 'BODEGA_01' 
					,@START_DATETIME = '2017-08-01 00:00:00.000'
					,@END_DATETIME = '2017-12-18 00:00:00.000'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_TRANSFER_REQUEST_HEADER_BY_DATE] (
  ...
  --
    ...
    -- ------------------------------------------------------------------------------------
		...
		SELECT
			...
			,0
		FROM
			[FERCO].[OP_WMS_TRANSFER_REQUEST_HEADER] [TH] WITH (NOLOCK)
		WHERE
    ...
    -- ------------------------------------------------------------------------------------
		...
		LEFT JOIN [FERCO].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [P] WITH (NOLOCK) ON (
											[PD].[SALES_ORDER_ID] COLLATE DATABASE_DEFAULT = [P].[DOC_NUM]
