...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_MATERIALS_WITH_MEASUREMENT_UNIT] @MASTER_PACK_MATERIAL_ID  = 'FERCO/RD001',  @CLIENT_ID = 'FERCO'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MATERIALS_WITH_MEASUREMENT_UNIT] (@MASTER_PACK_MATERIAL_ID VARCHAR(50)
...
BEGIN
  ...
  SELECT
   ...
   ,0 [IS_SELECT]
   , [M].[QTY]
  FROM [FERCO].[OP_WMS_UNIT_MEASUREMENT_BY_MATERIAL] [M]
