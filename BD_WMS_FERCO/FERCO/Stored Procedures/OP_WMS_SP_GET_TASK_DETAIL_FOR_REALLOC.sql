...
-- Ejemplo de Ejecucion:
		exec 	[FERCO].OP_WMS_SP_GET_TASK_DETAIL_FOR_REALLOC @WAVE_PICKING_ID = 4487, @LOGIN  = 'ADMIN'
*/
-- =============================================
CREATE  PROCEDURE [FERCO].OP_WMS_SP_GET_TASK_DETAIL_FOR_REALLOC
(
     @WAVE_PICKING_ID INT
    ,@LOGIN VARCHAR(25)
...
AS
	...
	INNER JOIN [FERCO].[OP_WMS_CLASS] [CL] ON [CL].[CLASS_ID] = CAST([M].[MATERIAL_CLASS] AS INT)
