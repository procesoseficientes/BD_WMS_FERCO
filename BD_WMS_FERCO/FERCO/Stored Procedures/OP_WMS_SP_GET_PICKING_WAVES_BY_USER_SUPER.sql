...
-- Ejemplo de Ejecucion:
	EXEC [FERCO].[OP_WMS_SP_GET_PICKING_WAVES_BY_USER_SUPER]
	@LOGIN_ID = 'Marvin'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_PICKING_WAVES_BY_USER_SUPER]
(@LOGIN_ID VARCHAR(50))
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM [FERCO].[OP_WMS_TASK_LIST] [T]
        ...
        LEFT JOIN [FERCO].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [NPH]
