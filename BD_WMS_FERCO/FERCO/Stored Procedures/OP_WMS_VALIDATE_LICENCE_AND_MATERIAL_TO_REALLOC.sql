...
-- Ejemplo de Ejecucion:
  ...
  declare @s as varchar(250)
			EXEC [FERCO].[OP_WMS_VALIDATE_LICENCE_AND_MATERIAL_TO_REALLOC] @SOURCE_LICENCE_ID = 217715
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].OP_WMS_VALIDATE_LICENCE_AND_MATERIAL_TO_REALLOC (@SOURCE_LICENCE_ID INT
...
BEGIN
  ...
  FROM [FERCO].[OP_WMS_INV_X_LICENSE] AS [IL]
  LEFT JOIN [FERCO].OP_WMS_FN_GET_COMMITED_INVENTORY_BY_LICENCE() AS [CIL]
    ON (
  ...
  LEFT JOIN [FERCO].[OP_WMS_TONE_AND_CALIBER_BY_MATERIAL] [TCM] ON(
