...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_ASSOCIATE_VEHICLE_TO_PILOT   @VEHICLE_CODE = 1, @PILOT_CODE = 1, @LAST_UPDATE_BY = 'RD'

  SELECT * FROM [FERCO].[OP_WMS_VEHICLE] 
  SELECT * FROM [FERCO].[OP_WMS_PILOT]

*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_ASSOCIATE_VEHICLE_TO_PILOT (@VEHICLE_CODE INT, @PILOT_CODE INT, @LAST_UPDATE_BY VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
