...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_RE_ASIGN_TASKS_TO_EVERYONE_WITHOUT_TASKS] @LOGIN = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE [FERCO].OP_WMS_SP_RE_ASIGN_TASKS_TO_EVERYONE_WITHOUT_TASKS (@LOGIN VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
