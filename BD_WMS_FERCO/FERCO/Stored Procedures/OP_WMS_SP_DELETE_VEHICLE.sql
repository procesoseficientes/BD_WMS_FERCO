...
-- Ejemplo de Ejecucion:
  SELECT * FROM [FERCO].[OP_WMS_VEHICLE] [owv]
			EXEC  [FERCO].OP_WMS_SP_DELETE_VEHICLE @VEHICLE_CODE = 3
  SELECT * FROM [FERCO].[OP_WMS_VEHICLE] [owv]
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_DELETE_VEHICLE (@VEHICLE_CODE INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
