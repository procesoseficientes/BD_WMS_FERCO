...
-- Modificacion 10/10/2017 @ NEXUS-Team Sprint enave
-- rodrigo.gomez
-- Excluye los documentos cuando IS_VOID = 1 y se excluyen las recepciones que vengan de facturas para devoluciones
/*
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_TOP5_FAILED_RECEPTION_DOCUMENT]
				@OWNER = 'arium'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_TOP5_FAILED_RECEPTION_DOCUMENT] (@OWNER VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
