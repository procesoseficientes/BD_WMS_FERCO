...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_OUT_TRANSACTION_DETAIL_ERP_BY_MASTER_PACK] @MASTER_PACK_HEADER_ID = 15
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_OUT_TRANSACTION_DETAIL_ERP_BY_MASTER_PACK (@MASTER_PACK_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  SELECT
   ...
   ,[FERCO].[OP_WMS_GET_STRING_FROM_CHAR]([M].[MATERIAL_ID], '/') AS ItemCode
   ,[MPH].[QTY] AS Quantity
