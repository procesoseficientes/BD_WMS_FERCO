...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_UPDATE_TASK_PRIORITY]
					@TASK_ID = 355533
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_TASK_PRIORITY (@TASK_ID INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    BEGIN
      UPDATE [FERCO].[OP_WMS_TASK]
      SET [PRIORITY] = @PRIORITY
      WHERE [TASK_ID] = @TASK_ID
    END
    IF @TASK_TYPE = 'TAREA_PICKING' OR @TASK_TYPE = 'TAREA_REUBICACION' 
    BEGIN
      SELECT
