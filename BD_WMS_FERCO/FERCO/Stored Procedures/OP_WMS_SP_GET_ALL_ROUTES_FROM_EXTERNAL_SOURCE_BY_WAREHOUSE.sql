...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_ALL_ROUTES_FROM_EXTERNAL_SOURCE_BY_WAREHOUSE] @WAREHOUSE = ''
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_ALL_ROUTES_FROM_EXTERNAL_SOURCE_BY_WAREHOUSE] (@WAREHOUSE VARCHAR(MAX))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  FROM [FERCO].[OP_WMS_FUNC_SPLIT_2](@WAREHOUSE, @DELIMITER) [OWFS]
