...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_GET_TRANSFER_REQUEST_DOCUMENT_DETAIL]
					@DOCUMENT_ID = 31
					,@OWNER = 'viscosa'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_TRANSFER_REQUEST_DOCUMENT_DETAIL (@DOCUMENT_ID INT,
@OWNER VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  --
  SELECT
    @IS_FROM_ERP = [DH].[IS_FROM_ERP]
  FROM [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] [DH]
