...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_MANIFEST_DETAIL]
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MANIFEST_DETAIL]
...
BEGIN
    ...
    (
        SELECT TOP 1
               1
        FROM [FERCO].[OP_WMS_MANIFEST_DETAIL] [MD]
            INNER JOIN [FERCO].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [PDH]
                ON (
    ...
    BEGIN
        ...
        SELECT [MD].[MANIFEST_DETAIL_ID],
               ...
               [FERCO].[OP_WMS_FN_CONVERT_FROM_WEIGHT_MEASURE_UNIT_TO_DEFAULT](
                                                                                ISNULL(
                                                                                          (([MT].[WEIGTH])
                                                                                           * ([DD].[QTY])
                                                                                          ),
        ...
        FROM [FERCO].[OP_WMS_MANIFEST_DETAIL] [MD]
            ...
            INNER JOIN [FERCO].[OP_WMS_MATERIALS] [MT]
            ...
            LEFT JOIN [FERCO].[OP_WMS_NEXT_PICKING_DEMAND_DETAIL] [DD]
                ON (
