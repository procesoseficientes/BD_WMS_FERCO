...
-- Ejemplo de Ejecucion:
  EXEC	[FERCO].[OP_WMS_SP_GET_NEXT_MATERIAL_FOR_COUNT] @LOGIN = 'ACAMACHO' , @TASK_ID = 2 , @LOCATION = '123123'
  SELECT * FROM [FERCO].[OP_WMS_PHYSICAL_COUNTS_DETAIL] [OWrPCD]
  SELECT * FROM [FERCO].[OP_WMS_MATERIALS]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_NEXT_MATERIAL_FOR_COUNT] (
		@LOGIN VARCHAR(25)
		,@TASK_ID INT
		,@LOCATION VARCHAR(50)
	)
