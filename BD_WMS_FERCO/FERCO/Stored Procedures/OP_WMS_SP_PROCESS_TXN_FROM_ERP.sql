...
CREATE PROCEDURE FERCO.OP_WMS_SP_PROCESS_TXN_FROM_ERP
...
BEGIN
  ...
  BEGIN TRY
    UPDATE FERCO.OP_WMS_TRANS
    SET POSTED_TO_ERP_STAMP = CURRENT_TIMESTAMP
       ,MESSAGE_FROM_ERP = @pMESSAGE_FROM_ERP
       ,INVOICE_REFERENCE = @pINVOICE_REFERENCE
    WHERE TERMS_OF_TRADE = @pTERMS_OF_TRADE
    AND TRANS_DATE BETWEEN @pTRANS_DATE_INI AND
    @pTRANS_DATE_FIN
