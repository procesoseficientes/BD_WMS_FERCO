...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_INSERT_NEXT_DEMAND_PICKING_HEADER] @DOC_NUM = 0, -- int
...
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_NEXT_DEMAND_PICKING_HEADER] (
