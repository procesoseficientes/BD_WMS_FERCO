...
-- Ejemplo de Ejecucion:
                EXEC [FERCO].OP_WMS_INSERT_ADDITIONAL_DATA_FROM_CERTIFICATE_DEPOSIT_HEADER
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_INSERT_ADDITIONAL_DATA_FROM_CERTIFICATE_DEPOSIT_HEADER] (@CERTIFICATE_DEPOSIT_ID_HEADER INT
...
BEGIN
  ...
  BEGIN TRY
    ...
    UPDATE [FERCO].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER]
