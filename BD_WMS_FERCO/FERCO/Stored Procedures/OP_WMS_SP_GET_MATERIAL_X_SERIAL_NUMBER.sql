...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_MATERIAL_X_SERIAL_NUMBER]
					@MATERIAL_ID = 'C00012/CONCLIMON'
					,@SERIAL = 'SERIAL'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MATERIAL_X_SERIAL_NUMBER] (
...
BEGIN
	...
	SELECT
		...
		,[SSN].[STATUS]
	FROM
		[FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER] [SSN]
	WHERE
