...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_INVENTORY_NEEDED_FOR_MASTERPACK]
				@MASTER_PACK_CODE = 'C00030/LECHEDESCRE'
				,@WAREHOUSE_ID = 'BODEGA_01'
				,@QTY = 10
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_INVENTORY_NEEDED_FOR_MASTERPACK (@MASTER_PACK_CODE VARCHAR(50)
...
BEGIN
  ...
  INSERT INTO @COMPONENT_INVENTORY ([MASTER_PACK_ID]
  , [MATERIAL_ID]
  , [QTY]
  , [AVAILABLE]
  , [QTY_NEEDED])
