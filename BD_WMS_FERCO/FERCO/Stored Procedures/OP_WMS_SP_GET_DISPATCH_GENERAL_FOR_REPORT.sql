...
EXEC [FERCO].OP_WMS_SP_GET_DISPATCH_GENERAL_FOR_REPORT @POLICY_CODE = '1'
*/
-- =============================================

CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_DISPATCH_GENERAL_FOR_REPORT] (@POLICY_CODE VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --  
  ...
  INNER JOIN [FERCO].[OP_WMS_POLIZA_HEADER] [PHS]
    ON (
    [TL].[CODIGO_POLIZA_SOURCE] = [PHS].[CODIGO_POLIZA]
    )
  INNER JOIN [FERCO].[OP_WMS_POLIZA_HEADER] [PHT]
    ON (
    [TL].[CODIGO_POLIZA_TARGET] = [PHT].[CODIGO_POLIZA]
    )
  LEFT JOIN [FERCO].[OP_WMS_POLIZA_DETAIL] [PDS]
    ON (
