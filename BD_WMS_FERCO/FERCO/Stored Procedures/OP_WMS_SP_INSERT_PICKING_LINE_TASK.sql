-- =============================================
-- Autor:				alberto.ruiz
-- Fecha de Creacion: 	04-Oct-17 @ Nexus Team Sprint eFERCO 
...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_INSERT_PICKING_LINE_TASK]
					@WAVE_PICKING_ID = 74
					,@IS_CONSOLIDATED = 1
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_PICKING_LINE_TASK](
	@WAVE_PICKING_ID INT
	,@IS_CONSOLIDATED INT
...
BEGIN
	...
	BEGIN TRY
	    ...
	    SELECT @QUERY ='INSERT INTO #DEMAND
	    	...
	    	INNER JOIN [FERCO].[OP_WMS_MATERIALS] [M] ON ([M].[MATERIAL_ID] = [TL].[MATERIAL_ID])
	    ...
	    -- Agrega a la linea
	    -- ------------------------------------------------------------------------------------
	    INSERT INTO [FERCO].[OP_WMS_DEMAND_TO_PICK]
	    		(
	    			[ERP_DOCUMENT]
	    			,[ERP_DOC_DATE]
	    			,[LOADED_DATE]
		...
		BEGIN
    		...
    		--
    		EXEC FERCO.[OP_WMS_SP_CREATE_DISTRIBUTED_TASK]
		...
		FROM FERCO.[OP_WMS_DISTRIBUTED_TASK]
