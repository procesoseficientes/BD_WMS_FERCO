...
EXEC [FERCO].[OP_WMS_SP_INSERT_PHYSICAL_COUNTS_DETAIL] @PHYSICAL_COUNT_HEADER_ID = 1
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_INSERT_PHYSICAL_COUNTS_DETAIL (@PHYSICAL_COUNT_HEADER_ID INT
...
BEGIN
  SET NOCOUNT ON;
  --
  INSERT INTO [FERCO].[OP_WMS_PHYSICAL_COUNTS_DETAIL] ([PHYSICAL_COUNT_HEADER_ID], [ZONE], [LOCATION], [CLIENT_CODE], [MATERIAL_ID], [ASSIGNED_TO], [STATUS], [WAREHOUSE_ID])
