...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_GET_DELIVERY_FOR_RETURN] 
					@OWNER = 'Motorganica', -- varchar(50)
					@DOC_NUM = 12037276, -- int
					@EXTERNAL_SOURCE_ID = 4 -- int
						exec [FERCO].OP_WMS_GET_INVOICE_FOR_RETURN  @DOC_NUM=20055889,@OWNER=N'autovanguard',@EXTERNAL_SOURCE_ID=4
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_DELIVERY_FOR_RETURN]
    (
     @OWNER VARCHAR(50)
    ,@DOC_NUM VARCHAR(50)
...
--
    ...
    BEGIN TRY
        ...
        FROM
            [FERCO].[OP_WMS_FN_GET_PARAMETER_BY_GROUP]('ERP_RECEPTION') AS [T]
        WHERE
        ...
        SELECT
            ...
            + '.[SWIFT_SP_GET_ERP_DELIVERY_BY_DOC_NUM_FOR_RETURN_IN_WMS]
        ...
        SELECT
           ...
           ,CAST('DELIVERY' AS VARCHAR(50)) [SOURCE]
        ...
        LEFT JOIN [FERCO].[OP_WMS_UNIT_MEASUREMENT_BY_MATERIAL] [UMM] ON [UMM].[MATERIAL_ID]  COLLATE DATABASE_DEFAULT  = [M].[MATERIAL_ID]  COLLATE DATABASE_DEFAULT 
