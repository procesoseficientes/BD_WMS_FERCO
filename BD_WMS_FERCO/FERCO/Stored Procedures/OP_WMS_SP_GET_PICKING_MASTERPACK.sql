...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_PICKING_MASTERPACK]
					@PICKING_DEMAND_HEADER_ID = 4182
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_PICKING_MASTERPACK (@PICKING_DEMAND_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
  SELECT
   ...
   ,[FERCO].[OP_WMS_GET_STRING_FROM_CHAR]([D].[MATERIAL_ID], '/') AS [ItemCode]
