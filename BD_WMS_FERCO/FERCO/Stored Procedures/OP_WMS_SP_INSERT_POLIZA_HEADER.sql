...
-- Ejemplo de Ejecucion:
          EXEC [FERCO].OP_WMS_SP_INSERT_POLIZA_HEADER @DOC_ID = 0
                                                           ,@FECHA_LLEGADA = '2017-08-30 09:35:52.170'
                                                           ,@LAST_UPDATED_BY = N'PABS'
                                                           ,@LAST_UPDATED = '2017-08-30 09:35:52.170'
                                                           ,@CLIENT_CODE = N'FERCO_ALMACENADORA'
                                                           ,@FECHA_DOCUMENTO = '2017-08-30 09:35:52.170'
                                                           ,@TIPO = N'EGRESO'
                                                           ,@CODIGO_POLIZA = N'52-FERCO_ALMACENADORA'
*/
-- =============================================

CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_POLIZA_HEADER] @DOC_ID INT
...
BEGIN TRY
  ...
  SELECT TOP 1
    @DOC_ID = [H].[DOC_ID]
  FROM [FERCO].[OP_WMS_POLIZA_HEADER] [H]
  ...
  BEGIN
    ...
    INSERT INTO [FERCO].[OP_WMS_POLIZA_HEADER] ([FECHA_LLEGADA]
    , [LAST_UPDATED_BY]
    , [LAST_UPDATED]
    , [CLIENT_CODE]
    , [FECHA_DOCUMENTO]
