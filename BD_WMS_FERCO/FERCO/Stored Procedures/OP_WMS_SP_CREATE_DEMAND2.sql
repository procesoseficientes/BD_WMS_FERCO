...
CREATE PROCEDURE [FERCO].[OP_WMS_SP_CREATE_DEMAND2] (
		@LOGIN VARCHAR(50)
...
BEGIN
  ...
  -- ------------------------------------------
	...
	DECLARE	@HEADER TABLE (
			 [HEADER_ID] INT NOT NULL            -- TIPO ENTERO
							PRIMARY KEY
  ...
  -- ------------------------------------------------------------------------------------
	BEGIN
      ...
      -- ------------------------------------------------------------------------------------
			...
			SELECT TOP 1
				@HEADER_ID = [H].[HEADER_ID]    --INT - INT
				,@DETAIL_ID = [D].[DETAIL_ID]   --INT 
				,@Resultado = -1
				...
				,@OWNER = [H].[OWNER]
				,@DOC_NUM = [H].[DOC_NUM]
				--,@DOC_ENTRY = isnull([H].[DOC_ENTRY],[H].[DOC_NUM])
				--,@QTY = [D].[QTY]
