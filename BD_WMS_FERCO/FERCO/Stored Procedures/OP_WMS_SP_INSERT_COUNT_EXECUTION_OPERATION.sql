...
-- Ejemplo de Ejecucion:
  ...
  EXEC [FERCO].[OP_WMS_SP_INSERT_COUNT_EXECUTION_OPERATION] @LOGIN = 'ACAMACHO'
                                                    ,@TASK_ID = 9
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_COUNT_EXECUTION_OPERATION]
    (
     @LOGIN VARCHAR(25)
    ,@TASK_ID INT
    ,@LOCATION VARCHAR(25)
...
BEGIN
    ...
    BEGIN TRY
        EXEC [FERCO].[OP_WMS_SP_INSERT_COUNT_EXECUTION] @LOGIN = @LOGIN, -- varchar(25)
            @TASK_ID = @TASK_ID, -- int
