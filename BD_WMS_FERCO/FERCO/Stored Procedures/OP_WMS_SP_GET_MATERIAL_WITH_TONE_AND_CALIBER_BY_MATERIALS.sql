...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_MATERIAL_WITH_TONE_AND_CALIBER_BY_MATERIALS] @MATERIAL_ID = 'arium/100089', @WAREHOUSE_ID ='BODEGA_01'
    
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_MATERIAL_WITH_TONE_AND_CALIBER_BY_MATERIALS]
(
...
BEGIN
    ...
    SELECT DISTINCT
           [M].[VALUE]
    FROM [FERCO].[OP_WMS_FUNC_SPLIT_3](@MATERIAL_ID, @DELIMITER) [M]
        INNER JOIN [FERCO].[OP_WMS_MATERIALS] [M2]
    ...
    SELECT [M].[MATERIAL_ID],
           ...
           0.0000 [QTY_ORDER]
    FROM @MATERIAL [M]
        LEFT JOIN [FERCO].[OP_WMS_INV_X_LICENSE] [IXL]
