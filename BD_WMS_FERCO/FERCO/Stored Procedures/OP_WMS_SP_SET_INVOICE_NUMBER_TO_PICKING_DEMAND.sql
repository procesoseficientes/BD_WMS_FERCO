...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_SET_INVOICE_NUMBER_TO_PICKING_DEMAND]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_SET_INVOICE_NUMBER_TO_PICKING_DEMAND]
AS
BEGIN
	SET NOCOUNT ON;
	--
    ...
    FROM [FERCO].[OP_SETUP_EXTERNAL_SOURCE] [ES]
		INNER JOIN [FERCO].[OP_WMS_NEXT_PICKING_DEMAND_HEADER] [DH] ON [DH].[EXTERNAL_SOURCE_ID] = [ES].[EXTERNAL_SOURCE_ID]
