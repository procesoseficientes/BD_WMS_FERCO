...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_GET_POLIZA_HEADER_PENDING_AUTHORIZED] @START_DATE = '2017-03-01 00:00:00.000'
                                                                  ,@END_DATE ='2017-05-30 23:59:00.000'
                                                                  ,@LOGIN = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_POLIZA_HEADER_PENDING_AUTHORIZED]
(
    @START_DATE DATETIME,
    @END_DATE DATETIME,
    @LOGIN VARCHAR(25)
...
BEGIN
    ...
    FROM [FERCO].[OP_WMS_POLIZA_HEADER] [PH]
        ...
        LEFT JOIN [FERCO].[OP_WMS_TICKETS] [TK]
