...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_GET_POLIZA_DETAIL_PENDING_AUTHORIZED] @CODE_POLIZA = 101007
      EXEC [FERCO].[OP_WMS_GET_POLIZA_DETAIL_HISTORIAL_SUGGESTED_COST]  @CODE_POLIZA = 252821
    SELECT * FROM [FERCO].[OP_WMS_POLIZA_DETAIL] [HD] WHERE DOC_ID = 123123
  SELECT * FROM [FERCO].OP_WMS_POLIZA_HEADER WHERE DOC_ID = 252821
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_POLIZA_DETAIL_HISTORIAL_SUGGESTED_COST]
...
BEGIN
    ...
    FROM [FERCO].[OP_WMS_POLIZA_DETAIL] [HD]
