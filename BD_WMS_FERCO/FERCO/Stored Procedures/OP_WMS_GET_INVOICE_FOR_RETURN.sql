...
-- Modificacion 26-Oct-2022 @ Sprint 56
					-- nelson.cifuentes
					-- Se incrementa caracteres de variables CLIENT_NAME y COMMENTS a MAX de la tabla temporal [#INVOICE].

/*
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_GET_INVOICE_FOR_RETURN] 
...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_INVOICE_FOR_RETURN]
    (
     @OWNER VARCHAR(50)
    ,@DOC_NUM VARCHAR(50)
