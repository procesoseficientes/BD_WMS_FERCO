...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_MARK_AS_SENT_GENERAL_EXIT] 1, 'Proceso Exitoso', '1294123'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_MARK_AS_SENT_GENERAL_EXIT](
	@GENERAL_EXIT_ID INT
...
BEGIN
	...
	BEGIN TRY
		...
		INNER JOIN [FERCO].[OP_WMS_PICKING_ERP_DOCUMENT] PED ON [PED].[WAVE_PICKING_ID] = [TL].[WAVE_PICKING_ID]
		...
		UPDATE [FERCO].[OP_WMS_PICKING_ERP_DOCUMENT]
		SET [IS_POSTED_ERP] = 1
