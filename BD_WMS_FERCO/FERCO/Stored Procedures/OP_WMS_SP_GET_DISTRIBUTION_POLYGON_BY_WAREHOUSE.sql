...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_DISTRIBUTION_POLYGON_BY_WAREHOUSE]
				 @WAREHOUSE_ID = 'BODEGA_01'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_DISTRIBUTION_POLYGON_BY_WAREHOUSE](
		...
		BEGIN 
			...
			SELECT @QUERY = '
				...
				FROM ' + @DATA_BASE_NAME + '.' + @SCHEMA_NAME + '.[SWIFT_POLYGON] [SP]
					...
					INNER JOIN [FERCO].[OP_WMS_WAREHOUSES] [OW] ON [OW].[WAREHOUSE_ID] = [SW].[CODE_WAREHOUSE_3PL]
