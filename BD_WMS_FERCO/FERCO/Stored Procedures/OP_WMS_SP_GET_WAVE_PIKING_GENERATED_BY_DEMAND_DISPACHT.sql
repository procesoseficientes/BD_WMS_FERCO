...
EXEC [FERCO].OP_WMS_SP_GET_WAVE_PIKING_GENERATED_BY_DEMAND_DISPACHT @DATE = GETDATE()
...
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_WAVE_PIKING_GENERATED_BY_DEMAND_DISPACHT] (@DATE DATE)
AS
BEGIN
	SET NOCOUNT ON;
