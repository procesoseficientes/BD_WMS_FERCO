...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_SP_GET_LOCATION_STATUS @WAREHOUSE = 'BODEGA_04'--, @ZONE = 'Z_BODEGA_04_PASILLO', @SPOT_TYPE = 'RACK'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_LOCATION_STATUS (@WAREHOUSE VARCHAR(25) = NULL,
...
BEGIN
  ...
  INNER JOIN [FERCO].[OP_WMS_INV_X_LICENSE] [OWIXL]
  ...
  LEFT JOIN [FERCO].[OP_WMS_VW_GET_LOCATIONS_WITH_WEIGHT] [WW]
