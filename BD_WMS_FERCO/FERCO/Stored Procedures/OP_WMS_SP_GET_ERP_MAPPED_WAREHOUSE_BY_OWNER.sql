...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_ERP_MAPPED_WAREHOUSE_BY_OWNER] @OWNER = '1102' -- varchar(50)
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_ERP_MAPPED_WAREHOUSE_BY_OWNER] (@OWNER VARCHAR(50))
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	--	AND LEN([SPARE2]) > 0;
		...
		SELECT  [ERP_WAREHOUSE], [WAREHOUSE_ID] [SWIFT_WAREHOUSE],  [NAME] [ERP_WAREHOUSE_NAME]  FROM [FERCO].[OP_WMS_WAREHOUSES]
