...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_UPDATE_ASSIGNED_TASK_USER] @TASK_ASSIGNEDTO = 'ACAMACHO'
                                                          , @SERIAL_NUMBER = NULL
                                                          , @WAVE_PICKING_ID = 15465
                                                          , @MATERIAL_ID = 'C01096/51755'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_ASSIGNED_TASK_USER (@TASK_ASSIGNEDTO VARCHAR(25), @SERIAL_NUMBER DECIMAL = NULL, @WAVE_PICKING_ID DECIMAL = NULL, @MATERIAL_ID VARCHAR(25) = NULL)
AS
BEGIN
  SET NOCOUNT ON;
  --
