...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_INSERT_CERTIFICATION_HEADER] @CERTIFICATION_HEADER_ID = 1                                                
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_INSERT_CERTIFICATION_HEADER]
    (
...
BEGIN
  ...
  --
    ...
    BEGIN TRY
        ...
        INSERT  INTO [FERCO].[OP_WMS_CERTIFICATION_HEADER]
                (
                 [MANIFEST_HEADER_ID]
                ,[CREATE_DATE]
                ,[CREATE_BY]
