...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].[OP_WMS_SP_GET_CLIENTS_FOR_MANIFIEST_REPORT] @MANIFEST_HEADER_ID = 5 
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_CLIENTS_FOR_MANIFIEST_REPORT (@MANIFEST_HEADER_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
  --
