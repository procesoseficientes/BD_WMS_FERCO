...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].OP_WMS_UNLOCK_INVENTORY_LOCKED_BY_INTERFACES  @RECEPTION_DOCUMENT_ID = 456
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_UNLOCK_INVENTORY_LOCKED_BY_INTERFACES] (@RECEPTION_DOCUMENT_ID INT)
AS
BEGIN
  SET NOCOUNT ON;
