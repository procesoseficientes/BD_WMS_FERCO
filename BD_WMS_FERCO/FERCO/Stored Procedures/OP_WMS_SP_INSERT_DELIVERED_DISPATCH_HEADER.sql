...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_INSERT_DELIVERED_DISPATCH_HEADER]
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_INSERT_DELIVERED_DISPATCH_HEADER (@WAVE_PICKING_ID INT
, @STATUS VARCHAR(25)
...
BEGIN
  ...
  BEGIN TRY
    ...
    INSERT INTO [FERCO].[OP_WMS_DELIVERED_DISPATCH_HEADER] ([WAVE_PICKING_ID]
    , [STATUS]
    , [CREATE_DATE]
    , [CREATE_BY]
