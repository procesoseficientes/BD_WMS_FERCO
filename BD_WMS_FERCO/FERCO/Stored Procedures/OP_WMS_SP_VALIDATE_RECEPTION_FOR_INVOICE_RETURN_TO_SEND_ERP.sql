...
-- Modificacion 1/30/2018 @ Reborn-Team Sprint Trotzdem
					-- diego.as
					-- Se agrega modificacion para recepcion de FERCO

/*
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_VALIDATE_RECEPTION_FOR_INVOICE_RETURN_TO_SEND_ERP]
					@TASK_ID = 83244
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_VALIDATE_RECEPTION_FOR_INVOICE_RETURN_TO_SEND_ERP] (@TASK_ID INT)
AS
BEGIN
	SET NOCOUNT ON;
		--
