...
-- Ejemplo de Ejecucion:
	 EXEC [FERCO].[OP_WMS_GET_SERVICE_TO_BILL_PICKING]  @INICIAL_DATE = '2016-11-02 00:00:00.000'
  , @END_DATE = '2016-11-02 23:59:59.997', @LAST_UPDATED_BY = 'PAGUILAR'

SELECT * FROM [FERCO].[OP_WMS_TARIFICADOR_HEADER] [OWTH]  
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_SERVICE_TO_BILL_PICKING (@INICIAL_DATE DATETIME
, @END_DATE DATETIME
