...
-- Ejemplo de Ejecucion:
    ...
    SELECT * FROM [FERCO].[OP_WMS_MASTER_PACK_DETAIL]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_INSERT_MASTER_PACK_BY_REALLOC_PARTIAL] (@SOURCE_LICENSE INT
, @TARGET_LICENSE INT
...
BEGIN
  ...
  INSERT INTO [FERCO].[OP_WMS_MASTER_PACK_DETAIL]
    SELECT
     ...
     ,[D].[BATCH]
     ,[D].[DATE_EXPIRATION]
    FROM [FERCO].[OP_WMS_MASTER_PACK_DETAIL] [D]
