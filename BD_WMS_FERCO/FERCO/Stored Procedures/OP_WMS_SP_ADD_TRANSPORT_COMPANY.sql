...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_ADD_TRANSPORT_COMPANY] @NAME = 'Transportes 4 caminos'
                                                ,@ADDRESS = 'El naranjo'
                                                ,@TELEPHONE = '12345678'
                                                ,@CONTACT = 'Diego'
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_ADD_TRANSPORT_COMPANY (@NAME VARCHAR(250)
, @ADDRESS VARCHAR(250)
...
BEGIN
  ...
  BEGIN TRY
    ...
    INSERT INTO [FERCO].[OP_WMS_TRANSPORT_COMPANY] ([NAME]
    , [ADDRESS]
    , [TELEPHONE]
    , [CONTACT]
    , [MAIL]
    , [LAST_UPDATE_BY]
    , [IS_OWN])
      VALUES (@NAME, @ADDRESS, @TELEPHONE, @CONTACT, @MAIL, @LAST_UPDATE_BY, @IS_OWN);
