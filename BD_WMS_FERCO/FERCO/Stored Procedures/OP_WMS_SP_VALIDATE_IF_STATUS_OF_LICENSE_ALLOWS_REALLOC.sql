...
-- Ejemplo de Ejecucion:
			EXEC  [FERCO].OP_WMS_SP_VALIDATE_IF_STATUS_OF_LICENCE_ALLOW_REALLOC
*/
-- =============================================
CREATE	 PROCEDURE [FERCO].[OP_WMS_SP_VALIDATE_IF_STATUS_OF_LICENSE_ALLOWS_REALLOC] (
		@LICENCE_ID NUMERIC
    ...
    ---------------------------------------------------------------------------------
		...
		FROM
			(SELECT
				...
				INNER JOIN [FERCO].[OP_WMS_STATUS_OF_MATERIAL_BY_LICENSE] [S] ON [IXL].[STATUS_ID] = [S].[STATUS_ID]
				WHERE
