...
-- Ejemplo de Ejecucion:
				...
				--
				EXEC [FERCO].[OP_WMS_SP_UPDATE_TRASNFER_REQUEST_DETAIL]
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_UPDATE_TRASNFER_REQUEST_DETAIL (@TRANSFER_REQUEST_ID INT
...
BEGIN
  ...
  --
  BEGIN TRY
    UPDATE [FERCO].[OP_WMS_TRANSFER_REQUEST_DETAIL]
