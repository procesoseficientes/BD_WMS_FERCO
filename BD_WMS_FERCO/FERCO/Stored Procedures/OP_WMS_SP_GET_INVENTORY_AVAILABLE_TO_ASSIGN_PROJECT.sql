...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_INVENTORY_AVAILABLE_TO_ASSIGN_PROJECT]						
					
   */
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INVENTORY_AVAILABLE_TO_ASSIGN_PROJECT] (
		@MATERIAL_XML XML
...
BEGIN
	...
	SELECT
		...
		,[AL].[CALIBER]
	FROM
		[FERCO].[OP_WMS_VW_COMPLETELY_AVAILABLE_LICENSES] [AL]
	INNER JOIN [FERCO].[OP_WMS_WAREHOUSE_BY_USER] [WU] ON [AL].[CURRENT_WAREHOUSE] = [WU].[WAREHOUSE_ID]
