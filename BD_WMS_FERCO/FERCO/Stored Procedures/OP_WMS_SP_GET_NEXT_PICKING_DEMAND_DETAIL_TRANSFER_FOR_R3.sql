...
-- Ejemplo de Ejecucion:
			...
			--
			EXEC [FERCO].[OP_WMS_SP_GET_NEXT_PICKING_DEMAND_DETAIL_TRANSFER_FOR_R3] 
				@PICKING_DEMAND_HEADER_ID = 46
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_NEXT_PICKING_DEMAND_DETAIL_TRANSFER_FOR_R3] (
...
BEGIN
  ...
  --
	...
	INNER JOIN [FERCO].[OP_WMS_TASK_LIST] [T] ON [PDH].[WAVE_PICKING_ID] = [T].[WAVE_PICKING_ID]
	WHERE
