...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_CLIENTS_BY_WAREHOUSE_CLIENT_LOCATION_OR_ZONE]   @WAREHOUSE = 'BODEGA_04' ,@REGIMEN = 'GENERAL' , @LOCATION = 'B04-TB-C02-NU'
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_CLIENTS_BY_WAREHOUSE_CLIENT_LOCATION_OR_ZONE (@WAREHOUSE VARCHAR(MAX),
@REGIMEN VARCHAR(50),
...
BEGIN
  ...
  FROM [FERCO].[OP_WMS_FN_SPLIT](@WAREHOUSE, '|') [Z]
