...
-- Ejemplo de Ejecucion:
				--	
				EXEC [FERCO].[OP_WMS_SP_GET_ERP_SALES_ORDER_REPORT]
					@START_DATETIME = '2017-11-15 15:11:25.147'
					,@END_DATETIME = '2017-11-17 15:11:25.147'
					,@CODE_WAREHOUSE = 'BODEGA_01'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_ERP_SALES_ORDER_REPORT](
...
BEGIN
	...
	FROM [FERCO].[OP_WMS_WAREHOUSES] WHERE [WAREHOUSE_ID] = @CODE_WAREHOUSE
	-- ------------------------------------------------------------------------------------
