...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_AVAILABLE_LICENSE_DETAIL]
					@LICENSE_ID = 317851
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_AVAILABLE_LICENSE_DETAIL] (@LICENSE_ID INT)
AS
BEGIN
    SET NOCOUNT ON;
	--
    ...
    LEFT JOIN [FERCO].[OP_WMS_FN_GET_COMMITED_INVENTORY_BY_LICENCE]() [CIL] ON [CIL].[MATERIAL_ID] = [IL].[MATERIAL_ID]
