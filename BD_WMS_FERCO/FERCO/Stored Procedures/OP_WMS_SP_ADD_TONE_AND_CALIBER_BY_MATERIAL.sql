...
EXEC [FERCO].OP_WMS_SP_ADD_TONE_AND_CALIBER_BY_MATERIAL @MATERIAL_ID = 'C00030/CASEREN'
...
CREATE PROCEDURE FERCO.OP_WMS_SP_ADD_TONE_AND_CALIBER_BY_MATERIAL (@MATERIAL_ID VARCHAR(50)
...
BEGIN TRY
  ...
  BEGIN
    ...
    -- ------------------------
    INSERT INTO [FERCO].[OP_WMS_TONE_AND_CALIBER_BY_MATERIAL] ([MATERIAL_ID]
    , [TONE]
    , [CALIBER])
      VALUES (@MATERIAL_ID, @TONE_TO_INSERT, @CALIBER_TO_INSERT);
