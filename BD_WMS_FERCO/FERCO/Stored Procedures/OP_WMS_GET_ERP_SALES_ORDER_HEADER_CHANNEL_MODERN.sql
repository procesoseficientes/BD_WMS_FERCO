...
-- Autor:				jose.lopez
-- Fecha de Creacion:   17-Ago-2021
-- Description:         Se agregaron columnas asesor y codigo de asesor en base a las columnas slpName y slpCode 

/*
-- Ejemplo de Ejecucion:
			exec ferco.OP_WMS_GET_ERP_SALES_ORDER_HEADER_CHANNEL_MODERN @START_DATE='2021-01-10 00:00:00',
			@END_DATE='2021-08-17 23:59:59',@CLIENTS=N'C000001|C000002|C000004|C000005|C000006|C000010|C000013|C000014|C000015|C000025|C000100',
			@WAREHOUSE_CODE=N'CEDI_ZONA_5',@DOC_NUM=N'0'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_GET_ERP_SALES_ORDER_HEADER_CHANNEL_MODERN] (
		@START_DATE DATETIME
		,@END_DATE DATETIME
		,@CLIENTS VARCHAR(MAX)
