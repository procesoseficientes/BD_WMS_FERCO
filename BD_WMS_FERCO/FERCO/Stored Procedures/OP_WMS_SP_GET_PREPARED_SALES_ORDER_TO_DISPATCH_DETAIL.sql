...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_PREPARED_SALES_ORDER_TO_DISPATCH_DETAIL]
					@PICKING_DEMAND_HEADERS = ''
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_PREPARED_SALES_ORDER_TO_DISPATCH_DETAIL]
    (
...
BEGIN
    ...
    INTO
        [#PICKING]
    FROM
        [FERCO].[OP_WMS_FN_SPLIT](@PICKING_DEMAND_HEADERS, @DELIMITER) [PDH];
	--
	SELECT [ORDER]
