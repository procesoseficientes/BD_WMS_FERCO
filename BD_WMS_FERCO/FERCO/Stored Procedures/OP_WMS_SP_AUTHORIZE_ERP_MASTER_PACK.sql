...
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_AUTHORIZE_ERP_MASTER_PACK] (@MASTER_PACK_HEADER_ID INT, @LAST_UPDATE_BY VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  --
  BEGIN TRY
    ...
    IF NOT EXISTS (SELECT
        TOP 1
          1
        FROM [FERCO].[OP_WMS_MASTER_PACK_HEADER] [H] WITH (NOLOCK)
