...
-- Fecha de Creacion: 	20181212@Gforde@Perezoso
-- Description:	        Sp que trae el top 5 de los documentos de recepcion para sap R3

/*
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_TOP5_RECEPTION_DOCUMENT_R3]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_TOP5_RECEPTION_DOCUMENT_R3]
AS
BEGIN
	SET NOCOUNT ON;
  --
