...
/*
 -- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_MASTER_PACK_DETAIL_BY_LICENCE] @LICENCE_ID  =167628
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_SP_GET_MASTER_PACK_DETAIL_BY_LICENCE (@LICENCE_ID INT, @MATERIAL_ID VARCHAR(50))
AS
BEGIN
  SET NOCOUNT ON;
  ...
  SELECT
   ...
   ,[MPD].[BATCH]
   ,[MPD].[DATE_EXPIRATION]
  FROM [FERCO].[OP_WMS_MASTER_PACK_DETAIL] [MPD]
  INNER JOIN [FERCO].[OP_WMS_MASTER_PACK_HEADER] [H]
