...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_EXPLODE_MASTER_PACK_WITH_RESPONSE]
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_EXPLODE_MASTER_PACK_WITH_RESPONSE](
	@LICENSE_ID INT,
...
BEGIN
	...
	--
	BEGIN TRY
		EXEC [FERCO].[OP_WMS_EXPLODE_MASTER_PACK] 
