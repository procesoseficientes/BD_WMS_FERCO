...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].OP_WMS_SP_CREATE_LICENSE_BY_SUGGESTED_LOCATIONS						
					@LICENSE_ID = 469790
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_CREATE_LICENSE_BY_SUGGESTED_LOCATIONS]
(
    @LOGIN VARCHAR(50),
    @ZONE VARCHAR(50),
...
BEGIN
    ...
    BEGIN TRY
        ...
        FROM [FERCO].[OP_WMS_INV_X_LICENSE] [IL]
            ...
            INNER JOIN [FERCO].[OP_WMS_SLOTTING_ZONE] [SZ]
