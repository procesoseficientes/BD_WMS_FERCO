...
-- Ejemplo de Ejecucion:
			EXEC [FERCO].[OP_WMS_SP_GET_INVENTORY_ONLINE_BY_MASTER_PACK ] @LOGIN = 'ADMIN'
*/
-- =============================================
CREATE PROCEDURE [FERCO].[OP_WMS_SP_GET_INVENTORY_ONLINE_BY_MASTER_PACK] (@LOGIN VARCHAR(25))
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  INNER JOIN [FERCO].[OP_WMS_MATERIALS] MD
    ON [MPD].[MATERIAL_ID] = MD.[MATERIAL_ID]
  INNER JOIN [FERCO].[OP_WMS_MATERIALS] MH
