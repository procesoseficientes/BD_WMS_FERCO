...
-- Ejemplo de Ejecucion:
				EXEC  [FERCO].[OP_WMS_GET_TERMS_OF_TRADE_BY_INVENTORY]
...
*/
-- =============================================
CREATE PROCEDURE FERCO.OP_WMS_GET_TERMS_OF_TRADE_BY_INVENTORY (@CLIENT_ID VARCHAR(MAX)
, @START_DATE DATE
, @END_DATE DATE,
@LOGIN VARCHAR(25))
AS
BEGIN
  ...
  FROM FERCO.[OP_WMS_FN_SPLIT](@CLIENT_ID, @DELIMITER) [owfs]
  ...
  FROM FERCO.[OP_WMS_VIEW_VALORIZACION] [owvv]
  ...
  INNER JOIN [FERCO].[OP_WMS_VIEW_CLIENTS] [owvc]
    ON (
