...
--/****** Object:  UserDefinedFunction [FERCO].[OP_WMS_FUNC_CONSOL_TERMINAL_BYUSR]    Script Date: 06/02/2011 10:41:47 ******/
--SET ANSI_NULLS ON
--GO
...
---- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FUNC_GET_QUANTITY_PENDING] 
(
