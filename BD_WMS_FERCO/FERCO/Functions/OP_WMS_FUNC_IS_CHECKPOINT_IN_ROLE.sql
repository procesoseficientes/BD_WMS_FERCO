...
-- Ejemplo de Ejecucion:
			SELECT  * FROM [FERCO].[OP_WMS_FUNC_IS_CHECKPOINT_IN_ROLE]('ADMIN', 'CONSULTA_SOLICITUD_DE_TRASLADO')
*/
-- ============================================= 
CREATE FUNCTION [FERCO].OP_WMS_FUNC_IS_CHECKPOINT_IN_ROLE (@pRoleID VARCHAR(25),
@pCheckID VARCHAR(50))
RETURNS TABLE
AS
  RETURN
  ...
  FROM [FERCO].OP_WMS_ROLES_JOIN_CHECKPOINTS
