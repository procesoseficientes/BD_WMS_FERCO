...
-- Ejemplo de Ejecucion:
        SELECT  [FERCO].OP_WMS_FN_SPLIT_COLUMNS('MC-1540',1,'-') PREFIX
				,[FERCO].OP_WMS_FN_SPLIT_COLUMNS('MC-1540',2,'-') ID
*/
-- =============================================

--SELECT * FROM [FERCO].[OP_WMS_FN_SPLIT]()

CREATE FUNCTION [FERCO].[OP_WMS_FN_SPLIT_COLUMNS](
 @TEXT      varchar(8000)
,@COLUMN    tinyint
,@DELIMITER char(1)
