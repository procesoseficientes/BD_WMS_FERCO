...
-- Ejemplo de Ejecucion:
			SELECT * FROM [FERCO].OP_WMS_FN_GET_PARENT_MATERIALS_OF_MATERIAL ('FERCO/U00000491')
  
  SELECT * FROM [FERCO].[OP_WMS_COMPONENTS_BY_MASTER_PACK] [OWCBMP] -- WHERE COMPONENT_MATERIAL = 'FERCO/CP0000705' 
*/
-- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FN_GET_PARENT_MATERIALS_OF_MATERIAL] (@MATERIAL_ID VARCHAR(50))
