...
-- Ejemplo de Ejecucion:
        SELECT [FERCO].[OP_WMS_FUNC_GET_STATUS_MANIFEST_BY_MANIFEST_ID](1108) STATUS_OF_MANIFEST
*/
-- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FUNC_GET_STATUS_MANIFEST_BY_MANIFEST_ID] (@MANIFEST_ID INT)
RETURNS VARCHAR(50)
AS
	BEGIN
		...
		FROM
			[FERCO].[OP_WMS_MANIFEST_HEADER] AS [M]
		WHERE
