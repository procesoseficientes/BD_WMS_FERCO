...
-- Ejemplo de Ejecucion:
        SELECT [FERCO].[OP_WMS_FN_GET_AVAILABLE_INVENTORY_FOR_MASTERPACK]('FERCO/C00000261','BODEGA_01')
*/
-- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FN_GET_AVAILABLE_INVENTORY_FOR_MASTERPACK]
(
...
BEGIN
	...
	FROM [FERCO].[OP_WMS_VIEW_PICKING_AVAILABLE_GENERAL]
	...
	LEFT JOIN [FERCO].[OP_WMS_VIEW_PICKING_AVAILABLE_GENERAL] [IXW] 
	...
	BEGIN
		...
		SET REAL_QTY = CAST([FERCO].[OP_WMS_FN_GET_AVAILABLE_INVENTORY_FOR_MASTERPACK](@SubComponentMaterial, @WAREHOUSE_ID) / @SubComponentQTY_NEEDED AS INT)
