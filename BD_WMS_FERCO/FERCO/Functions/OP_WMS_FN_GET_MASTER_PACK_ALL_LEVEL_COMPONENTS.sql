...
-- Ejemplo de Ejecucion:
			SELECT  * FROM [FERCO].[OP_WMS_FN_GET_MASTER_PACK_ALL_LEVEL_COMPONENTS] ('C00030/RD-001')
  SELECT * FROM [FERCO].[OP_WMS_MATERIALS] [OWM] WHERE [OWM].[IS_MASTER_PACK] = 1 
  SELECT * FROM [FERCO].[OP_WMS_COMPONENTS_BY_MASTER_PACK] [C] where master_pack_code = 'C00030/M-RD-003'
  
*/
-- =============================================
CREATE FUNCTION [FERCO].OP_WMS_FN_GET_MASTER_PACK_ALL_LEVEL_COMPONENTS (@MATERIAL_ID VARCHAR(25))
