...
-- Ejemplo de Ejecucion:
        SELECT * FROM [FERCO].[OP_WMS_FUNC_GET_MY_FIRST_PICKING_ALMGEN]('LINEA_PICKING_1',286,'7702354251765', '')
		SELECT * FROM [FERCO].[OP_WMS_TASK_LIST] [T] 
*/
-- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FUNC_GET_MY_FIRST_PICKING_ALMGEN] (@pLOGIN_ID VARCHAR(25),
