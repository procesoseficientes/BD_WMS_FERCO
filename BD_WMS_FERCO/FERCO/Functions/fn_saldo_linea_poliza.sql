...
*/
-- =============================================
CREATE FUNCTION [FERCO].[fn_saldo_linea_poliza]()
...
BEGIN
 DECLARE 
  ...
  SELECT DISTINCT A.DOC_ID,A.LINE_NUMBER FROM [FERCO].OP_WMS_POLIZA_DETAIL A
  INNER JOIN [FERCO].OP_WMS_POLIZA_HEADER B ON A.DOC_ID = B.DOC_ID
 ...
 BEGIN 
		...
		FROM [FERCO].OP_WMS_POLIZA_DETAIL WHERE ORIGIN_DOC_ID = @DOC_ID 
		...
		FROM [FERCO].OP_WMS_POLIZA_DETAIL WHERE DOC_ID = @DOC_ID AND LINE_NUMBER = @LINE_NUMBER;
