...
-- Ejemplo de Ejecucion:
				SELECT * FROM [FERCO].OP_WMS_FUNC_GET_MY_PICKING_LIST_DETAIL_ALMGEN('ACAMACHO')
*/
-- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FUNC_GET_MY_PICKING_LIST_DETAIL_ALMGEN] (@pLOGIN_ID VARCHAR(25))
RETURNS TABLE
AS
  RETURN
  (
