...
-- Ejemplo de Ejecucion:
				SELECT * FROM [FERCO].OP_WMS_FUNC_GET_MY_REALLOC_TASK_LIST_DETAIL('ACAMACHO')
*/
-- =============================================
CREATE FUNCTION [FERCO].OP_WMS_FUNC_GET_MY_REALLOC_TASK_LIST_DETAIL(@pLOGIN_ID VARCHAR(25))
RETURNS TABLE
AS
  RETURN
  (
