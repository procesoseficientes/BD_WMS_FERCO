...
-- Ejemplo de Ejecucion:
			SELECT [FERCO].[OP_WMS_FN_CONVERT_FROM_WEIGHT_MEASURE_UNIT_TO_DEFAULT]( 10, 'KG') CONVERSION
*/
-- =============================================

CREATE FUNCTION [FERCO].[OP_WMS_FN_CONVERT_FROM_WEIGHT_MEASURE_UNIT_TO_DEFAULT] (@QTY DECIMAL(18, 6),
@UNIT VARCHAR(50))
