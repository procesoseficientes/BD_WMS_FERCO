...
-- Ejemplo de Ejecucion:
        SELECT * FROM [FERCO].[OP_WMS_FN_GET_SUB_CLASSES_BY_LOCATION]('B01-R01-C01-NA')
*/
-- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FN_GET_SUB_CLASSES_BY_LOCATION]
(	
