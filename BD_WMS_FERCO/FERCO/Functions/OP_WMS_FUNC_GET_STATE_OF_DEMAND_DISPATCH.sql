...
-- Ejemplo de Ejecucion:
        SELECT * FROM [FERCO].[OP_WMS_FUNC_GET_STATE_OF_DEMAND_DISPATCH] 
*/
-- =============================================
CREATE FUNCTION [FERCO].OP_WMS_FUNC_GET_STATE_OF_DEMAND_DISPATCH
(
...
BEGIN
	...
	FROM [FERCO].[OP_WMS_PICKING_LABELS] AS PL
	INNER JOIN [FERCO].[OP_WMS_DELIVERED_LABEL] AS PLD ON([PLD].[LABEL_ID] = [PL].[LABEL_ID])
