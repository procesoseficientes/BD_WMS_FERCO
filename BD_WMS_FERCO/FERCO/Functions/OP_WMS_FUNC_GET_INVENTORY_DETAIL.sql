...
-- Ejemplo de Ejecucion:
			SELECT * FROM [FERCO].[OP_WMS_FUNC_GET_INVENTORY_DETAIL]('C00030/LECHEHAPRO') 

*/
-- =============================================
CREATE FUNCTION [FERCO].[OP_WMS_FUNC_GET_INVENTORY_DETAIL] (
...
RETURNS TABLE
  ...
  RETURN
	(SELECT
		...
		FROM
			[FERCO].[OP_WMS_VIEW_INVENTORY_DETAIL] [I]
		LEFT JOIN [FERCO].[OP_WMS_VW_GET_LOCATIONS_WITH_WEIGHT] [W] ON [CURRENT_LOCATION] = [W].[LOCATION_SPOT]
		WHERE
