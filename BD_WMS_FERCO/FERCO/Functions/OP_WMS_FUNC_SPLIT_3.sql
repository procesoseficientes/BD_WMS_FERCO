...
-- Ejemplo de Ejecucion:
        ...
        --
        SELECT * FROM [FERCO].OP_WMS_FUNC_SPLIT_3('A|B|C|D','|')
*/
-- =============================================
CREATE FUNCTION [FERCO].OP_WMS_FUNC_SPLIT_3 (@STRING VARCHAR(MAX),
@DELIMITER NCHAR(1))
RETURNS TABLE
AS
  RETURN (SELECT
  ...
  FROM [FERCO].[OP_WMS_FUNC_SPLIT](@STRING, @DELIMITER)
  );