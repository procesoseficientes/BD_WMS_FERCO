...
-- Ejemplo de Ejecucion:
        SELECT * FROM [FERCO].[OP_WMS_VIEW_PICKING_TASK]
*/
-- =============================================
CREATE FUNCTION [FERCO].OP_WMS_FUNC_GET_MY_PICKING_LIST_HEADER
(	
...
(
	SELECT 
		A.WAVE_PICKING_ID,
		MAX(ISNULL(TASK_COMMENTS,'SC')+' DESPACHO FISCAL') AS TASK_COMMENTS,
...
FROM 
	FERCO.OP_WMS_VIEW_PICKING_TASK A
...
WHERE 
	...
	AND A.TASK_SUBTYPE = 'DESPACHO_FISCAL' AND REGIMEN = 'FISCAL'
GROUP BY 
	A.WAVE_PICKING_ID	
)