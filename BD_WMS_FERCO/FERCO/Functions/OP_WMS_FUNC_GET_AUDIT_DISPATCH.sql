...
-- =============================================
CREATE FUNCTION [FERCO].OP_WMS_FUNC_GET_AUDIT_DISPATCH
(	
...
SELECT DISTINCT
 ...
 FROM 
	[FERCO].OP_WMS_AUDIT_DISPATCH_CONTROL A,  
	[FERCO].OP_WMS_AUDIT_DISPATCH_SKUS B
  ...
  LEFT JOIN [FERCO].OP_WMS_FUN_GET_MATERIAL_PICKING() MP ON(
    MP.[MATERIAL_ID] = M.[MATERIAL_ID]    
  )
	--LEFT JOIN [FERCO].OP_WMS_AUDIT_DISPATCH_SERIES S ON M.MATERIAL_ID = S.MATERIAL_ID AND B.AUDIT_ID = S.AUDIT_ID
	--FERCO.OP_WMS_VIEW_PICKING_VS_AUDIT C
 WHERE 
