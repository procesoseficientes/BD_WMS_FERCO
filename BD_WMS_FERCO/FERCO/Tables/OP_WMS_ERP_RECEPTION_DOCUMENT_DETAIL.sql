CREATE TABLE [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL] (
    ...
    [LICENSE_ID_SOURCE]                INT             NULL,
    [ACCEPTED_DATE]                    DATETIME        NULL,
    [COMPLETED_DATE]                   DATETIME        NULL,
    PRIMARY KEY CLUSTERED ([ERP_RECEPTION_DOCUMENT_DETAIL_ID] ASC),
    CONSTRAINT [FK_RECEPTION_DOCUMENT_DETAIL_HEADER] FOREIGN KEY ([ERP_RECEPTION_DOCUMENT_HEADER_ID]) REFERENCES [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] ([ERP_RECEPTION_DOCUMENT_HEADER_ID])
);


GO
CREATE NONCLUSTERED INDEX [IDX_ERP_RECEPTION_DOCUMENT_DETAIL_ID_ERP_RECEPTIONS]
    ON [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL]([ERP_RECEPTION_DOCUMENT_HEADER_ID] ASC)
    INCLUDE([ERP_OBJECT_TYPE], [ERP_RECEPTION_DOCUMENT_DETAIL_ID], [LINE_NUM], [MATERIAL_ID], [QTY]);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL_ERP_RECEPTION_DOCUMENT_HEADER_ID_MATERIAL_ID]
    ON [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL]([ERP_RECEPTION_DOCUMENT_HEADER_ID] ASC, [MATERIAL_ID] ASC)
    INCLUDE([ATTEMPTED_WITH_ERROR], [POSTED_ERP], [POSTED_RESPONSE], [ERP_REFERENCE], [ERP_REFERENCE_DOC_NUM], [IS_POSTED_ERP], [LINE_NUM]);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL_HEADER_ID_MATERIAL_ID_IS_POSTED_ERP]
    ON [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_DETAIL]([ERP_RECEPTION_DOCUMENT_HEADER_ID] ASC, [MATERIAL_ID] ASC, [IS_POSTED_ERP] ASC);
