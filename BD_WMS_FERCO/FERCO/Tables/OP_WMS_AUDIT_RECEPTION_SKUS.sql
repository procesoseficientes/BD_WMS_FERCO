CREATE TABLE [FERCO].[OP_WMS_AUDIT_RECEPTION_SKUS] (
    ...
    CONSTRAINT [PK_OP_WMS_RECEPTION_AUDIT_SKUS] PRIMARY KEY CLUSTERED ([AUDIT_ID] ASC, [CODIGO_POLIZA] ASC, [MATERIAL_ID] ASC)
);
