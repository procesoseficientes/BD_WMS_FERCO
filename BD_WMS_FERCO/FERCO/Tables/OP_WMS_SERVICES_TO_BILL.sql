CREATE TABLE [FERCO].[OP_WMS_SERVICES_TO_BILL] (
    ...
    PRIMARY KEY CLUSTERED ([SERVICES_TO_BILL_ID] ASC),
    CONSTRAINT [FK_SERVICES_TO_BILL_ACUERDO_COMERCIAL] FOREIGN KEY ([ACUERDO_COMERCIAL]) REFERENCES [FERCO].[OP_WMS_TARIFICADOR_HEADER] ([ACUERDO_COMERCIAL_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_CLIENT_CODE]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([CLIENT_CODE] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_CLIENT_CODE_LICENSE_ID]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([CLIENT_CODE] ASC, [LICENSE_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_CLIENT_CODE_REGIMEN]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([CLIENT_CODE] ASC, [REGIMEN] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_CLIENT_CODE_TRANSACTION_ID]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([CLIENT_CODE] ASC, [TRANSACTION_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_CLIENT_CODE_TYPE_CHARGE_ID]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([CLIENT_CODE] ASC, [TYPE_CHARGE_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_DOC_NUM]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([DOC_NUM] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_LICENSE_ID]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([LICENSE_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_REGIMEN]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([REGIMEN] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_TRANSACTION_ID]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([TRANSACTION_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_SERVICES_TO_BILL_TYPE_CHARGE_ID]
    ON [FERCO].[OP_WMS_SERVICES_TO_BILL]([TYPE_CHARGE_ID] ASC);
