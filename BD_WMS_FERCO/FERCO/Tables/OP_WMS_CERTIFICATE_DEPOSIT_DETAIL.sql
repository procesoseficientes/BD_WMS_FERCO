CREATE TABLE [FERCO].[OP_WMS_CERTIFICATE_DEPOSIT_DETAIL] (
    ...
    CONSTRAINT [PK_OP_WMS_CERTIFICATE_DEPOSIT_DETAIL] PRIMARY KEY CLUSTERED ([CERTIFICATE_DEPOSIT_ID_DETAIL] ASC)
);
