CREATE TABLE [FERCO].[OP_WMS_POLIZA_DETAIL] (
    ...
    CONSTRAINT [PK_OP_WMS_POLIZA_DETAIL] PRIMARY KEY CLUSTERED ([DOC_ID] ASC, [LINE_NUMBER] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_OP_WMS_POLIZA_DETAIL]
    ON [FERCO].[OP_WMS_POLIZA_DETAIL]([ORIGIN_DOC_ID] ASC, [ORIGIN_LINE_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_OP_WMS_POLIZA_DETAIL_1]
    ON [FERCO].[OP_WMS_POLIZA_DETAIL]([ACUERDO_COMERCIAL] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_OP_WMS_POLIZA_DETAIL_2]
    ON [FERCO].[OP_WMS_POLIZA_DETAIL]([RELATED_POLIZA] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_OP_WMS_POLIZA_DETAIL_3]
    ON [FERCO].[OP_WMS_POLIZA_DETAIL]([ORIGIN_DOC_ID] ASC, [SKU_DESCRIPTION] ASC);
