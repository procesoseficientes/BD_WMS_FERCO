CREATE TABLE [FERCO].[OP_WMS_AUDIT_DISPATCH_CONTROL] (
    ...
    CONSTRAINT [PK_OP_WMS_AUDIT_DISPATCH_HEADER_1] PRIMARY KEY CLUSTERED ([AUDIT_ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_OP_WMS_AUDIT_DISPATCH_CONTROL_BY_UPD]
    ON [FERCO].[OP_WMS_AUDIT_DISPATCH_CONTROL]([LAST_UPDATED] ASC);
