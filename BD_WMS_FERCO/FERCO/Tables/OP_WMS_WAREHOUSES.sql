CREATE TABLE [FERCO].[OP_WMS_WAREHOUSES] (
    ...
    [IMPLEMENTS_WMS]             INT           NULL,
    CONSTRAINT [PK_OP_WMS_WAREHOUSES] PRIMARY KEY CLUSTERED ([WAREHOUSE_ID] ASC),
    UNIQUE NONCLUSTERED ([ERP_WAREHOUSE] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_WAREHOUSES_DISTRIBUTION_CENTER_ID]
    ON [FERCO].[OP_WMS_WAREHOUSES]([DISTRIBUTION_CENTER_ID] ASC)
    INCLUDE([ALLOW_PICKING], [COMMENTS], [DEFAULT_RECEPTION_LOCATION], [ERP_WAREHOUSE], [GPS_URL], [IS_3PL_WAREHUESE], [NAME], [SHUNT_NAME], [WAHREHOUSE_ADDRESS], [WAREHOUSE_ID], [WAREHOUSE_STATUS], [WAREHOUSE_WEATHER]);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_WAREHOUSES_ERP_WAREHOUSE]
    ON [FERCO].[OP_WMS_WAREHOUSES]([ERP_WAREHOUSE] ASC)
    INCLUDE([ALLOW_PICKING], [COMMENTS], [DEFAULT_RECEPTION_LOCATION], [DISTRIBUTION_CENTER_ID], [GPS_URL], [IS_3PL_WAREHUESE], [NAME], [SHUNT_NAME], [WAHREHOUSE_ADDRESS], [WAREHOUSE_ID], [WAREHOUSE_STATUS], [WAREHOUSE_WEATHER]);
