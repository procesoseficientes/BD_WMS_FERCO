CREATE TABLE [FERCO].[OP_WMS_DISPATCH_LICENSE_EXIT_DETAIL] (
    ...
    [LINE_NUM]                        INT             NULL,
    CONSTRAINT [PK_OP_WMS_DISPATCH_LICENSE_EXIT_DETAIL_DISPATCH_LICENSE_EXIT_DETAIL] PRIMARY KEY CLUSTERED ([DISPATCH_LICENSE_EXIT_DETAIL] ASC),
    FOREIGN KEY ([DISPATCH_LICENSE_EXIT_HEADER_ID]) REFERENCES [FERCO].[OP_WMS_DISPATCH_LICENSE_EXIT_HEADER] ([DISPATCH_LICENSE_EXIT_HEADER_ID])
);
