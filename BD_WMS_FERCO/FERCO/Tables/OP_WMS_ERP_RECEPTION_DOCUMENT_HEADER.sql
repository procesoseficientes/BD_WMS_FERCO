CREATE TABLE [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER] (
    ...
    PRIMARY KEY CLUSTERED ([ERP_RECEPTION_DOCUMENT_HEADER_ID] ASC),
    FOREIGN KEY ([MANIFEST_HEADER_ID]) REFERENCES [FERCO].[OP_WMS_MANIFEST_HEADER] ([MANIFEST_HEADER_ID]),
    CONSTRAINT [FK_OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER_POLIZA_HEADER_DOC_ID] FOREIGN KEY ([DOC_ID_POLIZA]) REFERENCES [FERCO].[OP_WMS_POLIZA_HEADER] ([DOC_ID]),
    CONSTRAINT [FK_RECEPTION_DOCUMENT_TASK_LIST] FOREIGN KEY ([TASK_ID]) REFERENCES [FERCO].[OP_WMS_TASK_LIST] ([SERIAL_NUMBER]),
    CONSTRAINT [FK_RECEPTION_EXTERNAL_SOURCE] FOREIGN KEY ([EXTERNAL_SOURCE_ID]) REFERENCES [FERCO].[OP_SETUP_EXTERNAL_SOURCE] ([EXTERNAL_SOURCE_ID])
);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER_DOC_NUM_IS_FROM_WAREHOUSE_TRANSFER]
    ON [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER]([DOC_NUM] ASC, [IS_FROM_WAREHOUSE_TRANSFER] ASC)
    INCLUDE([LAST_UPDATE]);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER_DOC_NUM_IS_FROM_WAREHOUSE_TRANSFER_TASK_ID]
    ON [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER]([DOC_NUM] ASC, [IS_FROM_WAREHOUSE_TRANSFER] ASC, [TASK_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER_TASK_ID]
    ON [FERCO].[OP_WMS_ERP_RECEPTION_DOCUMENT_HEADER]([TASK_ID] ASC)
    INCLUDE([CODE_CLIENT], [CODE_SUPPLIER], [DOC_NUM], [EXTERNAL_SOURCE_ID], [NAME_SUPPLIER], [OWNER]);
