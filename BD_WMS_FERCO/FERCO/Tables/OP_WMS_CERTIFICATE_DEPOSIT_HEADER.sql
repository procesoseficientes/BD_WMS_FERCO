CREATE TABLE [FERCO].[OP_WMS_CERTIFICATE_DEPOSIT_HEADER] (
    ...
    CONSTRAINT [PK_OP_WMS_CERTIFICATE_DEPOSIT_HEADER] PRIMARY KEY CLUSTERED ([CERTIFICATE_DEPOSIT_ID_HEADER] ASC)
);
