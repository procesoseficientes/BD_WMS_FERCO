CREATE TABLE [FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER] (
    ...
    CONSTRAINT [UK_OP_WMS_MATERIAL_X_SERIAL_NUMBER_MATERIAL_SERIAL_NUMBER] UNIQUE NONCLUSTERED ([MATERIAL_ID] ASC, [SERIAL] ASC, [LICENSE_ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_MATERIAL_X_SERIAL_NUMBER_LICENSE_ID_MATERIAL_ID]
    ON [FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER]([LICENSE_ID] ASC, [MATERIAL_ID] ASC)
    INCLUDE([BATCH], [DATE_EXPIRATION], [SERIAL], [STATUS]);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_MATERIAL_X_SERIAL_NUMBER_MATERIAL_ID_SERIAL]
    ON [FERCO].[OP_WMS_MATERIAL_X_SERIAL_NUMBER]([MATERIAL_ID] ASC, [SERIAL] ASC);
