...
-- Ejemplo de Ejecucion:
			SELECT * FROM [FERCO].[OP_WMS_VW_GET_LOCATIONS_WITH_WEIGHT] 
  SELECT COUNT(IS_OVERWEIGHT),IS_OVERWEIGHT FROM [FERCO].[OP_WMS_VW_GET_LOCATIONS_WITH_WEIGHT] GROUP BY IS_OVERWEIGHT
*/
-- =============================================
CREATE VIEW FERCO.OP_WMS_VW_GET_LOCATIONS_WITH_WEIGHT
AS
SELECT
  [S].[LOCATION_SPOT]
 ,[S].[WAREHOUSE_PARENT]
...
LEFT JOIN [FERCO].[OP_WMS_VW_GET_MATERIAL_WEIGHT_IN_TONS] M
