...
-- Ejemplo de Ejecucion:
			SELECT COUNT(*) FROM [FERCO].OP_WMS_VIEW_INVENTORY_X_REGIMEN
*/
-- =============================================
CREATE VIEW [FERCO].[OP_WMS_VIEW_INVENTORY_X_REGIMEN]
AS
SELECT
	[B].[REGIMEN]
	,[B].[CURRENT_WAREHOUSE]
...
INNER JOIN [FERCO].[OP_WMS_TARIFICADOR_HEADER] AS [D] ON (
...
LEFT JOIN [FERCO].[OP_WMS_CONFIGURATIONS] [CONF] ON (
