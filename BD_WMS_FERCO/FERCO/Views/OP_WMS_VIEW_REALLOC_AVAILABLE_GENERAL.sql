...
-- Ejemplo de Ejecucion:
			SELECT * FROM [FERCO].[OP_WMS_VIEW_REALLOC_AVAILABLE_GENERAL]
*/
-- =============================================
CREATE VIEW FERCO.OP_WMS_VIEW_REALLOC_AVAILABLE_GENERAL
AS
SELECT
  [inv].[MATERIAL_ID]
 ,[inv].[MATERIAL_NAME]
...
INNER JOIN [FERCO].[OP_WMS_STATUS_OF_MATERIAL_BY_LICENSE]
AS [SML]
  ON [SML].[STATUS_ID] = [inv].[STATUS_ID]
