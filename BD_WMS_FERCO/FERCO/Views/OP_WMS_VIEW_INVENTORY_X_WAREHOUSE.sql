...
-- Ejemplo de Ejecucion:
			SELECT COUNT(*) FROM [FERCO].OP_WMS_VIEW_INVENTORY_X_WAREHOUSE
*/
-- =============================================

CREATE VIEW FERCO.OP_WMS_VIEW_INVENTORY_X_WAREHOUSE
AS
SELECT
 ...
 ,[TC].[TONE]
 ,[TC].[CALIBER]
FROM [FERCO].OP_WMS_INV_X_LICENSE AS A
...
INNER JOIN [FERCO].OP_WMS_MATERIALS AS C
  ON (A.MATERIAL_ID = C.MATERIAL_ID
      AND [C].[MATERIAL_ID] > '')
INNER JOIN [FERCO].[OP_WMS_TARIFICADOR_HEADER] AS D
