...
CREATE VIEW FERCO.OP_WMS_VIEW_ACUERDOS
AS
--SELECT 
--	codcliente, 
--	nomcliente, 
...
INNER JOIN FERCO.OP_WMS_VIEW_CLIENTS c
  ON ac.CLIENT_ID = c.CLIENT_CODE COLLATE DATABASE_DEFAULT
INNER JOIN FERCO.OP_WMS_TARIFICADOR_HEADER t
  ON ac.ACUERDO_COMERCIAL = t.ACUERDO_COMERCIAL_ID
