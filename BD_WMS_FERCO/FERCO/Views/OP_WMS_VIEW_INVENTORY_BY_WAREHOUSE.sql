...
CREATE VIEW [FERCO].[OP_WMS_VIEW_INVENTORY_BY_WAREHOUSE]
AS
...
SELECT
 ...
 ,((SELECT ERP_WAREHOUSE FROM FERCO.OP_WMS_WAREHOUSES WHERE WAREHOUSE_ID = [L].CURRENT_WAREHOUSE)) AS ERP_WAREHOUSE
