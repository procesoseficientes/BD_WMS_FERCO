...
-- Autor:				Elder Lucas
-- Fecha de Creacion: 	2022.03.03
-- Descripcion:			Query se modifica para no mostrar las licencias que estén despachadas
/*
-- Ejemplo de Ejecucion:
		--
		SELECT top 10000 * FROM [FERCO].[OP_WMS_VIEW_INVENTORY_DETAIL_WHITH_SERIES]
		where license_id = 4162830
		--      
*/
-- =============================================

CREATE VIEW [FERCO].[OP_WMS_VIEW_INVENTORY_DETAIL_WHITH_SERIES]
AS
SELECT
	[C].[CLIENT_NAME]
	,[PH].[NUMERO_ORDEN]
...
--WHERE L.WAVE_PICKING_ID NOT IN (SELECT DISTINCT WAVE_PICKING_ID FROM FERCO.OP_WMS_PASS_DETAIL);
