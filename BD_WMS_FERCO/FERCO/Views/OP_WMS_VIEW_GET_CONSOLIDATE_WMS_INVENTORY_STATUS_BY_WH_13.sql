...
-- Ejemplo de Ejecucion:
        SELECT * FROM [FERCO].[[OP_WMS_VIEW_GET_CONSOLIDATE_WMS_INVENTORY_STATUS_BY_WH_13]]
...
*/
-- =============================================
CREATE VIEW [FERCO].[OP_WMS_VIEW_GET_CONSOLIDATE_WMS_INVENTORY_STATUS_BY_WH_13]
AS
(SELECT 
MATERIAL_ID 
,MATERIAL_NAME
