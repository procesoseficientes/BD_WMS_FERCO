...
-- Ejemplo de Ejecucion:
			select * from [FERCO].OP_WMS_VIEW_VALORIZACION_ALMGEN
*/
-- =============================================
CREATE VIEW FERCO.OP_WMS_VIEW_VALORIZACION_ALMGEN
AS
(SELECT
    CLIENT_NAME
   ,CLIENT_OWNER
  ...
  LEFT JOIN [FERCO].OP_WMS_POLIZA_HEADER H
    ON H.CODIGO_POLIZA = A.CODIGO_POLIZA
  LEFT JOIN [FERCO].OP_WMS_POLIZA_DETAIL D
