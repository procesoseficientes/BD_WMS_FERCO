...
CREATE VIEW FERCO.OP_WMS3PL_VIEW_PENDING
AS
...
--FROM         [FERCO].OP_WMS_POLIZA_DETAIL AS pd INNER JOIN
--                      [FERCO].OP_WMS_POLIZA_HEADER AS ph ON pd.DOC_ID = ph.DOC_ID
