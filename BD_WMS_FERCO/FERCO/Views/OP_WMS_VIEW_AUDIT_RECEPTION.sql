...
CREATE VIEW FERCO.OP_WMS_VIEW_AUDIT_RECEPTION
AS
--SELECT     AUDIT_ID, ISNULL
--                          ((SELECT     CODIGO_POLIZA
--                              FROM         [FERCO].OP_WMS_AUDIT_RECEPTION_CONTROL AS B
...
--FROM         [FERCO].OP_WMS_AUDIT_RECEPTION_SKUS AS A
SELECT
  A.AUDIT_ID
 ,ISNULL((SELECT
      CODIGO_POLIZA
 ...
 ,(SELECT
      COUNTING_METHOD
    FROM [FERCO].OP_WMS_AUDIT_RECEPTION_CONTROL B
    WHERE A.AUDIT_ID = B.AUDIT_ID)
  AS COUNTING_METHOD
FROM [FERCO].OP_WMS_AUDIT_RECEPTION_SKUS AS A
LEFT JOIN [FERCO].OP_WMS_AUDIT_RECEPTION_SERIES S
