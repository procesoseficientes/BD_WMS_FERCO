...
*/
-- =============================================
CREATE VIEW [FERCO].[OP_WMS_VIEW_INVENTORY_FOR_PICKING_BY_STATUS_MATERIAL]
AS
SELECT
	[M].[MATERIAL_ID]
	,[M].[MATERIAL_NAME]
...
left JOIN [FERCO].[OP_WMS_TARIFICADOR_HEADER] [TH] ON [PH].[ACUERDO_COMERCIAL] = [TH].[ACUERDO_COMERCIAL_ID]
