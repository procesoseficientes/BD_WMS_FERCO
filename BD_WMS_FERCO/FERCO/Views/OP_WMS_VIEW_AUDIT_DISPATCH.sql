...
CREATE VIEW FERCO.OP_WMS_VIEW_AUDIT_DISPATCH
AS
...
--FROM         [FERCO].OP_WMS_AUDIT_DISPATCH_SKUS AS A INNER JOIN
--                      [FERCO].OP_WMS_AUDIT_DISPATCH_CONTROL AS B ON A.AUDIT_ID = B.AUDIT_ID INNER JOIN
...
INNER JOIN [FERCO].OP_WMS_AUDIT_DISPATCH_CONTROL AS B
