...
-- Ejemplo de Ejecucion:
				SELECT * FROM [FERCO].OP_WMS_VIEW_INSURANCE_DOC
*/
-- =============================================


CREATE VIEW FERCO.OP_WMS_VIEW_INSURANCE_DOC
AS
...
FROM [FERCO].OP_WMS_INSURANCE_DOCS ID
INNER JOIN [FERCO].OP_WMS_INSURANCE_COMPANIES IC
  ON (
...
LEFT JOIN [FERCO].OP_WMS_VIEW_VALORIZACION VV
  ON (
...
/*SELECT
 ...
 ,(SELECT
    ...
    JOIN [FERCO].OP_WMS_POLIZA_HEADER P
 ...
 ,AMOUNT - (SELECT
    ...
    WHERE POLIZA_ASEGURADA = CONVERT(varchar,isd.DOC_ID))
  AS AMOUNTDIF
FROM [FERCO].OP_WMS_INSURANCE_DOCS isd
INNER JOIN [FERCO].OP_WMS_INSURANCE_COMPANIES isc
