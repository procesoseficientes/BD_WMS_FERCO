CREATE TABLE [dbo].[OP_WMS_WAREHOUSE_INDICES] (
    ...
    CONSTRAINT [PK_OP_WMS_WAREHOUSE_INDICES_ID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON)
);
