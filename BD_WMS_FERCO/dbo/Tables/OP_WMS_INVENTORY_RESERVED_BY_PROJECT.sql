CREATE TABLE [dbo].[OP_WMS_INVENTORY_RESERVED_BY_PROJECT] (
    ...
    [MOBILE]           INT              NULL,
    CONSTRAINT [PK_ID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
    CONSTRAINT [FK_PROJECT_ID_ID] FOREIGN KEY ([PROJECT_ID]) REFERENCES [dbo].[OP_WMS_PROJECT] ([ID])
);
