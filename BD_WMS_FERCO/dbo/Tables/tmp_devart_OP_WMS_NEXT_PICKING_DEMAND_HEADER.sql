CREATE TABLE [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER] (
    ...
    PRIMARY KEY CLUSTERED ([PICKING_DEMAND_HEADER_ID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IDX_PICKING_DEMAND_HEADER_IS_FOR_DELIVERY_IMMEDIATE]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([WAVE_PICKING_ID] ASC)
    INCLUDE([IS_FOR_DELIVERY_IMMEDIATE]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IDX_PICKING_DEMAND_HEADER_IS_POSTED_ERP]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([WAVE_PICKING_ID] ASC)
    INCLUDE([ATTEMPTED_WITH_ERROR], [IS_AUTHORIZED], [IS_POSTED_ERP], [LAST_UPDATE], [LAST_UPDATE_BY], [PICKING_DEMAND_HEADER_ID], [POSTED_STATUS]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_DEMAND_TYPE_CODE_ROUTE_PICKING_DEMAND_HEADER_ID]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([DEMAND_TYPE] ASC, [CODE_ROUTE] ASC)
    INCLUDE([CLIENT_CODE], [CLIENT_NAME], [WAVE_PICKING_ID]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_DOC_ENTRY_EXTERNAL_SOURCE_ID_IS_COMPLETED]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([DOC_ENTRY] ASC, [IS_COMPLETED] ASC, [EXTERNAL_SOURCE_ID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_DOC_NUM]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([DOC_NUM] ASC)
    INCLUDE([IS_FROM_SONDA], [SOURCE_TYPE]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_DOC_NUM_EXTERNAL_SOURCE_ID]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([DOC_NUM] ASC, [EXTERNAL_SOURCE_ID] ASC)
    INCLUDE([IS_COMPLETED]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_DOC_NUM_EXTERNAL_SOURCE_ID_FROM_ERP]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([DOC_NUM] ASC, [IS_FROM_ERP] ASC, [EXTERNAL_SOURCE_ID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_DOC_NUM_HEADER_ID]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([DOC_NUM] ASC, [PICKING_DEMAND_HEADER_ID] ASC, [EXTERNAL_SOURCE_ID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_TRANSFER_REQUEST_ID]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([TRANSFER_REQUEST_ID] ASC)
    INCLUDE([CREATED_DATE], [WAVE_PICKING_ID]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_WAVE_PICKING_ID]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([WAVE_PICKING_ID] ASC)
    INCLUDE([CLIENT_CODE], [CLIENT_NAME], [CODE_ROUTE]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);


GO
CREATE NONCLUSTERED INDEX [IN_OP_WMS_NEXT_PICKING_DEMAND_HEADER_WAVE_PICKING_ID_TRANSFER_REQUEST_ID]
    ON [dbo].[tmp_devart_OP_WMS_NEXT_PICKING_DEMAND_HEADER]([WAVE_PICKING_ID] ASC, [TRANSFER_REQUEST_ID] ASC)
    INCLUDE([CREATED_DATE], [STATE_CODE]) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON);
