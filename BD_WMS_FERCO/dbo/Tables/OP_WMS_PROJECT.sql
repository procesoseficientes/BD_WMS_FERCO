CREATE TABLE [dbo].[OP_WMS_PROJECT] (
    ...
    CONSTRAINT [PK_OP_WMS_PROJECT_ID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON),
    UNIQUE NONCLUSTERED ([OPPORTUNITY_CODE] ASC) WITH (FILLFACTOR = 80, STATISTICS_NORECOMPUTE = ON)
);
