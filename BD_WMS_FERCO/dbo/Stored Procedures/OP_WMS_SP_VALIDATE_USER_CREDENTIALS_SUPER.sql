...
-- Ejemplo de Ejecucion:
	...
	EXEC [FERCO].[OP_WMS_SP_VALIDATE_USER_CREDENTIALS_SUPER]
	@LOGIN_ID = 'ADMIN'
	,@DOMAIN = 'ALSERSA'
	,@PASSWORD = '124'
...
*/
-- =============================================
CREATE PROCEDURE [OP_WMS_SP_VALIDATE_USER_CREDENTIALS_SUPER]
(
    @LOGIN_ID VARCHAR(50),
    @DOMAIN VARCHAR(50),
    @PASSWORD VARCHAR(50)
        ...
        BEGIN
            ...
            BEGIN
                ...
                (
                    ...
                    FROM [FERCO].[OP_WMS_WAREHOUSE_BY_USER] AS [WBU]
                ...
                BEGIN
                    ...
                    SELECT CASE
                           ...
                           1 [Codigo]
                    FROM alsersa.OP_WMS_LOGINS AS L
                    WHERE L.LOGIN_ID = @LOGIN_ID
                          AND L.LOGIN_PWD = @PASSWORD;
                --------------------------------------------
                END;
