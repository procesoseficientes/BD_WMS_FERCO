...
-- Ejemplo de Ejecucion:
				EXEC [FERCO].[OP_WMS_SP_GET_INVENTORY_BY_LOCATION_SUPER]
					@MATERIAL_ID = 'viscosa/VCA1030',@LOGIN_ID = 'MARVIN'
*/
-- =============================================
CREATE PROCEDURE [OP_WMS_SP_GET_INVENTORY_BY_LOCATION_SUPER]
(
...
BEGIN
    ...
    FROM alsersa.[OP_WMS_LICENSES] [L]
        ...
        LEFT JOIN [FERCO].[OP_WMS_INVENTORY_RESERVED_BY_PROJECT] [IRP]
            ON (
                   [IL].[PK_LINE] = [IRP].[PK_LINE]
                   AND [IL].[PROJECT_ID] = [IRP].[PROJECT_ID]
               )
        LEFT JOIN [FERCO].[OP_WMS_PROJECT] [P]
