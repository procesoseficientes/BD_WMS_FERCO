...
-- Ejemplo de Ejecucion:
	EXEC [FERCO].[OP_WMS_GET_PENDING_TASK_BY_USER_SUPER]
	@LOGIN_PARAMETER = 'Marvin'
*/
CREATE PROCEDURE [OP_WMS_GET_PENDING_TASK_BY_USER_SUPER]
...
BEGIN
    ...
    SELECT WAREHOUSE_ID
    FROM alsersa.OP_WMS_WAREHOUSE_BY_USER
    ...
    FROM alsersa.OP_WMS_TASK_LIST [WTL]
...
--EXECUTE ALSERSA.OP_WMS_GET_PENDING_TASK_BY_USER_SUPER @LOGIN_ID = 'MARVIN' -- varchar(100)