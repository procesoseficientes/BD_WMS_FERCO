...
-- Ejemplo de Ejecucion:
	EXEC [FERCO].[OP_WMS_SP_GET_TASKS_BY_USER_SUPER]
	@LOGIN_PARAMETER = 'Marvin'
*/
CREATE PROCEDURE [OP_WMS_SP_GET_TASKS_BY_USER_SUPER]
(
...
END
	...
	--EXECUTE ALSERSA.OP_WMS_SP_GET_TASKS_BY_USER_SUPER @LOGIN_PARAMETER = 'MARVIN' -- varchar(100)