...
-- Ejemplo de Ejecucion:
        SELECT * FROM [FERCO].OP_WMS_FN_GET_LICENSE_TO_PICK_FOR_PROYECT('ferco/I00000002','BODEGA_02',255,1,NULL)		
*/
-- =============================================

CREATE FUNCTION [OP_WMS_FN_GET_LICENSE_TO_PICK_FOR_PROYECT] (
...
BEGIN
	...
	BEGIN
		...
		FROM
			[FERCO].[OP_WMS_FN_GET_INVENTORY_FROM_PROYECT](@PROYECT_ID) [IFP]
		WHERE
