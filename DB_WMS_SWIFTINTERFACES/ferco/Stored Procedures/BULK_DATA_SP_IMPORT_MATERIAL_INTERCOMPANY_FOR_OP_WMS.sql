...
-- Ejemplo de Ejecucion:
        EXEC [ferco].[BULK_DATA_SP_IMPORT_MATERIAL_INTERCOMPANY_FOR_OP_WMS]
		--
		SELECT * FROM [OP_WMS_FERCO].[FERCO].[OP_WMS_MATERIAL_INTERCOMPANY]
*/
-- =============================================
CREATE PROCEDURE [ferco].[BULK_DATA_SP_IMPORT_MATERIAL_INTERCOMPANY_FOR_OP_WMS]
AS
BEGIN
	SET NOCOUNT ON;
	--
	...
	--
	DELETE FROM [OP_WMS_FERCO].[FERCO].[OP_WMS_MATERIAL_INTERCOMPANY]
	--
	INSERT INTO [OP_WMS_FERCO].[FERCO].[OP_WMS_MATERIAL_INTERCOMPANY]
			(
				[MASTER_ID]
				,[ITEM_CODE]
				,[SOURCE]
