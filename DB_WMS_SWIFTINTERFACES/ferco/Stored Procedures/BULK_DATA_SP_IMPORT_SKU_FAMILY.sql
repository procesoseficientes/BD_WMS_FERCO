...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [ferco].[BULK_DATA_SP_IMPORT_SKU_FAMILY]
*/
-- =============================================
CREATE PROCEDURE ferco.BULK_DATA_SP_IMPORT_SKU_FAMILY
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  -- ------------------------------------------------------------------------------------
  MERGE SWIFT_EXPRESS.ferco.[SWIFT_SKU_FAMILY] TRG
  USING (SELECT
      *
    FROM SWIFT_INTERFACES_ONLINE.ferco.[ERP_VIEW_SKU_FAMILY]) AS SRC
