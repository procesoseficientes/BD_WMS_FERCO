...
-- Fecha de Creacion: 	16/01/2021 @Procesos eficientes 
-- Description:			Se inserta el detalle del pedido en ERP_DELIVERY_ORDER_DETAIL y se devuelve la secuencia para el reporte de trazabilidad

-- Autor:				Thomas.Pamal
-- Fecha de Creacion:   16/06/2021 @Procesos eficientes 
-- Description:         Se corrigió la variable [U_Serie]
...
-- Ejemplo de Ejecucion:
				...
				EXEC [FERCO].[ERP_SP_INSERT_DELIVERY_ORDER_DETAIL_FOR_REPORT] 
...
*/
-- =============================================
create PROCEDURE [ferco].[ERP_SP_INSERT_DELIVERY_ORDER_DETAIL_FOR_REPORT] (@START_DATE VARCHAR(100)
