...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [ferco].[BULK_DATA_SP_IMPORT_MATERIALS_WITH_CATEGORY]
				--
				SELECT * FROM [OP_WMS_FERCO].[FERCO].[OP_WMS_MATERIALS_WITH_CATEGORY]
*/
-- =============================================
CREATE PROCEDURE ferco.BULK_DATA_SP_IMPORT_MATERIALS_WITH_CATEGORY
AS
BEGIN
  SET NOCOUNT ON;
  --
  ...
  -- ------------------------------------------------------------------------------------
  MERGE [OP_WMS_FERCO].[FERCO].[OP_WMS_MATERIALS_WITH_CATEGORY] [TRG]
  USING (SELECT
      *
    FROM [SWIFT_INTERFACES_ONLINE].[ferco].[ERP_VIEW_MATERIALS_WITH_CATEGORY]) AS [SRC]
