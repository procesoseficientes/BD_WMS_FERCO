...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [ferco].[BULK_DATA_SP_IMPORT_SELLER_INFO]
*/
-- =============================================
CREATE PROCEDURE ferco.BULK_DATA_SP_IMPORT_SELLER_INFO
AS
BEGIN
  SET NOCOUNT ON;
  --
  MERGE SWIFT_EXPRESS.[ferco].[USERS] AS TRG
  USING (SELECT
      [EVS].[SELLER_CODE]
     ,[EVS].[SELLER_NAME]
     ,[EVS].[SELLER_TYPE]
     ...
     ,[EVS].[CODE_WAREHOUSE]
     ,[EVS].[NAME_WAREHOUSE]
    FROM [SWIFT_INTERFACES_ONLINE].[ferco].[ERP_VIEW_SELLER] EVS) AS SRC
