...
-- =============================================
-- Autor:				rodrigo.gomez
-- Fecha de Creacion: 	9/28/2017 @ NEXUS-Team Sprint DuckHunt/ferco
...
-- Ejemplo de Ejecucion:
				...
				EXEC [ferco].[ERP_SP_INSERT_SALES_ORDER_HEADER_FOR_REPORT] 
...
*/
-- =============================================
CREATE PROCEDURE [ferco].[ERP_SP_INSERT_SALES_ORDER_HEADER_FOR_REPORT] (@START_DATE VARCHAR(100)
