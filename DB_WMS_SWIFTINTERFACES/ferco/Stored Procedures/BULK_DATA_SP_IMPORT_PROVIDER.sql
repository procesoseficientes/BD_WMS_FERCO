...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [ferco].[BULK_DATA_SP_IMPORT_PROVIDER]
*/
-- =============================================
CREATE PROCEDURE [ferco].[BULK_DATA_SP_IMPORT_PROVIDER]
AS
BEGIN
	SET NOCOUNT ON;
	--
	MERGE [ferco].SWIFT_ERP_PROVIDERS TRG
	USING (SELECT * FROM SWIFT_INTERFACES_ONLINE.[ferco].ERP_VIEW_PROVIDERS) AS SRC
