CREATE TABLE [ferco].[ERP_SALES_ORDER_DETAIL_CHANNEL_MODERN] (
...
GO
CREATE NONCLUSTERED INDEX [IN_ERP_SALES_ORDER_DETAIL_CHANNEL_MODERN_SEQUENCE]
    ON [ferco].[ERP_SALES_ORDER_DETAIL_CHANNEL_MODERN]([Sequence] ASC);
