...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [ferco].[ERP_SP_GENERATE_DISCOUNT_LIST_BY_CUSTOMER_AND_SKU]
					@DISCOUNT_TYPE = 2
					,@ORDER = 1
*/
-- =============================================
CREATE PROCEDURE ferco.ERP_SP_GENERATE_DISCOUNT_LIST_BY_CUSTOMER_AND_SKU (@DISCOUNT_TYPE INT
, @ORDER INT)
AS
BEGIN
  SET NOCOUNT ON;
