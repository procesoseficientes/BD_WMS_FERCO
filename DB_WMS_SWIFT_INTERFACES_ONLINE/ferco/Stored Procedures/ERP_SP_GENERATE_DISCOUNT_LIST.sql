...
-- Ejemplo de Ejecucion:
				-- 
				EXEC [ferco].[ERP_SP_GENERATE_DISCOUNT_LIST]
*/
-- =============================================
CREATE PROCEDURE ferco.ERP_SP_GENERATE_DISCOUNT_LIST
AS
BEGIN
  SET NOCOUNT ON;
  --
  DECLARE @DISCOUNT_TYPE INT = 2
  ...
  SELECT
   ...
   ,[ORDER] INTO #PROC
  FROM ferco.SWIFT_DISCOUNT_PRIORITY DP
